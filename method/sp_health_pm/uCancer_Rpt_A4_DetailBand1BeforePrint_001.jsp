...
FROM   ET_EXAM_ACPT A
 INNER JOIN IT_CUSTOMER B ON
  ...
  LEFT OUTER JOIN ET_CANCER_STMC C ON
       ECS_EXAM_DT = EEA_EXAM_DT AND
       ECS_EXAM_SQ = EEA_EXAM_SQ
  LEFT OUTER JOIN ET_CANCER_COLO D ON
       ECC_EXAM_DT = EEA_EXAM_DT AND
       ECC_EXAM_SQ = EEA_EXAM_SQ
  LEFT OUTER JOIN ET_CANCER_LIVER E ON
       ECL_EXAM_DT = EEA_EXAM_DT AND
       ECL_EXAM_SQ = EEA_EXAM_SQ
  LEFT OUTER JOIN ET_CANCER_BRST F ON
       ECB_EXAM_DT = EEA_EXAM_DT AND
       ECB_EXAM_SQ = EEA_EXAM_SQ
  LEFT OUTER JOIN ET_CANCER_CRVC G ON
       ECV_EXAM_DT = EEA_EXAM_DT AND
       ECV_EXAM_SQ = EEA_EXAM_SQ
  LEFT OUTER JOIN ET_CANCER_LUNG M ON
  ...
  AND (EEA_STOMA_CD <> '0' OR EEA_COLON_CD <> '0' OR EEA_LIVER_CD <> '0'
   OR EEA_BAST_CD  <> '0' OR EEA_UTER_CD  <> '0' OR NVL(EEA_LUNG_CD, '0') <> '0')
		...
		*/
		...
		sql = " SELECT A.*, B.*, C.*, D.*, E.*, F.*, G.*, M.*";
		sql += " FROM ET_EXAM_ACPT A INNER JOIN IT_CUSTOMER B";
		sql += " ON ICR_CUST_NO = EEA_CUST_NO LEFT OUTER JOIN ET_CANCER_STMC C";
		sql += " ON ECS_EXAM_DT = EEA_EXAM_DT";
		sql += " AND ECS_EXAM_SQ = EEA_EXAM_SQ LEFT OUTER JOIN ET_CANCER_COLO D";
		sql += " ON ECC_EXAM_DT = EEA_EXAM_DT";
		sql += " AND ECC_EXAM_SQ = EEA_EXAM_SQ LEFT OUTER JOIN ET_CANCER_LIVER E";
		sql += " ON ECL_EXAM_DT = EEA_EXAM_DT";
		sql += " AND ECL_EXAM_SQ = EEA_EXAM_SQ LEFT OUTER JOIN ET_CANCER_BRST F";
		sql += " ON ECB_EXAM_DT = EEA_EXAM_DT";
		sql += " AND ECB_EXAM_SQ = EEA_EXAM_SQ LEFT OUTER JOIN ET_CANCER_CRVC G";
		sql += " ON ECV_EXAM_DT = EEA_EXAM_DT";
		sql += " AND ECV_EXAM_SQ = EEA_EXAM_SQ LEFT OUTER JOIN ET_CANCER_LUNG M";
		...
		sql += " OR NVL(EEA_LUNG_CD, '0') <> '0')";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCancer_Rpt_A4_DetailBand1BeforePrint_001 \n";
			G_INFO += "설명 : 검사결과 로딩 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='ROWID' rs:number='499' rs:rowid='true' rs:basetable='ET_EXAM_ACPT' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c499' rs:name='ROWID' rs:number='500' rs:rowid='true' rs:basetable='IT_CUSTOMER' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c500' rs:name='ROWID' rs:number='501' rs:rowid='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ROWID' rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c501' rs:name='ROWID' rs:number='502' rs:rowid='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ROWID' rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c502' rs:name='ROWID' rs:number='503' rs:rowid='true' rs:basetable='ET_CANCER_LIVER'
			 rs:basecolumn='ROWID' rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c503' rs:name='ROWID' rs:number='504' rs:rowid='true' rs:basetable='ET_CANCER_BRST'
			 rs:basecolumn='ROWID' rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c504' rs:name='ROWID' rs:number='505' rs:rowid='true' rs:basetable='ET_CANCER_CRVC'
			 rs:basecolumn='ROWID' rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c505' rs:name='ROWID' rs:number='506' rs:rowid='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ROWID' rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
...
<%
		...
		while(cRsList.next()) {
			...
			String c499_T = cRsList.getString("c499");
			String c500_T = cRsList.getString("c500");
			String c501_T = cRsList.getString("c501");
			String c502_T = cRsList.getString("c502");
			String c503_T = cRsList.getString("c503");
			String c504_T = cRsList.getString("c504");
