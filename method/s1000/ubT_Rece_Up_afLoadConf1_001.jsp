...
<%
		...
		sql = " SELECT EEA_PSNL_NM, EEA_CHART_NO, ICR_PENL_ID, EEA_CUST_NO FROM ET_EXAM_ACPT A ";
		sql += " 	LEFT OUTER JOIN IT_CUSTOMER B ON A.EEA_CUST_NO = B.ICR_CUST_NO ";
		sql += " WHERE EEA_PSNL_NM LIKE  '" + PSNL_NM + "%' ";
		sql += " AND EEA_EXAM_DT BETWEEN '" + FROM_DT + "' AND  '" + TO_DT + "' ";
		sql += " GROUP BY EEA_PSNL_NM, ICR_PENL_ID,  EEA_CHART_NO, EEA_CUST_NO ";
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : ubT_Rece_Up_afLoadConf1_001 \n";
			G_INFO += "설명 : 납입확인서 대상자리스트 \n";
			G_INFO += "\n\n";
