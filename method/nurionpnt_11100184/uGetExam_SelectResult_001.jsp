...
SELECT  *
     FROM (SELECT ET_RSLT_ITEM.*, IT_ITEM.IIM_NITEM_CD, IT_ITEM.IIM_KNME_NM, IT_ITEM.IIM_SNME_NM, IT_ITEM.IIM_REJH_EX, IT_ITEM.IIM_RSLT_KD, 
                                 ET_EXAM_ACPT.EEA_SEX_CD, ET_EXAM_ACPT.EEA_PSNL_AGE 
                    ...
                    LEFT OUTER JOIN TABLE(GetItemVldtTable_PKG.GetItemVldtTable(A.ERI_ITEM_CD, A.EEA_SEX_CD, A.EEA_PSNL_AGE, A.ERI_EXAM_DT, '1')) B 
                      ON B.ITEM_CD = A.ERI_ITEM_CD 
		*/

		sql = " SELECT *";
		sql += " FROM (SELECT ET_RSLT_ITEM.*, IT_ITEM.IIM_NITEM_CD, IT_ITEM.IIM_KNME_NM, IT_ITEM.IIM_SNME_NM, IT_ITEM.IIM_REJH_EX, IT_ITEM.IIM_RSLT_KD, ET_EXAM_ACPT.EEA_SEX_CD, ET_EXAM_ACPT.EEA_PSNL_AGE";
		...
		sql += " AND ET_RSLT_ITEM.ERI_CNCL_YN = 'N' ) A LEFT OUTER JOIN TABLE(GETITEMVLDTTABLE_PKG.GETITEMVLDTTABLE(A.ERI_ITEM_CD, A.EEA_SEX_CD, A.EEA_PSNL_AGE, A.ERI_EXAM_DT, '1')) B";
		sql += " ON B.ITEM_CD = A.ERI_ITEM_CD";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uGetExam_SelectResult_001 \n";
			G_INFO += "설명 : 검사 결과 조회 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='IIM_RSLT_KD' rs:number='76'>
		...
		<s:AttributeType name='ITEM_CD' rs:number='79' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='RLOW' rs:number='80' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='RHIGH' rs:number='81' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='CHRVAL' rs:number='82' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='500'/>
		</s:AttributeType>
		<s:AttributeType name='RUNIT' rs:number='83' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='50'/>
		</s:AttributeType>
		<s:AttributeType name='RSPT' rs:number='84' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='LOWKD' rs:number='85' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='HIGHKD' rs:number='86' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='RSZR_KD' rs:number='87' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
