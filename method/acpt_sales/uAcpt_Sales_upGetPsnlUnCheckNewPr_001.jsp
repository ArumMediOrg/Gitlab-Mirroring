...
<%
		...
		sql = " SELECT A.ERI_EXAM_DT, A.ERI_EXAM_SQ, NVL(SUM(B.ITEM_PR),0) NEW_UNCHECK_PR FROM ET_RSLT_ITEM A ";
		sql += " INNER JOIN ";
		...
		sql += " GROUP BY A.ERI_EXAM_DT, A.ERI_EXAM_SQ ";



			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uAcpt_Sales_upGetPsnlUnCheckNewPr_001 \n";
			G_INFO += "설명 : 개인별 일반검진 미검수가 조회 \n";
			G_INFO += "\n\n";
