...
<%
		...
		sql = " select EEA_EXAM_DT, EEA_EXAM_SQ, EEA_CHART_NO, EEA_PSNL_NM,EEA_FAMY_CD,EEA_FAMY_NM ";
		sql += " 	,EEA_COMP_CD ,(select ICY_COMP_NM from it_company where ICY_COMP_CD = EEA_COMP_CD) ICY_COMP_NM ";
		sql += " 	,CAP_RSVN_DT, CAP_DOCTOR ";
		sql += " 	,(select IAU_PENL_NM from IT_AUTH_USER where IAU_EMP_NO = CAP_DOCTOR) DOCTOR_NM ";
		sql += " 	,SSV_PRNT_DT, SSV_EMAIL_DT ,SSV_RPT_DT ";
		...
		if (SLT_KD.equals("Exam_Dt")) {
			...
			sql += " left outer join ET_EXAM_ACPT   b on a.SSV_EXAM_DT = b.EEA_EXAM_DT and a.SSV_EXAM_SQ = b.EEA_EXAM_SQ ";
			sql += " left outer join CR_ADVICE_PLAN c on a.SSV_EXAM_DT = c.CAP_EXAM_DT and a.SSV_EXAM_SQ = c.CAP_EXAM_SQ ";
			sql += " where  1 = 1 ";
			sql += " and SSV_RPT_DT between '" + SRCH_DTS + "' and '" + SRCH_DTE + "' ";
		}
		...
		sql += SSQLADD;
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCRM_BASIC_UP_S7Main_GridDisplay_001 \n";
			G_INFO += "설명 : 종검판정권고화면-메인내역조회 \n";
			G_INFO += "\n\n";
