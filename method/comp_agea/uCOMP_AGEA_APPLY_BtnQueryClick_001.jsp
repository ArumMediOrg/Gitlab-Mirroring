...
<%
		...
		sql += " WHERE 0 = 0";
		sql += " AND A.ECA_COMP_CD = '" + COMP_CD + "'";
		sql += " AND A.ECA_MNGT_YR = '" + MNGT_YR + "'";
		sql += " AND A.ECA_AGEA_KD = '1'";
		sql += " ORDER BY NVL(A.ECA_SORT_SQ, 0), A.ECA_ITEM_CD ";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCOMP_AGEA_APPLY_BtnQueryClick_001 \n";
			G_INFO += "설명 : 계약단가 내역 조회(특정항목추가) \n";
			G_INFO += "\n\n";
