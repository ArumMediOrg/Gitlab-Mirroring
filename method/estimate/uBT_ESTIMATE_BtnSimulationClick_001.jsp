...
SELECT BEI_ITEM_CD, BEI_ITEM_PR, BEI_ESTI_PR, (SELECT IIM_KNME_NM FROM IT_ITEM WHERE IIM_ITEM_CD = BEI_ITEM_CD) AS BEI_ITEM_NM 
...
WHERE BEI_MNGT_YR = :MNGT_YR
   ...
   AND BEI_PROF_SQ = :PROF_SQ
		...
		*/
		...
		sql = " SELECT BEI_ITEM_CD, BEI_ITEM_PR, BEI_ESTI_PR";
		sql += ", (";
		...
		sql += " AND BEI_PROF_SQ = '" + PROF_SQ + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uBT_ESTIMATE_BtnSimulationClick_001 \n";
			G_INFO += "설명 : 유형항목정보 로딩 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='BEI_ESTI_PR' rs:number='3' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_PROF_ITEM'
			 rs:basecolumn='BEI_ESTI_PR'>
			<s:datatype dt:type='number' rs:dbtype='varnumeric' dt:maxLength='38' rs:scale='255' rs:precision='38'/>
		</s:AttributeType>
		<s:AttributeType name='BEI_ITEM_NM' rs:number='4' rs:nullable='true'>
