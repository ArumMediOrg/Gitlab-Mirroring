...
SELECT CSC_FULL_NM FROM CT_SP_COMMON WHERE CSC_LARGE =:AParam1 AND CSC_SMALL = :AParam2 AND CSC_LEVEL <> '1'
		*/

		sql = " SELECT CSC_FULL_NM";
		sql += " FROM CT_SP_COMMON";
		sql += " WHERE CSC_LARGE ='" + APARAM1 + "'";
		sql += " AND CSC_SMALL = '" + APARAM2 + "'";
		sql += " AND CSC_LEVEL <> '1'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uTiberoTemplate_GetSP_COMMON_cdToNm_001 \n";
