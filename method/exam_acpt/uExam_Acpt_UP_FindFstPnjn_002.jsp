...
SELECT *
  FROM (SELECT A.EEA_EXAM_DT, A.EEA_EXAM_SQ, B.PFP_EXAM_DT2, B.PFP_EXAM_SQ2 
          FROM ET_EXAM_ACPT A JOIN PT_FIR_PANJUNG B
 ...
 WHERE ROWNUM = 1
		...
		*/
		...
		sql = " SELECT *";
		sql += " FROM (";
		sql += "	SELECT A.EEA_EXAM_DT, A.EEA_EXAM_SQ, B.PFP_EXAM_DT2, B.PFP_EXAM_SQ2";
		sql += "	FROM ET_EXAM_ACPT A JOIN PT_FIR_PANJUNG B";
		...
		sql += " WHERE ROWNUM = 1";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uExam_Acpt_UP_FindFstPnjn_002 \n";
			G_INFO += "설명 : 일검 2차 접수 조회 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='PFP_EXAM_DT2' rs:number='3' rs:nullable='true' rs:writeunknown='true' rs:basetable='PT_FIR_PANJUNG'
			 rs:basecolumn='PFP_EXAM_DT2'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='PFP_EXAM_SQ2' rs:number='4' rs:nullable='true' rs:writeunknown='true' rs:basetable='PT_FIR_PANJUNG'
		...
		<s:AttributeType name='c5' rs:name='ROWID' rs:number='6' rs:rowid='true' rs:basetable='PT_FIR_PANJUNG' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
