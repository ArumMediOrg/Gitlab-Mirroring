...
<%
 ...
 SELECT IIR_RSLT_CD, IIR_RSLT_VL, IIR_HEEX_CD, IIR_SPEX_CD, IIR_PRNT_VL, IIR_USE_YN
   FROM IT_ITEM_RESULT  +
  WHERE IIR_ITEM_CD = :IIR_ITEM_CD
    AND IIR_RSLT_CD = :IIR_RSLT_CD
    AND IIR_RSLT_KD = ''2''
		*/

		sql = " SELECT IIR_RSLT_CD, IIR_RSLT_VL, IIR_HEEX_CD, IIR_SPEX_CD, IIR_PRNT_VL, IIR_USE_YN";
		...
		sql += " AND IIR_RSLT_KD = '2'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uRslt_Code_FormShow_002 \n";
			G_INFO += "설명 : 검사항목 결과코드 조회 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='IIR_HEEX_CD' rs:number='3' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_ITEM_RESULT'
			 rs:basecolumn='IIR_HEEX_CD'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='IIR_SPEX_CD' rs:number='4' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_ITEM_RESULT'
			 rs:basecolumn='IIR_SPEX_CD'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='IIR_PRNT_VL' rs:number='5' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_ITEM_RESULT'
			 rs:basecolumn='IIR_PRNT_VL'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='IIR_USE_YN' rs:number='6' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_ITEM_RESULT'
			 rs:basecolumn='IIR_USE_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ROWID' rs:number='7' rs:rowid='true' rs:basetable='IT_ITEM_RESULT' rs:basecolumn='ROWID'
