...
<%
		...
		sql += "		, CASE WHEN ERI_ITEM_CD='BD003' THEN ERI_HERT_CD END BD003";
		sql += "		, CASE WHEN ERI_ITEM_CD='BD025' THEN ERI_HERT_CD END BD025";
		sql += "		, CASE WHEN ERI_ITEM_CD='BD027' THEN ERI_RSLT_VL END BD027";
		sql += "		, CASE WHEN ERI_ITEM_CD='BD004' THEN ERI_HERT_CD END BD004";
		sql += "		, CASE WHEN ERI_ITEM_CD='BD026' THEN ERI_HERT_CD END BD026";
		...
		sql += " , CASE WHEN ERI_ITEM_CD='F0001'  AND NVL(ERI_RSLT_VL, ' ') <> ' ' AND ERI_HERT_CD<>'11' AND ERI_HLTH_KD ='1' THEN '1'";
		sql += " WHEN ERI_ITEM_CD='F0003'  AND NVL(ERI_RSLT_VL, ' ') <> ' ' AND ERI_HERT_CD<>'11' AND ERI_HLTH_KD ='1' THEN '2'";
		sql += " WHEN ERI_ITEM_CD='F0007'  AND NVL(ERI_RSLT_VL, ' ') <> ' ' AND ERI_HERT_CD<>'11' AND ERI_HLTH_KD ='1' THEN '3'";
		sql += " WHEN ERI_ITEM_CD='F0014'  AND NVL(ERI_RSLT_VL, ' ') <> ' ' AND ERI_HERT_CD<>'11' AND ERI_HLTH_KD ='1' THEN '4'";
		sql += " WHEN ERI_ITEM_CD='F0001'  AND NVL(ERI_RSLT_VL, ' ') <> ' ' AND ERI_HERT_CD= '11'  AND ERI_HLTH_KD ='1' THEN '5'";
		sql += " WHEN ERI_ITEM_CD='F0003'  AND NVL(ERI_RSLT_VL, ' ') <> ' ' AND ERI_HERT_CD= '11'  AND ERI_HLTH_KD ='1' THEN '5'";
		sql += " WHEN ERI_ITEM_CD='F0007'  AND NVL(ERI_RSLT_VL, ' ') <> ' ' AND ERI_HERT_CD= '11'  AND ERI_HLTH_KD ='1' THEN '5'";
		sql += " WHEN ERI_ITEM_CD='F0014'  AND NVL(ERI_RSLT_VL, ' ') <> ' ' AND ERI_HERT_CD= '11'  AND ERI_HLTH_KD ='1' THEN '5'";
		sql += "		ELSE '' END S6,";

		sql += " CASE WHEN ERI_ITEM_CD='F0001' AND ERI_HLTH_KD ='1' THEN ERI_HERT_CD";
		sql += " WHEN ERI_ITEM_CD='F0003'  AND ERI_HLTH_KD ='1' THEN ERI_HERT_CD";
		sql += " WHEN ERI_ITEM_CD='F0007'  AND ERI_HLTH_KD ='1' THEN ERI_HERT_CD";
		sql += " WHEN ERI_ITEM_CD='F0014'  AND ERI_HLTH_KD ='1' THEN ERI_HERT_CD";
		sql += " END F0014 ";
