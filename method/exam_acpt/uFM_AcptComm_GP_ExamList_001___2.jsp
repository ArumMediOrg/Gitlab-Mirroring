...
<%
  ...
  SELECT LTRIM(RTRIM(IIM_KNME_NM)) EXAM_NM, 0 EXAM_PR 
    FROM IT_ITEM 
   WHERE IIM_NITEM_CD = :SRCH_CD

		*/

		sql = " SELECT LTRIM(RTRIM(IIM_KNME_NM)) EXAM_NM, 0 EXAM_PR";
		sql += " FROM IT_ITEM";
		sql += " WHERE IIM_NITEM_CD = '" + SRCH_CD + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uFM_AcptComm_GP_ExamList_001___2 \n";
			G_INFO += "설명 : 기존 앨리스 검사 묶음/항목 조회___2 \n";
			G_INFO += "\n\n";
