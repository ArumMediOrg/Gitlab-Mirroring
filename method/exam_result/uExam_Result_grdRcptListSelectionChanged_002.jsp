...
Select QQN_INPT_ID from QT_QUESTION
Where QQN_EXAM_DT = :EXAM_DT  
    And QQN_EXAM_SQ = :EXAM_SQ
    And QQN_INPT_ID = 'WEQ'                                                                                                                                            
		*/

		sql = " SELECT QQN_INPT_ID";
		...
		sql += " AND QQN_INPT_ID = 'WEQ'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uExam_Result_grdRcptListSelectionChanged_002 \n";
			G_INFO += "설명 : 전자문진 데이터 조회 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='QQN_INPT_ID' rs:number='1' rs:nullable='true' rs:writeunknown='true' rs:basetable='QT_QUESTION'
