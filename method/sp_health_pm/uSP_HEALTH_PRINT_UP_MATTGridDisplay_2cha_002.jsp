...
Select A.ERI_ITEM_CD, A.ERI_RSLT_VL, B.IIM_SBCD_CD 
From ET_RSLT_ITEM  A
     Inner Join IT_ITEM B On B.IIM_ITEM_CD = A.ERI_ITEM_CD
Where A.ERI_EXAM_DT = :EXAM_DT
  And A.ERI_EXAM_SQ = :EXAM_SQ
  And A.ERI_RSLT_KD In ('1', '2', '4', '5', '7')
  And A.ERI_ITEM_CD Not In ('A0001', 'A0002', 'A0014', 'A0015',
                              'F0002', 'F0014', 'S0020')
   And A.ERI_CNCL_YN = 'N'
Order By A.ERI_ITEM_CD

		*/

		sql = " SELECT A.ERI_ITEM_CD, A.ERI_RSLT_VL, B.IIM_SBCD_CD";
		...
		sql += " AND A.ERI_RSLT_KD IN ('1', '2', '4', '5', '7')";
		sql += " AND A.ERI_ITEM_CD NOT IN ('A0001', 'A0002', 'A0014', 'A0015', 'F0002', 'F0014', 'S0020')";
		sql += " AND A.ERI_CNCL_YN = 'N'";
		sql += " ORDER BY A.ERI_ITEM_CD";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_HEALTH_PRINT_UP_MATTGridDisplay_2cha_002 \n";
			G_INFO += "설명 : 검사항목결과정보 로딩 \n";
			G_INFO += "\n\n";
