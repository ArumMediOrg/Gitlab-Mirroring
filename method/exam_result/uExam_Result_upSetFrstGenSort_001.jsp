...
SELECT COUNT(*) FROM USER_TABLES WHERE TABLE_NAME = 'IT_HTSB_SEQ'
		*/

		sql = " SELECT COUNT(*)";
		sql += " FROM USER_TABLES";
		sql += " WHERE TABLE_NAME = 'IT_HTSB_SEQ'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uExam_Result_upSetFrstGenSort_001 \n";
			G_INFO += "설명 : 1차졍렬순서유무조회 \n";
			G_INFO += "\n\n";
