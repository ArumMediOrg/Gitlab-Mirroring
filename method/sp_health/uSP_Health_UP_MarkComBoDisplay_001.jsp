...
<%
		...
		String SMARK_SQL = htMethod.get("SMARK_SQL");

		//
		if(SMARK_SQL == null) { SMARK_SQL = ""; }
...
SELECT CSC_LARGE, CSC_SMALL, CSC_FULL_NM FROM CT_SP_COMMON
 ...
 ORDER BY CSC_SMALL
		*/
		...
		sql += " AND CSC_LEVEL = '5'";
		sql += " AND CSC_SMALL IN ('" + SMARK_SQL + "')";
		sql += " AND CSC_USE_YN = 'Y'";
		sql += " ORDER BY CSC_SMALL";
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_Health_UP_MarkComBoDisplay_001 \n";
			G_INFO += "설명 : 특검공통코드(표적장기) 조회(해당대상만) \n";
			G_INFO += "\n\n";

			G_INFO += "전달인자 : \n";
			G_INFO += " SMARK_SQL : " + SMARK_SQL + " \n";
			G_INFO += "\n\n";
