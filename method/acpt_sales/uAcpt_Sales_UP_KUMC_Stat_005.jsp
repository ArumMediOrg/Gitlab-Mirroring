...
<%
		...
		sql += "		NVL(SUM(CASE ACPT_CD WHEN '1' THEN NCNL_CNT ELSE 0 END), 0) PSNL_NCNL, ";
		sql += "		NVL(SUM(CASE ACPT_CD WHEN '2' THEN NCNL_CNT ELSE 0 END), 0) COMP_NCNL, ";
		sql += " 		NVL(SUM(RSVN_CNT), 0) RTOT_CNT, NVL(SUM(YES_CNT), 0)  YTOT_CNT, ";
		sql += " 		NVL(SUM(NO_CNT), 0)   NTOT_CNT, NVL(SUM(CNCL_CNT), 0) CTOT_CNT, ";
		sql += "		NVL(SUM(NCNL_CNT), 0) NCNL_CNT ";
		...
		sql += " 				CASE WHEN NVL(RRT_CNCL_YN, 'N') = 'Y' THEN CASE WHEN RRT_EXAM_DT <= TO_CHAR(RRT_INPT_DTT, 'YYYY-MM-DD') THEN 1 ELSE 0 END ELSE 0 END NCNL_CNT  ";
		sql += " 			FROM RT_RSVT ";
