...
ELSE 
  SELECT B.ICR_PENL_ID ICR_PENL_DE,
       ...
       GETCOMMON_LVCDTONM('0910',A.EEA_SPCL_CD,'5',2) EEA_SPCL_NM,
       GETCOMMON_LVCDTONM('0911',A.EEA_SPHT_CD,'5',1) EEA_SPHT_MN,
       GETCOMMON_LVCDTONM('0401',A.EEA_EXAM_CD,'5',5) EEA_EXAM_NM,
       GETCOMMON_LVCDTONM('0411',A.EEA_SEX_CD ,'5',1) ICR_SEX_NM, 
       GETSP_COMMON_CDTONM('HM05D',E.SPG_ORGA_CD)  SPG_ORGA_NM, 
       GETSP_COMMON_CDTONM('HM05E',E.SPG_PANJ_CD)  SPG_PANJ_NM, 
       ...
       A.EEA_EXAM_CD, A.EEA_HDMD_YN, A.EEA_SDMD_YN, A.EEA_SPCL_LT, A.EEA_SPCL_CD, A.EEA_SPHT_CD,
       A.EEA_CHART_NO, A.EEA_ADD_DT, A.EEA_ACPT_TX, A.EEA_DEPT_NM,
       D.SBE_TOBO_DT, D.SBE_RECHK_DT, D.SBE_SEND_YN, D.SBE_SEND_NM,
       E.SPG_ORGA_CD, E.SPG_SWING_CD, E.SPG_PANJ_CD, E.SPG_PANJ_DT, E.SPG_DOCT_CD, E.SPG_MATT_CD,
       E.SPG_POSM1_TX, E.SPG_POSM1_DT, E.SPG_POSM2_TX, E.SPG_POSM2_DT, E.SPG_POSM3_TX, E.SPG_POSM3_DT,
       F_DOCTOR_FIND(1,E.SPG_DOCT_CD) SPG_DOCT_NM, E.SPG_POSM1_CD, E.SPG_POSM2_CD, E.SPG_POSM3_CD 
  FROM ET_EXAM_ACPT A 
...
:ORDER_BY
		*/
		...
		sql += " OR A.EEA_SPSB_YN = 'Y' THEN '1' ELSE '2' END EEA_SPCH_KD, GETCOMMON_LVCDTONM('0910',A.EEA_SPCL_CD,'5',2) EEA_SPCL_NM, GETCOMMON_LVCDTONM('0911',A.EEA_SPHT_CD,'5',1) EEA_SPHT_MN, GETCOMMON_LVCDTONM('0401',A.EEA_EXAM_CD,'5',5) EEA_EXAM_NM, GETCOMMON_LVCDTONM('0411',A.EEA_SEX_CD ,'5',1) ICR_SEX_NM, GETSP_COMMON_CDTONM('HM05D',E.SPG_ORGA_CD) SPG_ORGA_NM, GETSP_COMMON_CDTONM('HM05E',E.SPG_PANJ_CD) SPG_PANJ_NM, GETSP_COMMON_CDTONM('HM05A',E.SPG_POSM1_CD) SPG_POSM1_NM, GETSP_COMMON_CDTONM('HM05A',E.SPG_POSM2_CD) SPG_POSM2_NM, GETSP_COMMON_CDTONM('HM05A',E.SPG_POSM3_CD) SPG_POSM3_NM, GETSP_COMMON_CDTONM('HM05B',E.SPG_BUSI_CD) SPG_BUSI_NM, A.EEA_EXAM_CD, A.EEA_HDMD_YN, A.EEA_SDMD_YN, A.EEA_SPCL_LT, A.EEA_SPCL_CD, A.EEA_SPHT_CD, A.EEA_CHART_NO, A.EEA_ADD_DT, A.EEA_ACPT_TX, A.EEA_DEPT_NM, D.SBE_TOBO_DT, D.SBE_RECHK_DT, D.SBE_SEND_YN, D.SBE_SEND_NM, E.SPG_ORGA_CD, E.SPG_SWING_CD, E.SPG_PANJ_CD, E.SPG_PANJ_DT, E.SPG_DOCT_CD, E.SPG_MATT_CD, E.SPG_POSM1_TX, E.SPG_POSM1_DT, E.SPG_POSM2_TX, E.SPG_POSM2_DT, E.SPG_POSM3_TX, E.SPG_POSM3_DT, F_DOCTOR_FIND(1,E.SPG_DOCT_CD) SPG_DOCT_NM, E.SPG_POSM1_CD, E.SPG_POSM2_CD, E.SPG_POSM3_CD";
		...
		sql += ORDER_BY;
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_HEALTH_CUSTLIST_UF_SqlSet_004 \n";
			G_INFO += "설명 : 04-사후관리 추적검사자 명단 05-추가검사자 명단 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='EEA_ADD_DT' rs:number='33' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_EXAM_ACPT'
			 rs:basecolumn='EEA_ADD_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='EEA_ACPT_TX' rs:number='34' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_EXAM_ACPT'
			 rs:basecolumn='EEA_ACPT_TX'>
			<s:datatype dt:type='string' dt:maxLength='1000'/>
		</s:AttributeType>
		<s:AttributeType name='EEA_DEPT_NM' rs:number='35' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_EXAM_ACPT'
			 rs:basecolumn='EEA_DEPT_NM'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='SBE_TOBO_DT' rs:number='36' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_BASE'
			 rs:basecolumn='SBE_TOBO_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='SBE_RECHK_DT' rs:number='37' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_BASE'
			 rs:basecolumn='SBE_RECHK_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='SBE_SEND_YN' rs:number='38' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_BASE'
			 rs:basecolumn='SBE_SEND_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SBE_SEND_NM' rs:number='39' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_BASE'
			 rs:basecolumn='SBE_SEND_NM'>
			<s:datatype dt:type='string' dt:maxLength='50'/>
		</s:AttributeType>
		<s:AttributeType name='SPG_ORGA_CD' rs:number='40' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_PANJUNG'
			 rs:basecolumn='SPG_ORGA_CD'>
			<s:datatype dt:type='string' dt:maxLength='2'/>
		</s:AttributeType>
		<s:AttributeType name='SPG_SWING_CD' rs:number='41' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_PANJUNG'
			 rs:basecolumn='SPG_SWING_CD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SPG_PANJ_CD' rs:number='42' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_PANJUNG'
			 rs:basecolumn='SPG_PANJ_CD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SPG_PANJ_DT' rs:number='43' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_PANJUNG'
			 rs:basecolumn='SPG_PANJ_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='SPG_DOCT_CD' rs:number='44' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_PANJUNG'
			 rs:basecolumn='SPG_DOCT_CD'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='SPG_MATT_CD' rs:number='45' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_PANJUNG'
			 rs:basecolumn='SPG_MATT_CD'>
			<s:datatype dt:type='string' dt:maxLength='5'/>
		</s:AttributeType>
		<s:AttributeType name='SPG_POSM1_TX' rs:number='46' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_PANJUNG'
			 rs:basecolumn='SPG_POSM1_TX'>
			<s:datatype dt:type='string' dt:maxLength='200'/>
		</s:AttributeType>
		<s:AttributeType name='SPG_POSM1_DT' rs:number='47' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_PANJUNG'
			 rs:basecolumn='SPG_POSM1_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='SPG_POSM2_TX' rs:number='48' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_PANJUNG'
			 rs:basecolumn='SPG_POSM2_TX'>
			<s:datatype dt:type='string' dt:maxLength='200'/>
		</s:AttributeType>
		<s:AttributeType name='SPG_POSM2_DT' rs:number='49' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_PANJUNG'
			 rs:basecolumn='SPG_POSM2_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='SPG_POSM3_TX' rs:number='50' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_PANJUNG'
			 rs:basecolumn='SPG_POSM3_TX'>
			<s:datatype dt:type='string' dt:maxLength='200'/>
		</s:AttributeType>
		<s:AttributeType name='SPG_POSM3_DT' rs:number='51' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_PANJUNG'
			 rs:basecolumn='SPG_POSM3_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='SPG_DOCT_NM' rs:number='52' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='SPG_POSM1_CD' rs:number='53' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_PANJUNG'
			 rs:basecolumn='SPG_POSM1_CD'>
			<s:datatype dt:type='string' dt:maxLength='2'/>
		</s:AttributeType>
		<s:AttributeType name='SPG_POSM2_CD' rs:number='54' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_PANJUNG'
			 rs:basecolumn='SPG_POSM2_CD'>
			<s:datatype dt:type='string' dt:maxLength='2'/>
		</s:AttributeType>
		<s:AttributeType name='SPG_POSM3_CD' rs:number='55' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_PANJUNG'
			 rs:basecolumn='SPG_POSM3_CD'>
			<s:datatype dt:type='string' dt:maxLength='2'/>
		</s:AttributeType>
		<s:AttributeType name='ROWID' rs:number='56' rs:rowid='true' rs:basetable='ET_EXAM_ACPT' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c56' rs:name='ROWID' rs:number='57' rs:rowid='true' rs:basetable='IT_CUSTOMER' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c57' rs:name='ROWID' rs:number='58' rs:rowid='true' rs:basetable='IT_COMPANY' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c58' rs:name='ROWID' rs:number='59' rs:rowid='true' rs:basetable='ST_BASE' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c59' rs:name='ROWID' rs:number='60' rs:rowid='true' rs:basetable='ST_PANJUNG' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
