...
<%!
	public String func_uItem_BatchYN_btnSaveClick_003(Statement argStmtExec, HashMap argHtMethod) throws Exception {
		...
		try {
			...
			sql += " SET EEA_EXAM_LT = REPLACE(EEA_EXAM_LT, ?, ''), ";
			sql += " 	EEA_ADD_LT  = REPLACE(EEA_ADD_LT,  ?, '') ";
