...
select count(*) cnt from ET_RSLT_ITEM a left outer join IT_ITEM b on a.ERI_ITEM_CD = b.IIM_ITEM_CD
where  ERI_EXAM_DT = :EXAM_DT
   and ERI_EXAM_SQ = :EXAM_SQ
   and IIM_SBCD_CD = :SBCD_CD
		*/
		...
		sql += " AND IIM_SBCD_CD = '" + SBCD_CD + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : Uspchungfile2020_UDP_RESULT_002 \n";
			G_INFO += "설명 : 검진결과 조회(2차)  LDL실측정 유무 확인 \n";
			G_INFO += "\n\n";
