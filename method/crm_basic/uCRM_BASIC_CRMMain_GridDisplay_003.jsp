...
select a.*,
           b.icr_penl_id, b.icr_pid_en, b.icr_birh_dt, b.ICR_NTNA_CD,
       dbo.f_tel_format(a.rrt_mobl_no) rrt_mobl_no2,
       dbo.f_tel_format(a.rrt_tel_no)  rrt_tel_no2,
       dbo.F_COMP_FIND(a.rrt_comp_cd) rrt_comp_nm, dbo.f_user_find(a.rrt_inpt_id) rrt_inpt_nm,
       dbo.F_CODE_FIND('0711', RRT_MMBR_CD, '', '1') RRT_MMBR_NM,
       dbo.F_CODE_FIND('0703', ICR_NTNA_CD, '', '1') RRT_NATI_NM,
       dbo.F_CODE_FIND('0712', RRT_SEND_CD, '', '1') RRT_SEND_NM,
       dbo.F_CODE_FIND('0919', RRT_FAMY_CD, '', '1') FAMY_CD,
        B.ICR_CUST_TX
from rt_rsvt a
left outer join it_customer b on b.icr_cust_no = a.rrt_cust_no
where a.rrt_exam_dt >= :sEXAM_DT
 and a.rrt_exam_dt <= :eEXAM_DT
 and substring(a.rrt_exam_cd, 1, 2) <> '31'
 And A.RRT_EXAM_SQ = ' '
 ...
 || :sSQL_ADD3
		...
		*/
		...
		sql = " SELECT A.*, B.ICR_PENL_ID, B.ICR_PID_EN, B.ICR_BIRH_DT, B.ICR_NTNA_CD, F_TEL_FORMAT(A.RRT_MOBL_NO) RRT_MOBL_NO2, ";
		sql += " F_TEL_FORMAT(A.RRT_TEL_NO) RRT_TEL_NO2, F_COMP_FIND(A.RRT_COMP_CD) RRT_COMP_NM, F_USER_FIND(A.RRT_INPT_ID) RRT_INPT_NM, ";
		sql += " F_CODE_FIND('0711', RRT_MMBR_CD, ' ', '1') RRT_MMBR_NM, ";
		sql += " F_CODE_FIND('0703', ICR_NTNA_CD, ' ', '1') RRT_NATI_NM, ";
		sql += " F_CODE_FIND('0712', RRT_SEND_CD, ' ', '1') RRT_SEND_NM, ";
		sql += " F_CODE_FIND('0919', RRT_FAMY_CD, ' ', '1') FAMY_CD, ";
		...
		sql += SSQL_ADD3;
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCRM_BASIC_CRMMain_GridDisplay_003 \n";
			G_INFO += "설명 : 환자관리-예약조회 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='ICR_PENL_ID' rs:number='106' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_CUSTOMER'
			 rs:basecolumn='ICR_PENL_ID'>
			<s:datatype dt:type='string' dt:maxLength='13'/>
		</s:AttributeType>
		<s:AttributeType name='ICR_PID_EN' rs:number='107' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_CUSTOMER'
			 rs:basecolumn='ICR_PID_EN'>
			<s:datatype dt:type='string' dt:maxLength='2000'/>
		</s:AttributeType>
		<s:AttributeType name='ICR_BIRH_DT' rs:number='108' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_CUSTOMER'
		...
		<s:AttributeType name='RRT_MOBL_NO2' rs:number='110' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='RRT_TEL_NO2' rs:number='111' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='RRT_COMP_NM' rs:number='112' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='RRT_INPT_NM' rs:number='113' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='RRT_MMBR_NM' rs:number='114' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='RRT_NATI_NM' rs:number='115' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='RRT_SEND_NM' rs:number='116' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='FAMY_CD' rs:number='117' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='RRT_EXAM_NM' rs:number='118' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_CUSTOMER'
			 rs:basecolumn='RRT_EXAM_NM'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='ICR_CUST_TX' rs:number='119' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_CUSTOMER'
			 rs:basecolumn='ICR_CUST_TX'>
			<s:datatype dt:type='string' dt:maxLength='400'/>
		</s:AttributeType>
		<s:AttributeType name='ROWID' rs:number='120' rs:rowid='true' rs:basetable='RT_RSVT' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c119' rs:name='ROWID' rs:number='121' rs:rowid='true' rs:basetable='IT_CUSTOMER' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
...
<%
		...
		while(cRsList.next()) {
			...
			String RRT_MOBL_NO2_T = cRsList.getString("RRT_MOBL_NO2");
			String RRT_TEL_NO2_T = cRsList.getString("RRT_TEL_NO2");
			String RRT_COMP_NM_T = cRsList.getString("RRT_COMP_NM");
			String RRT_INPT_NM_T = cRsList.getString("RRT_INPT_NM");
			String RRT_MMBR_NM_T = cRsList.getString("RRT_MMBR_NM");
			String RRT_NATI_NM_T = cRsList.getString("RRT_NATI_NM");
			String RRT_SEND_NM_T = cRsList.getString("RRT_SEND_NM");
			...
			String c119_T = cRsList.getString("c119");
%>
			<z:row
<%
...
<%
			...
			if(! RRT_MOBL_NO2_T.equals("")) {
%>
		 		RRT_MOBL_NO2='<%= RRT_MOBL_NO2_T%>'
<%
			}

			if(! RRT_TEL_NO2_T.equals("")) {
%>
		 		RRT_TEL_NO2='<%= RRT_TEL_NO2_T%>'
<%
			}
...
<%
			...
			if(! RRT_MMBR_NM_T.equals("")) {
%>
		 		RRT_MMBR_NM='<%= RRT_MMBR_NM_T%>'
<%
			}

			if(! RRT_NATI_NM_T.equals("")) {
%>
		 		RRT_NATI_NM='<%= RRT_NATI_NM_T%>'
<%
			}

			if(! RRT_SEND_NM_T.equals("")) {
%>
		 		RRT_SEND_NM='<%= RRT_SEND_NM_T%>'
<%
			}
