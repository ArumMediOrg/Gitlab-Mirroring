...
<%
		...
		sql += " 							ET_EXAM_ACPT.EEA_SEX_CD, ET_EXAM_ACPT.EEA_PSNL_AGE, IT_ITEM.IIM_SBCD_CD ";
		...
		sql += " 					) A ";
		sql += " 			LEFT OUTER JOIN TABLE(GetItemVldtTable_PKG.GetItemVldtTable(A.ERI_ITEM_CD, A.EEA_SEX_CD, A.EEA_PSNL_AGE, A.ERI_EXAM_DT, '4')) B ";
		sql += " 				ON B.ITEM_CD = A.ERI_ITEM_CD ";

			//
		G_INFO += "<!-- \n";
		G_INFO += "서비스명 : ufireman_UP_SqlOpen_003 \n";
		G_INFO += "설명 : 검사 결과 조회 \n";
		G_INFO += "\n\n";
