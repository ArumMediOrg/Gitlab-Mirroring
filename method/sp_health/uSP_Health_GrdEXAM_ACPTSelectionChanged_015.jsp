...
<%
		...
		sql = " SELECT A.EEA_MNGT_SPYM, A.EEA_DIVI_CD, A.EEA_DEPT_CD, A.EEA_DEPT_NM, A.EEA_ENTRY_DT, A.EEA_NOTE_YN, A.EEA_DIVI_NO, B.ICR_NTNA_CD, D.ERI_SPRT_CD, D.ERI_RSLT_VL ERI_XRAY_NO, C.*";
		...
		sql += " AND C.SBE_EXAM_CHA = '" + EXAM_CHA + "' LEFT OUTER JOIN ET_RSLT_ITEM D";
		sql += " ON A.EEA_EXAM_DT = D.ERI_EXAM_DT";
		sql += " AND A.EEA_EXAM_SQ = D.ERI_EXAM_SQ";
		sql += " AND D.ERI_ITEM_CD = 'F0002'";
		sql += " WHERE A.EEA_EXAM_DT = '" + EXAM_DT + "'";
		sql += " AND A.EEA_EXAM_SQ = '" + EXAM_SQ + "'";
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_Health_GrdEXAM_ACPTSelectionChanged_015 \n";
			G_INFO += "설명 : 특검 기초관리 내용 조회 \n";
			G_INFO += "\n\n";
