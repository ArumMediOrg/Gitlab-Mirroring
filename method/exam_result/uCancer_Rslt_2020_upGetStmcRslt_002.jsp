...
select ERI_ITEM_CD
 ...
 where ERI_EXAM_DT = :EXAM_DT
   ...
   and ERI_ITEM_CD in ('BJ006','BJ007','BJ008','BJ009','BJ010')
   and ERI_HLTH_KD <> '0'
   and ERI_CNCL_YN <> 'Y'
		*/
		...
		sql += " AND ERI_ITEM_CD IN ('BJ006','BJ007','BJ008','BJ009','BJ010')";
		sql += " AND ERI_HLTH_KD <> '0'";
		sql += " AND ERI_CNCL_YN <> 'Y'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCancer_Rslt_2020_upGetStmcRslt_002 \n";
			G_INFO += "설명 : 위조직 시행여부 체크 \n";
			G_INFO += "\n\n";
