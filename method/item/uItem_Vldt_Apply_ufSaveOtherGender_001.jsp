...
<%
		...
		String ASEX_CD = htMethod.get("ASEX_CD");
		...
		sql = func_uItem_Vldt_Apply_ufSaveOtherGender_001(stmtExec, htMethod);

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uItem_Vldt_Apply_ufSaveOtherGender_001 \n";
			G_INFO += "설명 : 참고치 저장(복사 기능) \n";
			G_INFO += "\n\n";

			G_INFO += "전달인자 : \n";
			G_INFO += " ASEX_CD : " + ASEX_CD + " \n";
