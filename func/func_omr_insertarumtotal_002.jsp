...
<%!
	public String func_omr_insertarumtotal_002(Statement argStmtExec, HashMap argHtMethod) throws Exception {
		...
		try {
			...
			sql = "INSERT INTO ARUM_TOTAL (REQUEST_DATE, SCANDATE, FILENAME, FORMNAME, EXAM_NAME, CHART_NO, CUST_NO, JUMIN1, JUMIN2, SERIAL, OMRYN, VALUYN, SENDYN, INDEXYN, LOGINID) VALUES (";
			sql += "  '" + REQUEST_DATE + "'";
			sql += ", '" + SCANDATE + "'";
			sql += ", '" + FILENAME + "'";
			sql += ", '" + FORMNAME + "'";
