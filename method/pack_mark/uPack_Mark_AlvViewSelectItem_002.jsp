...
select a.emi_item_cd item_cd, a.emi_rslt_up item_up, a.emi_rslt_dn item_dn, a.emi_use_yn use_yn,
       f_item_find('', a.emi_item_cd, 'K') item_nm,
       f_item_find('', a.emi_item_cd, 'S') prnt_nm,
       f_ocs_find(a.emi_item_cd) ocs_cd
from et_pack_mark_item a
where a.emi_mark_kd = '1'
...
order by a.emi_sort_sq
		...
		*/
		...
		sql = " SELECT A.EMI_ITEM_CD ITEM_CD, A.EMI_RSLT_UP ITEM_UP, A.EMI_RSLT_DN ITEM_DN, A.EMI_USE_YN USE_YN, F_ITEM_FIND('', A.EMI_ITEM_CD, 'K') ITEM_NM, F_ITEM_FIND('', A.EMI_ITEM_CD, 'S') PRNT_NM, F_OCS_FIND(A.EMI_ITEM_CD) OCS_CD";
		sql += " FROM ET_PACK_MARK_ITEM A";
		sql += " WHERE A.EMI_MARK_KD = '1'";
		...
		sql += " ORDER BY A.EMI_SORT_SQ";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uPack_Mark_AlvViewSelectItem_002 \n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='ITEM_UP' rs:number='2' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_PACK_MARK_ITEM'
			 rs:basecolumn='EMI_RSLT_UP'>
			<s:datatype dt:type='string' dt:maxLength='2000'/>
		</s:AttributeType>
		<s:AttributeType name='ITEM_DN' rs:number='3' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_PACK_MARK_ITEM'
			 rs:basecolumn='EMI_RSLT_DN'>
			<s:datatype dt:type='string' dt:maxLength='2000'/>
		</s:AttributeType>
		<s:AttributeType name='USE_YN' rs:number='4' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_PACK_MARK_ITEM'
			 rs:basecolumn='EMI_USE_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ITEM_NM' rs:number='5' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='PRNT_NM' rs:number='6' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='OCS_CD' rs:number='7' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
