...
<%
      ...
      SELECT CSC_LARGE, SUBSTR(CSC_SMALL,3,2) CSC_SMALL, CSC_FULL_NM FROM CT_SP_COMMON 
                  WHERE CSC_LARGE = :sLarge AND SUBSTR(CSC_SMALL,1,2) = :sSmall
		...
		*/
		...
		sql = " SELECT CSC_LARGE, SUBSTR(CSC_SMALL,3,2) CSC_SMALL, CSC_FULL_NM";
		sql += " FROM CT_SP_COMMON";
		sql += " WHERE CSC_LARGE = '" + SLARGE + "'";
		sql += " AND SUBSTR(CSC_SMALL,1,2) = '" + SSMALL + "'";
		...
		sql += " ORDER BY CSC_SMALL";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : UFM_Common_GP_ComboSetting_001___16 \n";
			G_INFO += "설명 : 구분값에 따른 콤보박스 정보 로딩___16 \n";
			G_INFO += "\n\n";
