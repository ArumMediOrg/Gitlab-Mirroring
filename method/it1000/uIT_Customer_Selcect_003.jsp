...
<%
		...
		sql += " WHERE CCN_LARGE = '0711' ";
		sql += " AND CCN_LEVEL = '5' ";
		sql += " AND CCN_USE_YN = 'Y' ";
		sql += " AND CCN_SMALL = A.ICR_MMBR_CD) MMBR_CD, ";
		sql += " (SELECT CCN_FULL_NM FROM CT_COMMON ";
		sql += " WHERE CCN_LARGE = '0702' ";
		sql += " AND CCN_LEVEL = '5' ";
		sql += " AND CCN_USE_YN = 'Y' ";
		sql += " AND CCN_SMALL = A.ICR_MANA_KD) MANA_KD, ";
		sql += " (SELECT CCN_FULL_NM FROM CT_COMMON ";
		sql += " WHERE CCN_LARGE = '0701' ";
		sql += " AND CCN_LEVEL = '5' ";
		sql += " AND CCN_USE_YN = 'Y' ";
		sql += " AND CCN_SMALL = A.ICR_CUST_KD) CUST_KD, ";
		sql += " (SELECT CCN_FULL_NM FROM CT_COMMON ";
		sql += " WHERE CCN_LARGE = '0703' ";
		sql += " AND CCN_LEVEL = '5' ";
		sql += " AND CCN_USE_YN = 'Y' ";
		sql += " AND CCN_SMALL = A.ICR_NTNA_CD) NTNA_CD, ";
		sql += " A.* ";
		...
		sql += SSQL_ADD;
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uIT_Customer_Selcect_003 \n";
			G_INFO += "설명 : 인적정보 조회 \n";
			G_INFO += "\n\n";
