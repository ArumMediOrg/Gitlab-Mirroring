...
SELECT CSC_FULL_NM, CSC_ETC1_CD
 ...
 WHERE CSC_LARGE = ''HM06D''
   AND SUBSTRING(CSC_SMALL,1,3) =  :CSC_SMALL
   AND CSC_LEVEL = ''5''
 ORDER BY CSC_SMALL
		*/
		...
		sql += " AND SUBSTR(CSC_SMALL,1,3) = '" + CSC_SMALL + "'";
		sql += " AND CSC_LEVEL = '5'";
		sql += " ORDER BY CSC_SMALL";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uItem_Vldt_Apply_grdCharValGetEditorProp_001 \n";
			G_INFO += "설명 : 특검 공통코드 조회 \n";
			G_INFO += "\n\n";
