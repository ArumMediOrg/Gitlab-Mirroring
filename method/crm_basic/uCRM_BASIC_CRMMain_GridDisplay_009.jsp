...
SELECT EEA_EXAM_DT, EEA_EXAM_SQ,  EEA_ACPT_TX, EEA_SPCL_LT,  EEA_HTSB_YN, EEA_SPSB_YN,   
       dbo.GetCOMMON_LvCdToNm('0401',EEA_EXAM_CD ,'5',5) EEA_EXAM_NM,                
       dbo.GetCOMMON_LvCdToNm('0401',EEA_HTSB_CD ,'5',5) EEA_HTSB_NM,                
       dbo.GetCOMMON_LvCdToNm('0401',EEA_SPSB_CD ,'5',5) EEA_SPSB_NM,                
       dbo.GetCOMMON_LvCdToNm('0401',EEA_CVSB_CD ,'5',5) EEA_CVSB_NM,                
       dbo.GetCOMMON_LvCdToNm('0401',EEA_EMSB_CD ,'5',5) EEA_EMSB_NM,                
       dbo.GetCOMMON_LvCdToNm('0401',EEA_ETSB_CD ,'5',5) EEA_ETSB_NM,                
       CASE WHEN (EEA_EXAM_CD   = '14001') OR (EEA_ORAL_YN = 'N') THEN ''          
            else EEA_ORAL_YN END EEA_ORAL_YN,                                            
       CASE WHEN EEA_STOMA_CD  = '0' THEN ''                                         
            else dbo.GetCOMMON_LvCdToNm('0915',EEA_STOMA_CD ,'5',1) END EEA_STOMA_NM,
       CASE WHEN EEA_COLON_CD  = '0' THEN ''                                         
            else dbo.GetCOMMON_LvCdToNm('0915',EEA_COLON_CD ,'5',1) END EEA_COLON_NM,
       CASE WHEN EEA_LIVER_CD  = '0' THEN ''                                         
            else dbo.GetCOMMON_LvCdToNm('0915',EEA_LIVER_CD ,'5',1) END EEA_LIVER_NM,
       CASE WHEN EEA_BAST_CD   = '0' THEN ''                                         
            else dbo.GetCOMMON_LvCdToNm('0915',EEA_BAST_CD  ,'5',1) END EEA_BAST_NM, 
       CASE WHEN EEA_UTER_CD   = '0' THEN ''                                         
            else dbo.GetCOMMON_LvCdToNm('0915',EEA_UTER_CD  ,'5',1) END EEA_UTER_NM, 
       dbo.GetCOMMON_LvCdToNm('0910',EEA_SPCL_CD ,'5',2) EEA_SPCL_NM                 
  FROM ET_EXAM_ACPT                                                                      
 WHERE EEA_CUST_NO = :sRSVN_NO
   AND EEA_ORDER_YN <> 'C'                                                             
 ORDER BY EEA_EXAM_DT desc
		*/

		sql = " SELECT EEA_EXAM_DT, EEA_EXAM_SQ, EEA_ACPT_TX, EEA_SPCL_LT, EEA_HTSB_YN, EEA_SPSB_YN, GETCOMMON_LVCDTONM('0401',EEA_EXAM_CD ,'5',5) EEA_EXAM_NM, GETCOMMON_LVCDTONM('0401',EEA_HTSB_CD ,'5',5) EEA_HTSB_NM, GETCOMMON_LVCDTONM('0401',EEA_SPSB_CD ,'5',5) EEA_SPSB_NM, GETCOMMON_LVCDTONM('0401',EEA_CVSB_CD ,'5',5) EEA_CVSB_NM, GETCOMMON_LVCDTONM('0401',EEA_EMSB_CD ,'5',5) EEA_EMSB_NM, GETCOMMON_LVCDTONM('0401',EEA_ETSB_CD ,'5',5) EEA_ETSB_NM, CASE WHEN (EEA_EXAM_CD = '14001')";
		sql += " OR (EEA_ORAL_YN = 'N') THEN '' ELSE EEA_ORAL_YN END EEA_ORAL_YN, CASE WHEN EEA_STOMA_CD = '0' THEN '' ELSE GETCOMMON_LVCDTONM('0915',EEA_STOMA_CD ,'5',1) END EEA_STOMA_NM, CASE WHEN EEA_COLON_CD = '0' THEN '' ELSE GETCOMMON_LVCDTONM('0915',EEA_COLON_CD ,'5',1) END EEA_COLON_NM, CASE WHEN EEA_LIVER_CD = '0' THEN '' ELSE GETCOMMON_LVCDTONM('0915',EEA_LIVER_CD ,'5',1) END EEA_LIVER_NM, CASE WHEN EEA_BAST_CD = '0' THEN '' ELSE GETCOMMON_LVCDTONM('0915',EEA_BAST_CD ,'5',1) END EEA_BAST_NM, CASE WHEN EEA_UTER_CD = '0' THEN '' ELSE GETCOMMON_LVCDTONM('0915',EEA_UTER_CD ,'5',1) END EEA_UTER_NM, GETCOMMON_LVCDTONM('0910',EEA_SPCL_CD ,'5',2) EEA_SPCL_NM";
		sql += " FROM ET_EXAM_ACPT";
		sql += " WHERE EEA_CUST_NO = '" + SRSVN_NO + "'";
		sql += " AND EEA_ORDER_YN <> 'C'";
		sql += " ORDER BY EEA_EXAM_DT DESC";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCRM_BASIC_CRMMain_GridDisplay_009 \n";
			G_INFO += "설명 : 상담관리-환자정보 수진정보 이력 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='EEA_ACPT_TX' rs:number='3' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_EXAM_ACPT'
