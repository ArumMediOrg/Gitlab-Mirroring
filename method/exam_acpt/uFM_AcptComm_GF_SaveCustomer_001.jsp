...
<%
		...
		String PENL_SQ = htMethod.get("PENL_SQ");
		...
		String REGION_CD = htMethod.get("REGION_CD");
		String USER_ID = htMethod.get("USER_ID");
		String COMPAR_YN = htMethod.get("COMPAR_YN");
		...
		sql = func_uFM_AcptComm_GF_SaveCustomer_001(stmtExec, htMethod);

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uFM_AcptComm_GF_SaveCustomer_001 \n";
			G_INFO += "설명 : 고객정보 저장 \n";
			G_INFO += "\n\n";
			...
			G_INFO += " REGION_CD : " + REGION_CD + " \n";
			G_INFO += " USER_ID : " + USER_ID + " \n";
			G_INFO += " COMPAR_YN : " + COMPAR_YN + " \n";
