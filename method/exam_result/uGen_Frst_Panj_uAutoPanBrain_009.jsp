...
<%
		...
		String DANR_AGE = htMethod.get("DANR_AGE");
		String SEX_KD = htMethod.get("SEX_KD");

		//
		if(DANR_AGE == null) { DANR_AGE = ""; }
 ...
 WHERE CDR_DANR_KD  = ''2''
   ...
   AND CDR_SEX_KD   = :SEX_KD
		*/
		...
		sql += " AND CDR_DANR_AGE = '" + DANR_AGE + "'";
		sql += " AND CDR_SEX_KD = '" + SEX_KD + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uGen_Frst_Panj_uAutoPanBrain_009 \n";
			G_INFO += "설명 : 뇌심혈관판정(위험도평가CT_DANGER 조회 2) \n";
			G_INFO += "\n\n";

			G_INFO += "전달인자 : \n";
			G_INFO += " DANR_AGE : " + DANR_AGE + " \n";
