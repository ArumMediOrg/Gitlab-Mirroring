...
WHERE ERI_EXAM_DT = :Ms_Date
   AND ERI_EXAM_SQ = :Ms_Sq
   ...
   AND ERI_ITEM_CD IN ('A0009', 'A0006', 'A0014', 'A0015',
		...
		*/
		...
		sql += " WHERE ERI_EXAM_DT = '" + MS_DATE + "'";
		sql += " AND ERI_EXAM_SQ = '" + MS_SQ + "'";
		sql += " AND NVL(ERI_CNCL_YN, 'N') <> 'Y'";
		sql += " AND ERI_ITEM_CD IN ('A0009', 'A0006', 'A0014', 'A0015', 'BA014', 'BA009', 'S0253', 'BF007', 'BA012', 'BA011','A0002')";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uAutoBrain_uAutoPanBrain_002 \n";
			G_INFO += "설명 : 각코드에 대한 검사결과 로딩 \n";
			G_INFO += "\n\n";
