...
<%!
	public String func_uCOMP_CNRT_RzBmpButton1Click_003(Statement argStmtExec, HashMap argHtMethod) throws Exception {
		...
		try {
			...
			sql = "DELETE ET_COMP_CNRT_PROF_ITEM";
