...
Select CASE WHEN A.PLP_JLPN_DSCD = '0SH' then '기타질환'                                                         
 ...
 Order By A.PLP_JLPN_DSCD                                                                                            
		...
		*/
		...
		sql = " SELECT CASE WHEN A.PLP_JLPN_DSCD = '0SH' THEN '기타질환' WHEN A.PLP_JLPN_DSCD = '1SH' THEN '폐결핵/흉부' WHEN A.PLP_JLPN_DSCD = '2SH' THEN '고혈압' WHEN A.PLP_JLPN_DSCD = '3SH' THEN '당뇨' WHEN A.PLP_JLPN_DSCD = '4SH' THEN '이상지질혈' WHEN A.PLP_JLPN_DSCD = '5SH' THEN '빈혈' WHEN A.PLP_JLPN_DSCD = '6SH' THEN '청력' WHEN A.PLP_JLPN_DSCD = '7SH' THEN '간장질환' WHEN A.PLP_JLPN_DSCD = '8SH' THEN '신장질환' WHEN A.PLP_JLPN_DSCD = '9SH' THEN '비만' ELSE '' END PLP_JLPN_DSCD, A.PLP_JLPN_PNCD";
		sql += ", CASE WHEN A.PLP_JLPN_SH01 = '1' THEN '건강상담' WHEN A.PLP_JLPN_SH01 = '2' THEN '보호구지급 및 착용지도' WHEN A.PLP_JLPN_SH01 = '3' THEN '추적검사검사항목에 대하여 추적검사가 필요' WHEN A.PLP_JLPN_SH01 = '4' THEN '근무중에 대하여 치료' WHEN A.PLP_JLPN_SH01 = '5' THEN '근로시간 단축' WHEN A.PLP_JLPN_SH01 = '6' THEN '작업전환' WHEN A.PLP_JLPN_SH01 = '7' THEN '근로제한 및 금지' WHEN A.PLP_JLPN_SH01 = '8' THEN '산재요양신청서 직접 작성 등 당해 근로자에 대한 직업병확진의뢰 안내 ' WHEN A.PLP_JLPN_SH01 = '9' THEN '기타' ELSE '' END PLP_JLPN_SH01";
		sql += ", CASE WHEN A.PLP_JLPN_SH02 = '1' THEN '건강상담' WHEN A.PLP_JLPN_SH02 = '2' THEN '보호구지급 및 착용지도' WHEN A.PLP_JLPN_SH02 = '3' THEN '추적검사검사항목에 대하여 추적검사가 필요' WHEN A.PLP_JLPN_SH02 = '4' THEN '근무중에 대하여 치료' WHEN A.PLP_JLPN_SH02 = '5' THEN '근로시간 단축' WHEN A.PLP_JLPN_SH02 = '6' THEN '작업전환' WHEN A.PLP_JLPN_SH02 = '7' THEN '근로제한 및 금지' WHEN A.PLP_JLPN_SH02 = '8' THEN '산재요양신청서 직접 작성 등 당해 근로자에 대한 직업병확진의뢰 안 내' WHEN A.PLP_JLPN_SH02 = '9' THEN '기타' ELSE '' END PLP_JLPN_SH02";
		sql += ", CASE WHEN A.PLP_JLPN_SH03 = '1' THEN '건강상담' WHEN A.PLP_JLPN_SH03 = '2' THEN '보호구지급 및 착용지도' WHEN A.PLP_JLPN_SH03 = '3' THEN '추적검사검사항목에 대하여 추적검사가 필요' WHEN A.PLP_JLPN_SH03 = '4' THEN '근무중에 대하여 치료' WHEN A.PLP_JLPN_SH03 = '5' THEN '근로시간 단축' WHEN A.PLP_JLPN_SH03 = '6' THEN '작업전환' WHEN A.PLP_JLPN_SH03 = '7' THEN '근로제한 및 금지' WHEN A.PLP_JLPN_SH03 = '8' THEN '산재요양신청서 직접 작성 등 당해 근로자에 대한 직업병확진의뢰 안내 ' WHEN A.PLP_JLPN_SH03 = '9' THEN '기타' ELSE '' END PLP_JLPN_SH03";
		...
		sql += " ORDER BY A.PLP_JLPN_DSCD";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uPostManagement_NEWCustList_APPLY_UP_PanjungDispaly_010 \n";
			G_INFO += "설명 : 노동부 판정정보 로딩 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='PLP_JLPN_DSCD' rs:number='1' rs:nullable='true' rs:writeunknown='true' rs:basetable='PT_LABOR_PANJUNG'
			 rs:basecolumn='PLP_JLPN_DSCD'>
			<s:datatype dt:type='string' dt:maxLength='11'/>
		</s:AttributeType>
		<s:AttributeType name='PLP_JLPN_PNCD' rs:number='2' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='2'/>
		</s:AttributeType>
		<s:AttributeType name='PLP_JLPN_SH01' rs:number='3' rs:nullable='true' rs:writeunknown='true' rs:basetable='PT_LABOR_PANJUNG'
			 rs:basecolumn='PLP_JLPN_SH01'>
			<s:datatype dt:type='string' dt:maxLength='67'/>
		</s:AttributeType>
		<s:AttributeType name='PLP_JLPN_SH02' rs:number='4' rs:nullable='true' rs:writeunknown='true' rs:basetable='PT_LABOR_PANJUNG'
			 rs:basecolumn='PLP_JLPN_SH02'>
			<s:datatype dt:type='string' dt:maxLength='67'/>
		</s:AttributeType>
		<s:AttributeType name='PLP_JLPN_SH03' rs:number='5' rs:nullable='true' rs:writeunknown='true' rs:basetable='PT_LABOR_PANJUNG'
			 rs:basecolumn='PLP_JLPN_SH03'>
			<s:datatype dt:type='string' dt:maxLength='67'/>
		</s:AttributeType>
		<s:AttributeType name='PLP_JLPN_SHDS' rs:number='6' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='PLP_JLPN_DOCV' rs:number='7' rs:nullable='true' rs:writeunknown='true' rs:basetable='PT_LABOR_PANJUNG'
			 rs:basecolumn='PLP_JLPN_DOCV'>
			<s:datatype dt:type='string' dt:maxLength='400'/>
		</s:AttributeType>
		<s:AttributeType name='PLP_ETC_EX' rs:number='8' rs:nullable='true' rs:writeunknown='true' rs:basetable='PT_LABOR_PANJUNG'
			 rs:basecolumn='PLP_ETC_EX'>
			<s:datatype dt:type='string' dt:maxLength='60'/>
		</s:AttributeType>
		<s:AttributeType name='PFP_DOCTORFIR' rs:number='9' rs:nullable='true' rs:writeunknown='true' rs:basetable='PT_FIR_PANJUNG'
			 rs:basecolumn='PFP_DOCTORFIR'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='IAU_PENL_NM' rs:number='10' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
		...
		<s:AttributeType name='c11' rs:name='ROWID' rs:number='12' rs:rowid='true' rs:basetable='PT_FIR_PANJUNG' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c12' rs:name='ROWID' rs:number='13' rs:rowid='true' rs:basetable='IT_AUTH_USER' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
