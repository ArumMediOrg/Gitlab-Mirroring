...
<%
		...
		String NUSE_DTT = htMethod.get("NUSE_DTT");
		...
		sql = func_uCOMP_CNRT_CUST_APPLY_UF_Save_001(stmtExec, htMethod);

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCOMP_CNRT_CUST_APPLY_UF_Save_001 \n";
			G_INFO += "설명 : 명단관리 저장(insert) \n";
			G_INFO += "\n\n";
