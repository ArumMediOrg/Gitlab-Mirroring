...
SELECT SUBSTR(:EXAM_DT, 1, 4) EXAM_YR, LTRIM(RTRIM(A.IIM_ITEM_CD)) EXAM_CD, LTRIM(RTRIM(A.IIM_KNME_NM)) EXAM_NM, 
       '0000' || SUBSTR(C.IIC_STDTO_KD, 2, 1) AS EXAM_KD, 
 ...
 ORDER BY A.IIM_EXGN_CD, A.IIM_SORT_SQ, A.IIM_ITEM_CD
		*/
		...
		sql = " SELECT SUBSTR('" + EXAM_DT + "', 1, 4) EXAM_YR, LTRIM(RTRIM(A.IIM_ITEM_CD)) EXAM_CD, LTRIM(RTRIM(A.IIM_KNME_NM)) EXAM_NM, '0000' || SUBSTR(C.IIC_STDTO_KD, 2, 1) AS EXAM_KD, '" + EXAM_DT + "' PRCE_DT, '1' CALC_CD, B.IIP_GBSG_PR STDT_PR, B.IIP_GASN_PR GASN_PR";
		...
		sql += " ORDER BY A.IIM_EXGN_CD, A.IIM_SORT_SQ, A.IIM_ITEM_CD";
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uStdt_AcptO_UP_StdtItem_002 \n";
