...
Select Count(*) Max From IT_AUTH_USER
 Where IAU_DEPT_CD = :DEPT_CD
   And IAU_USE_YN  = :USE_YN
		*/

		sql = " SELECT COUNT(*) MAX";
		sql += " FROM IT_AUTH_USER";
		sql += " WHERE IAU_DEPT_CD = '" + DEPT_CD + "'";
		sql += " AND IAU_USE_YN = '" + USE_YN + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_Health_GrdEXAM_ACPTSelectionChanged_016 \n";
			G_INFO += "설명 : 특검 특정부서  의사 조회(의사수)-흉부검사 \n";
			G_INFO += "\n\n";
