...
:sSQL_ADD1
 ORDER BY A.SAE_ADVI_DT DESC, A.SAE_ADVI_SQ DESC
		*/
		...
		sql += " Left Outer Join RT_RSVT B ON A.SAE_RSVT_NO = B.RRT_RSVN_NO " ;
		...
		sql += " ORDER BY A.SAE_ADVI_DT DESC, A.SAE_ADVI_SQ DESC " ;
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCRM_BASIC_CRMMain_GridDisplay_020 \n";
			G_INFO += "설명 : 상담관리-예약-상담정보 \n";
			G_INFO += "\n\n";
