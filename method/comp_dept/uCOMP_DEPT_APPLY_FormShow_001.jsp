...
SELECT '[1]' || GetSP_COMMON_cdToNm('HM99G','1') VIP_ITKD_NM, A.*
  FROM VIEW_IT_ITEM_PRICE A
 WHERE NVL(VIP_SBCD_CD, ' ') <> ' '
 ORDER BY VIP_APLY_DT DESC
		*/

		sql = " SELECT '[1]' || GETSP_COMMON_CDTONM('HM99G','1') VIP_ITKD_NM, A.*";
		...
		sql += " ORDER BY VIP_APLY_DT DESC";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCOMP_DEPT_APPLY_FormShow_001 \n";
			G_INFO += "설명 : 특검검사항목 수가 내역 조회 \n";
			G_INFO += "\n\n";
