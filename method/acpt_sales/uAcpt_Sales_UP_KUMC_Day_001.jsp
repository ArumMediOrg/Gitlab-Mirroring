...
<%
		...
		sql += " 					WHEN EEA_DISC_RC = 'A050' THEN '02' ";
		sql += " 					WHEN EEA_DISC_RC = 'A040' THEN '03' ";
		sql += " 					WHEN EEA_DISC_RC = 'A060' THEN '04' ";
		sql += " 					WHEN EEA_DISC_RC = 'A010' THEN '05' ";
		sql += " 					WHEN EEA_DISC_RC = 'A030' THEN '06' ";
		sql += " 					WHEN EEA_DISC_RC = 'A020' THEN '07' ";
