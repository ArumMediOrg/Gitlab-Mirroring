...
SELECT A.CSM_LARGE,   A.CSM_MATT_CD, A.CSM_INJA_CD, C.CSC_FULL_NM AS CSM_INJA_NM,
       A.CSM_MATT_NM, B.CSC_ETC1_NM, B.CSC_ETC1_CD, B.CSC_ETC2_NM, B.CSC_ETC2_CD 
FROM CT_SP_MATTER A                                                              
LEFT OUTER JOIN CT_SP_COMMON B ON A.CSM_COMM_CD = B.CSC_SMALL                    
                              AND B.CSC_LARGE = 'HM99A'                        
LEFT OUTER JOIN CT_SP_COMMON C ON A.CSM_INJA_CD = C.CSC_SMALL                    
                              AND C.CSC_LARGE = 'HM06B'                        
Where A.CSM_MATT_CD <> '00'                                                    
Order By A.CSM_MATT_CD     
		*/

		sql = " SELECT A.CSM_LARGE, A.CSM_MATT_CD, A.CSM_INJA_CD, C.CSC_FULL_NM AS CSM_INJA_NM, A.CSM_MATT_NM, B.CSC_ETC1_NM, B.CSC_ETC1_CD, B.CSC_ETC2_NM, B.CSC_ETC2_CD";
		...
		sql += " WHERE A.CSM_MATT_CD <> '00'";
		sql += " ORDER BY A.CSM_MATT_CD";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uIT_ChungGU_Move_Up_afload_per_002 \n";
			G_INFO += "설명 : 특검 문진정보 로딩 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='CSM_INJA_NM' rs:number='4' rs:nullable='true' rs:writeunknown='true' rs:basetable='CT_SP_COMMON'
			 rs:basecolumn='CSC_FULL_NM'>
			<s:datatype dt:type='string' dt:maxLength='500'/>
		</s:AttributeType>
		<s:AttributeType name='CSM_MATT_NM' rs:number='5' rs:writeunknown='true' rs:basetable='CT_SP_MATTER' rs:basecolumn='CSM_MATT_NM'>
