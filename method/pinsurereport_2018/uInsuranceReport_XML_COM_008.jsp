...
<%
		...
		sql = " SELECT ICY_ZIP_CD, ICY_ZIP_AR, ICY_ROAD_AR,ICY_COMP_NM, ICY_PRNT_ZIP_CD, ICY_PRNT_ZIP_AR, ICY_PRNT_ROAD_AR";
		sql += " FROM IT_COMPANY";
		sql += " WHERE ICY_COMP_CD = '" + COMP_CD + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uInsuranceReport_XML_COM_008 \n";
			G_INFO += "설명 : 사업장정보조회(주소,사업장명) \n";
			G_INFO += "\n\n";
