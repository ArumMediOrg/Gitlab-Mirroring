...
SELECT IIM_ITEM_CD, IIM_KNME_NM, IIM_RSLT_KD
 ...
 WHERE A.ERI_EXAM_DT = :EXAM_DT
   ...
   AND B.IIM_RSLT_KD IN ('3', '4', '6', '7')
 ORDER BY ISNULL(A.ERI_SORT_SQ, 0), A.ERI_ITEM_CD
		...
		*/
		...
		sql += " AND B.IIM_RSLT_KD IN ('3', '4', '6', '7')";
		sql += " ORDER BY NVL(A.ERI_SORT_SQ, 0), A.ERI_ITEM_CD";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uExam_Acpt_AlvAcptSelectItem_001 \n";
			G_INFO += "설명 : 접수 검사 항목중 장문결과 검사 조회 \n";
			G_INFO += "\n\n";
