...
SELECT B.IIM_KNME_NM AS ICI_ITEM_NM,
       CASE WHEN ICI_ITKD_CD  IS NULL OR ICI_ITKD_CD  = '' THEN ICI_ITKD_CD
            ELSE '[' || ICI_ITKD_CD  || ']' || GetSP_COMMON_cdToNm('HM99G',A.ICI_ITKD_CD) END ICI_ITKD_NM,
       A.*
 ...
 ORDER BY A.ICI_ITKD_CD
		*/
		...
		sql += " ORDER BY A.ICI_ITKD_CD";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCOMP_DEPT_dsET_COMP_DEPTDataChange_001 \n";
			G_INFO += "설명 : 사업장부서 검사항목 리스트 조회 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='ICI_DCAS_PR' rs:number='24' rs:nullable='true' rs:basetable='IT_COMP_DEPT_ITEM' rs:basecolumn='ICI_DCAS_PR'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='ICI_DSBS_PR' rs:number='25' rs:nullable='true' rs:basetable='IT_COMP_DEPT_ITEM' rs:basecolumn='ICI_DSBS_PR'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='ICI_DTGS_PR' rs:number='26' rs:nullable='true' rs:basetable='IT_COMP_DEPT_ITEM' rs:basecolumn='ICI_DTGS_PR'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='ROWID' rs:number='27' rs:rowid='true' rs:writeunknown='true' rs:basetable='IT_COMP_DEPT_ITEM'
