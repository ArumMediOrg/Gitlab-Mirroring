...
<%!
	public String func_uSP_Health_GrdEXAM_ACPTSelectionChanged_014(Statement argStmtExec, HashMap argHtMethod) throws Exception {
		...
		try {
			...
			sql = "INSERT INTO ST_PASTJOB (SPB_EXAM_DT, SPB_EXAM_SQ, SPB_EXAM_CHA, SPB_GOJU_SQ, SPB_GOJU_CD, SPB_YEAR_VAL, SPB_FROM_DT, SPB_TO_DT, SPB_ETC_TX, SPB_INPT_ID) VALUES (";
			sql += "  '" + EXAM_DT + "'";
			sql += ", '" + EXAM_SQ + "'";
			sql += ", '" + EXAM_CHA + "'";
			sql += ", '" + GOJU_SQ + "'";
