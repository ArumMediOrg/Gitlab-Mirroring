...
SELECT EEA_EXAM_DT, EEA_EXAM_SQ, EEA_CHART_NO, EEA_SPCL_LT, 
       ...
       CASE WHEN (EEA_EXAM_CD  = '14001') OR (EEA_ORAL_YN = 'N') THEN '' ELSE EEA_ORAL_YN END EEA_ORAL_YN, 
       CASE WHEN EEA_STOMA_CD  = '0' THEN '' ELSE GETCOMMON_LVCDTONM('0915',EEA_STOMA_CD ,'5',1) END EEA_STOMA_NM, 
       CASE WHEN EEA_COLON_CD  = '0' THEN '' ELSE GETCOMMON_LVCDTONM('0915',EEA_COLON_CD ,'5',1) END EEA_COLON_NM, 
       CASE WHEN EEA_LIVER_CD  = '0' THEN '' ELSE GETCOMMON_LVCDTONM('0915',EEA_LIVER_CD ,'5',1) END EEA_LIVER_NM, 
       CASE WHEN EEA_BAST_CD   = '0' THEN '' ELSE GETCOMMON_LVCDTONM('0915',EEA_BAST_CD  ,'5',1) END EEA_BAST_NM,  
       CASE WHEN EEA_UTER_CD   = '0' THEN '' ELSE GETCOMMON_LVCDTONM('0915',EEA_UTER_CD  ,'5',1) END EEA_UTER_NM,
       CASE WHEN EEA_LUNG_CD   = '0' THEN '' ELSE GETCOMMON_LVCDTONM('0915',EEA_LUNG_CD  ,'5',1) END EEA_LUNG_NM,  
 ...
 ORDER BY EEA_EXAM_DT DESC
		*/
		...
		sql += ", CASE WHEN EEA_LUNG_CD = '0' THEN '' ELSE GETCOMMON_LVCDTONM('0915',EEA_LUNG_CD ,'5',1) END EEA_LUNG_NM";
		...
		sql += " ORDER BY EEA_EXAM_DT DESC";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_PostManagement_CustList_APPLY_UP_ExamDisp_001 \n";
			G_INFO += "설명 : 개인별 접수조회 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='EEA_EXAM_NM' rs:number='5' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='EEA_HTSB_NM' rs:number='6' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='EEA_SPSB_NM' rs:number='7' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='EEA_CVSB_NM' rs:number='8' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='EEA_EMSB_NM' rs:number='9' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='EEA_ETSB_NM' rs:number='10' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='EEA_ORAL_YN' rs:number='11' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_EXAM_ACPT'
			 rs:basecolumn='EEA_ORAL_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='EEA_STOMA_NM' rs:number='12' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_EXAM_ACPT'
			 rs:basecolumn='EEA_STOMA_NM'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='EEA_COLON_NM' rs:number='13' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_EXAM_ACPT'
			 rs:basecolumn='EEA_COLON_NM'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='EEA_LIVER_NM' rs:number='14' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_EXAM_ACPT'
			 rs:basecolumn='EEA_LIVER_NM'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='EEA_BAST_NM' rs:number='15' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_EXAM_ACPT'
			 rs:basecolumn='EEA_BAST_NM'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='EEA_UTER_NM' rs:number='16' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_EXAM_ACPT'
			 rs:basecolumn='EEA_UTER_NM'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='EEA_LUNG_NM' rs:number='17' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_EXAM_ACPT'
			 rs:basecolumn='EEA_LUNG_NM'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='EEA_SPCL_NM' rs:number='18' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='ROWID' rs:number='19' rs:rowid='true' rs:basetable='ET_EXAM_ACPT' rs:basecolumn='ROWID'
...
<%
		...
		while(cRsList.next()) {
			...
			String EEA_LUNG_NM_T = cRsList.getString("EEA_LUNG_NM");
...
<%
			...
			if(! EEA_LUNG_NM_T.equals("")) {
%>
		 		EEA_LUNG_NM='<%= EEA_LUNG_NM_T%>'
<%
			}
