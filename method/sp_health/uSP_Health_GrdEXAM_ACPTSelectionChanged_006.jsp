...
<%
		...
		sql = func_uSP_Health_GrdEXAM_ACPTSelectionChanged_006(stmtExec, htMethod);

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_Health_GrdEXAM_ACPTSelectionChanged_006 \n";
			G_INFO += "설명 : 특수검진 기본정보 저장(pk만) \n";
			G_INFO += "\n\n";
