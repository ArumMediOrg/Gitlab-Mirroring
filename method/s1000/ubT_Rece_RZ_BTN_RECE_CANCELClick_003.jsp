...
select NVL(SUM(RRM_RESEREPL_PR),0) RRM_RESEREPL_PR
from RT_RECE_MEDICHK
where RRM_RECE_NO = :RECE_NO
		*/

		sql = " SELECT NVL(SUM(RRM_RESEREPL_PR),0) RRM_RESEREPL_PR";
		sql += " FROM RT_RECE_MEDICHK";
		sql += " WHERE RRM_RECE_NO = '" + RECE_NO + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : ubT_Rece_RZ_BTN_RECE_CANCELClick_003 \n";
			G_INFO += "설명 : 예약대체금수납확인 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='RRM_RESEREPL_PR' rs:number='1' rs:nullable='true' rs:basetable='RT_RECE_MEDICHK' rs:basecolumn='RRM_RESEREPL_PR'>
