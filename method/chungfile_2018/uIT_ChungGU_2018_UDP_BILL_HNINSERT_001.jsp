...
<%
		...
		String ACPT_DT = htMethod.get("ACPT_DT");
		...
		sql = func_uIT_ChungGU_2018_UDP_BILL_HNINSERT_001(stmtExec, htMethod);

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uIT_ChungGU_2018_UDP_BILL_HNINSERT_001 \n";
			G_INFO += "설명 : 건보청구헤더정보 입력 \n";
			G_INFO += "\n\n";
