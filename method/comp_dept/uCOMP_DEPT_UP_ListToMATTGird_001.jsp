...
SELECT CSM_MATT_CD, CSM_MATT_NM, GetSP_COMMON_cdToNm('HM99B',CSM_PERIOD_TM) CSM_PERIOD_NM
  FROM CT_SP_MATTER
 WHERE CSM_MATT_CD IN (:MATT_CD)
		*/

		sql = " SELECT CSM_MATT_CD, CSM_MATT_NM, GETSP_COMMON_CDTONM('HM99B',CSM_PERIOD_TM) CSM_PERIOD_NM";
		sql += " FROM CT_SP_MATTER";
		sql += " WHERE CSM_MATT_CD IN ('" + MATT_CD + "')";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCOMP_DEPT_UP_ListToMATTGird_001 \n";
			G_INFO += "설명 : 사업장부서 취급물질 리스트 조회 \n";
			G_INFO += "\n\n";
