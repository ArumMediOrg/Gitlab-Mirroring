...
<%
		...
		String CHAR_KD = htMethod.get("CHAR_KD");

		//
		if(ITEM_CD == null) { ITEM_CD = ""; }
		if(SEX_KD == null) { SEX_KD = ""; }
		if(CHAR_KD == null) { CHAR_KD = ""; }
...
SELECT * FROM CT_DANR_ITEM
 WHERE CDI_ITEM_CD = :ITEM_CD
   ...
   AND CDI_DANR_KD = '1'
   And INSTR(CDI_CHAR_KD, :CHAR_KD ) <> 0
		*/
		...
		sql += " AND INSTR(CDI_CHAR_KD, '" + CHAR_KD + "') <> 0";
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uGen_Frst_Panj_uAutoPanBrain_005 \n";
			G_INFO += "설명 : 뇌심혈관판정(위험도평가CT_DANR_ITEM 조회 2) \n";
			G_INFO += "\n\n";

			G_INFO += "전달인자 : \n";
			G_INFO += " ITEM_CD : " + ITEM_CD + " \n";
			G_INFO += " SEX_KD : " + SEX_KD + " \n";
			G_INFO += " CHAR_KD : " + CHAR_KD + " \n";
			G_INFO += "\n\n";
