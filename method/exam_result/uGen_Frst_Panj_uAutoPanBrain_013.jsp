...
<%
		...
		String SCODE5 = htMethod.get("SCODE5");
		String SRSLT5 = htMethod.get("SRSLT5");
		String SCODE6 = htMethod.get("SCODE6");
		String SRSLT6 = htMethod.get("SRSLT6");
		String SCODE7 = htMethod.get("SCODE7");
		String SRSLT7 = htMethod.get("SRSLT7");
		...
		if(SCODE5 == null) { SCODE5 = ""; }
		if(SRSLT5 == null) { SRSLT5 = ""; }
		if(SCODE6 == null) { SCODE6 = ""; }
		if(SRSLT6 == null) { SRSLT6 = ""; }
		if(SCODE7 == null) { SCODE7 = ""; }
		if(SRSLT7 == null) { SRSLT7 = ""; }

		// DB객체
		stmtList = connect.createStatement();

		sql = " SELECT * FROM CT_DANR_ITEM ";
		sql += " WHERE CDI_ITEM_CD = '" + SCODE1 + "' ";
		sql += " 	AND CDI_SEX_KD  = '" + SEX_KD + "' ";
		sql += " 	AND CDI_DANR_KD = '1' ";
		sql += " 	And (TO_NUMBER(CDI_RSLT_LOW)  <= '" + SRSLT1 + "' and ";
		sql += " 		TO_NUMBER(CDI_RSLT_HIGH) >= '" + SRSLT1 + "' ) ";
		sql += " UNION ";
		sql += " SELECT * FROM CT_DANR_ITEM ";
		sql += " WHERE CDI_ITEM_CD = '" + SCODE2 + "' ";
		sql += " 	AND CDI_SEX_KD  = '" + SEX_KD + "' ";
		sql += " 	AND CDI_DANR_KD = '1' ";
		...
		sql += " UNION ";
		sql += " SELECT * FROM CT_DANR_ITEM ";
		sql += " WHERE CDI_ITEM_CD = '" + SCODE5 + "' ";
		sql += " 	AND CDI_SEX_KD  = '" + SEX_KD + "' ";
		sql += " 	AND CDI_DANR_KD = '1' ";
		sql += " 	And (TO_NUMBER(CDI_RSLT_LOW)  <= '" + SRSLT5 + "' and ";
		sql += " 		TO_NUMBER(CDI_RSLT_HIGH) >= '" + SRSLT5 + "' ) ";
		sql += " UNION ";
		sql += " SELECT * FROM CT_DANR_ITEM ";
		sql += " WHERE CDI_ITEM_CD = '" + SCODE6 + "' ";
		sql += " 	AND CDI_SEX_KD  = '" + SEX_KD + "' ";
		sql += " 	AND CDI_DANR_KD = '1' ";
		sql += " 	And (TO_NUMBER(CDI_RSLT_LOW)  <= '" + SRSLT6 + "' and ";
		sql += " 		TO_NUMBER(CDI_RSLT_HIGH) >= '" + SRSLT6 + "' ) ";
		sql += " UNION ";
		sql += " SELECT * FROM CT_DANR_ITEM ";
		sql += " WHERE CDI_ITEM_CD = '" + SCODE7 + "' ";
		sql += " 	AND CDI_SEX_KD  = '" + SEX_KD + "' ";
		sql += " 	AND CDI_DANR_KD = '1' ";
		sql += " 	And (TO_NUMBER(CDI_RSLT_LOW)  <= '" + SRSLT7 + "' and ";
		sql += " 		TO_NUMBER(CDI_RSLT_HIGH) >= '" + SRSLT7 + "' ) ";
			//
		G_INFO += "<!-- \n";
		G_INFO += "서비스명 : uGen_Frst_Panj_uAutoPanBrain_013 \n";
		G_INFO += "설명 : 뇌심혈관판정(위험도평가CT_DANR_ITEM 조회 5) \n";
		G_INFO += "\n\n";
		...
		G_INFO += " SCODE5 : " + SCODE5 + " \n";
		G_INFO += " SRSLT5 : " + SRSLT5 + " \n";
		G_INFO += " SCODE6 : " + SCODE6 + " \n";
		G_INFO += " SRSLT6 : " + SRSLT6 + " \n";
		G_INFO += " SCODE7 : " + SCODE7 + " \n";
		G_INFO += " SRSLT7 : " + SRSLT7 + " \n";
