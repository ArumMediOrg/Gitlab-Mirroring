...
UNION
SELECT '순특(배치전 제외)' AS CCN_FULL_NM, '49002' AS CCN_SMALL from dual
UNION
...
ORDER BY CCN_SMALL
		...
		*/
		...
		sql += " SELECT '순특(배치전 제외)' AS CCN_FULL_NM, '49002' AS CCN_SMALL";
		sql += " FROM DUAL";
		...
		sql += " ORDER BY CCN_SMALL";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uMake_Excel_upSetComboBox_001 \n";
			G_INFO += "설명 : 코드정보 로딩 \n";
			G_INFO += "\n\n";
