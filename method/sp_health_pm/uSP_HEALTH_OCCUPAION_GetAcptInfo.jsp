...
<%
		...
		sql = " Select ";
		sql += " A.EEA_EXAM_DT, A.EEA_EXAM_SQ, A.EEA_CUST_NO, EEA_PSNL_NM, ";
		sql += " Case When A.EEA_SEX_CD = '1' THEN '남' Else '여' End EEA_SEX_CD, ";
		...
		sql += " And A.EEA_EXAM_SQ = '" + EXAM_SQ + "' ";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_HEALTH_OCCUPAION_GetAcptInfo \n";
			G_INFO += "설명 : 접수정보 로딩 \n";
			G_INFO += "\n\n";
