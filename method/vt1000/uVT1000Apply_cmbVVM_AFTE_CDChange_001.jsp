...
FROM CT_COMMON WHERE CCN_LARGE = '0217' AND SUBSTR(CCN_SMALL,1,2) = :SMALL
		...
		*/
		...
		sql += " AND SUBSTR(CCN_SMALL,1,2) = '" + SMALL + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uVT1000Apply_cmbVVM_AFTE_CDChange_001 \n";
			G_INFO += "설명 : 사후관리 조치구분코드 로딩 \n";
			G_INFO += "\n\n";
