 ...
 WHERE SSV_EXAM_DT = :EXAM_DT
   ...
   AND SSV_PACK_CD = '00'
		*/
		...
		sql = " SELECT SSV_VIEW_EX, SSV_VIEW_EX2, SSV_VIEW_RTF, SSV_DOCTOR, SSV_RPT_DT, SSV_PRNT_DT, SSV_RSLT_INPUT, SSV_COMMT ";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='SSV_COMMT' rs:number='8' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
			 rs:basecolumn='SSV_COMMT'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='ROWID' rs:number='9' rs:rowid='true' rs:basetable='ST_SYTH_VIEW' rs:basecolumn='ROWID'
