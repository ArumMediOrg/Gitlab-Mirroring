...
<%
     ...
     select icd_dept_cd||'-'||icd_dept_nm dept_nm from it_comp_dept 
                 where icd_comp_cd = :sLarge                           
                   and icd_mngt_yr = :sSmall 
		...
		*/
		...
		sql += " ORDER BY ICD_DEPT_CD";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : UFM_Common_GP_ComboSetting_001___19 \n";
			G_INFO += "설명 : 구분값에 따른 콤보박스 정보 로딩___19 \n";
			G_INFO += "\n\n";
