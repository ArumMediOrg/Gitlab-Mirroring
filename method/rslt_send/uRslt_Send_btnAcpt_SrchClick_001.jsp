...
<%
		...
		sql = " SELECT A.EEA_EXAM_DT, A.EEA_EXAM_SQ, A.EEA_PSNL_NM, A.EEA_CUST_NO, A.EEA_HTSB_CD, A.EEA_DIVI_CS, A.EEA_CHART_NO, A.EEA_ORAL_YN, F_TEL_FORMAT(A.EEA_MOBL_NO) EEA_MOBL_NO, A.EEA_CNCR_DT, C.PFP_TRANC_DATE, D.PSP_TRANC_DATE, CASE WHEN A.EEA_EXAM_CD = '31001' THEN CASE WHEN A.EEA_ORAL_YN = '3' THEN E.ESP_OIFRM_DT ELSE E.ESP_EIFRM_DT END WHEN A.EEA_EXAM_CD = '31006' THEN F.ESO_EIFRM_DT WHEN SUBSTR(A.EEA_HTSB_CD, 1, 2) = '13' AND A.EEA_ORAL_YN = 'Y' THEN G.EDP_TOBO_DT WHEN SUBSTR(A.EEA_HTSB_CD, 1, 2) = '14' THEN G.EDP_TOBO_DT WHEN SUBSTR(A.EEA_HTSB_CD, 5, 1) = '2'";
