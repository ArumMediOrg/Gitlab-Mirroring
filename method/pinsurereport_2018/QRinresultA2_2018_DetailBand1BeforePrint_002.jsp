...
<%
		...
		String CBCHOL_YN = htMethod.get("CBCHOL_YN");

		//
		if(EXAM_DT == null) { EXAM_DT = ""; }
		if(EXAM_SQ == null) { EXAM_SQ = ""; }
		if(CBCHOL_YN == null) { CBCHOL_YN = ""; }
...
if :cbChol_Yn = 'Y' then
begin
   or ERI_ITEM_CD IN ('BA009', 'BA010', 'BA011', 'BA012', 'BA013')   )
end
else
begin
   )
		...
		*/
		...
		if(CBCHOL_YN.equals("Y")) {
			sql += " OR ERI_ITEM_CD IN ('BA009', 'BA010', 'BA011', 'BA012', 'BA013')";
		}
		
		sql += ")";
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : QRinresultA2_2018_DetailBand1BeforePrint_002 \n";
			G_INFO += "설명 : 검진결과내역조회(일반검진) \n";
			G_INFO += "\n\n";

			G_INFO += "전달인자 : \n";
			G_INFO += " EXAM_DT : " + EXAM_DT + " \n";
			G_INFO += " EXAM_SQ : " + EXAM_SQ + " \n";
			G_INFO += " CBCHOL_YN : " + CBCHOL_YN + " \n";
			G_INFO += "\n\n";
