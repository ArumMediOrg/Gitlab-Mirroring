...
<%
		...
		String DTEDINPUT_DTT_ST = htMethod.get("DTEDINPUT_DTT_ST");
		String DTEDINPUT_DTT_ED = htMethod.get("DTEDINPUT_DTT_ED");

		//
		if(DTEDINPUT_DTT_ST == null) { DTEDINPUT_DTT_ST = ""; }
		if(DTEDINPUT_DTT_ED == null) { DTEDINPUT_DTT_ED = ""; }
...
from RT_RECE_MAGAM
where RMG_INPUT_DTT between :dtedInput_Dtt_st and :dtedInput_Dtt_ed
order by RMG_INPUT_DTT desc
		...
		*/
		...
		sql += " WHERE RMG_INPUT_DTT BETWEEN '" + DTEDINPUT_DTT_ST + "'";
		sql += " AND '" + DTEDINPUT_DTT_ED + "'";
		sql += " ORDER BY RMG_INPUT_DTT DESC";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uRT_ReceDayReport_btn_Serch3Click_001 \n";
			G_INFO += "설명 : 마감현황정보 로딩 \n";
			G_INFO += "\n\n";

			G_INFO += "전달인자 : \n";
			G_INFO += " DTEDINPUT_DTT_ST : " + DTEDINPUT_DTT_ST + " \n";
			G_INFO += " DTEDINPUT_DTT_ED : " + DTEDINPUT_DTT_ED + " \n";
			G_INFO += "\n\n";
