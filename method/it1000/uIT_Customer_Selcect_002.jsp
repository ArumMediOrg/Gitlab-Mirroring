...
<%
		...
		sql = " SELECT EEA_EXAM_DT EXAM_DT, EEA_MMBR_CD MMBR_CD FROM ";
		sql += " ( ";
		sql += " SELECT EEA_EXAM_DT, EEA_MMBR_CD FROM ET_EXAM_ACPT ";
		sql += " WHERE EEA_CUST_NO = '" + CUST_NO + "' ";
		sql += " ORDER BY EEA_EXAM_DT DESC ";
		sql += " ) ";
		sql += " WHERE ROWNUM = 1 ";
		sql += " UNION ";
		sql += " SELECT RRT_EXAM_DT EXAM_DT, RRT_MMBR_CD MMBR_CD FROM ";
		sql += " ( ";
		sql += " SELECT RRT_EXAM_DT, RRT_MMBR_CD FROM RT_RSVT ";
		sql += " WHERE RRT_CUST_NO = '" + CUST_NO + "' ";
		sql += " AND RRT_EXAM_SQ IS NULL ";
		...
		sql += " WHERE ROWNUM = 1 ";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uIT_Customer_Selcect_002 \n";
			G_INFO += "설명 : 예약, 접수 최근 정보 조회 \n";
			G_INFO += "\n\n";
