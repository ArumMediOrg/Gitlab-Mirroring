...
<%
 ...
 SELECT EEA_CUST_NO  
   FROM ET_EXAM_ACPT  
     WHERE EEA_EXAM_DT = :REQUEST_DATE
       AND EEA_EXAM_SQ = :EXAM_NO
		*/

		sql = " SELECT EEA_CUST_NO";
		sql += " FROM ET_EXAM_ACPT";
		sql += " WHERE EEA_EXAM_DT = '" + REQUEST_DATE + "'";
		sql += " AND EEA_EXAM_SQ = '" + EXAM_NO + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : MunJin_Viewselect_002 \n";
			G_INFO += "설명 : 누리온 접수정보 조회 \n";
			G_INFO += "\n\n";
