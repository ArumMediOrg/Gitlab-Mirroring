...
<%
   ...
   SELECT A.IIQ_ITQU_LV1, A.IIQ_ITQU_LV2, A.IIQ_ITQU_SQ, C.CQN_QSTN_CD, C.CQN_QSKD_CD
      , C.CQN_QSTN_SQ, C.CQN_QSTN_LV, C.CQN_QSTN_NM, C.CQN_ANSR_CD, C.CQN_ANSE_EX, C.CQN_QSTN_CP
      , C.CQN_DEFULT, RTRIM(B.QQN_RESULT) QQN_RESULT
  ...
  ORDER BY A.IIQ_SORT_NO
		...
		*/
		...
		sql += " ORDER BY A.IIQ_SORT_NO";
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uDental_Panj_upGridDisplay_003 \n";
			G_INFO += "설명 : 구강판정(현재문진조회) \n";
			G_INFO += "\n\n";
