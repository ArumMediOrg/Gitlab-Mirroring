   ...
   AND SIR_EXAM_SQ = :EXAM_SQ  
		*/
		...
		sql += " AND SIR_EXAM_SQ = '" + EXAM_SQ + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_RecheckList_UP_GridDisplay_003 \n";
			G_INFO += "설명 : 특검 2차 추가검사 조회 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='SIR_ADD_LT' rs:number='1' rs:nullable='true' rs:basetable='ST_ITEM_RECHECK' rs:basecolumn='SIR_ADD_LT'>
