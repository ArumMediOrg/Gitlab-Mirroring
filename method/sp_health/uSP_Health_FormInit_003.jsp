...
SELECT A.CSM_LARGE, A.CSM_MATT_CD, A.CSM_MATT_NM, A.CSM_INJA_CD, A.CSM_JIB_CD, A.CSM_PERIOD_TM,
  ...
  FROM CT_SP_MATTER A LEFT OUTER JOIN CT_SP_COMMON B ON A.CSM_COMM_CD = B.CSC_SMALL AND B.CSC_LARGE = 'HM99A'
		*/
		...
		sql = " SELECT A.CSM_LARGE, A.CSM_MATT_CD, A.CSM_MATT_NM, A.CSM_INJA_CD, A.CSM_JIB_CD, A.CSM_PERIOD_TM, B.CSC_ETC1_NM, B.CSC_ETC1_CD, B.CSC_ETC2_NM, B.CSC_ETC2_CD";
		...
		sql += " AND B.CSC_LARGE = 'HM99A'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_Health_FormInit_003 \n";
			G_INFO += "설명 : 유해물질 OPEN \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='CSM_JIB_CD' rs:number='5' rs:nullable='true' rs:writeunknown='true' rs:basetable='CT_SP_MATTER'
