...
SELECT CSM_MATT_CD, CSM_MATT_NM, CSM_PERIOD_TM, dbo.GetSP_COMMON_cdToNm('HM99B',CSM_PERIOD_TM) CSM_PERIOD_NM, CSM_COMM_CD
FROM CT_SP_MATTER
		*/
		...
		sql += " FROM CT_SP_MATTER";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uBT_ESTI_DEPT_APPLY_UP_ListToMATTGird_001 \n";
			G_INFO += "설명 : 특검 물질정보 로딩 \n";
			G_INFO += "\n\n";
