...
SELECT EEA_DEPT_NM FROM ET_EXAM_ACPT
WHERE EEA_EXAM_DT = :EXAM_DT
    AND EEA_EXAM_SQ = :EXAM_SQ

		*/

		sql = " SELECT EEA_DEPT_NM";
		...
		sql += " AND EEA_EXAM_SQ = '" + EXAM_SQ + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uEmotional_Labor_Pm_Pnt_DetailBand1BeforePrint_002 \n";
			G_INFO += "설명 : 부서명 로딩 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='EEA_DEPT_NM' rs:number='1' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_EXAM_ACPT'
