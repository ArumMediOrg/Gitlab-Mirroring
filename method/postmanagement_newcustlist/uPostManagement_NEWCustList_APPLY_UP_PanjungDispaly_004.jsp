...
Select CASE WHEN A.ECC_RSLT_KD = '1' then '이상소견없음'      
            WHEN A.ECC_RSLT_KD = '2' then '양성질환'          
            WHEN A.ECC_RSLT_KD = '3' then '대장암 의심'       
            WHEN A.ECC_RSLT_KD = '4' then '대장암'            
            WHEN A.ECC_RSLT_KD = '5' then '기타'              
            WHEN A.ECC_RSLT_KD = '6' then '음성(분변잠혈)'    
            WHEN A.ECC_RSLT_KD = '7' then '양성(분변잠혈)'    
            Else '' END ECC_RSLT_KD,                            
       A.*, B.IAU_PENL_NM                                         
  From ET_CANCER_COLO A                                           
  Left Outer Join IT_AUTH_USER B On B.IAU_EMP_NO  = A.ECC_LICEN_CD
 Where A.ECC_EXAM_DT = :EXAM_DT                  
   And A.ECC_EXAM_SQ = :EXAM_SQ                

		*/

		sql = " SELECT CASE WHEN A.ECC_RSLT_KD = '1' THEN '이상소견없음' WHEN A.ECC_RSLT_KD = '2' THEN '양성질환' WHEN A.ECC_RSLT_KD = '3' THEN '대장암 의심' WHEN A.ECC_RSLT_KD = '4' THEN '대장암' WHEN A.ECC_RSLT_KD = '5' THEN '기타' WHEN A.ECC_RSLT_KD = '6' THEN '음성(분변잠혈)' WHEN A.ECC_RSLT_KD = '7' THEN '양성(분변잠혈)' ELSE '' END ECC_RSLT_KD, A.*, B.IAU_PENL_NM";
		sql += " FROM ET_CANCER_COLO A LEFT OUTER JOIN IT_AUTH_USER B";
		sql += " ON B.IAU_EMP_NO = A.ECC_LICEN_CD";
		sql += " WHERE A.ECC_EXAM_DT = '" + EXAM_DT + "'";
		sql += " AND A.ECC_EXAM_SQ = '" + EXAM_SQ + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uPostManagement_NEWCustList_APPLY_UP_PanjungDispaly_004 \n";
			G_INFO += "설명 : 대장암정보 로딩 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='ECC_RSLT_KD' rs:number='1' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_RSLT_KD'>
			<s:datatype dt:type='string' dt:maxLength='14'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_EXAM_DT' rs:number='2' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO' rs:basecolumn='ECC_EXAM_DT'>
			<s:datatype dt:type='string' dt:maxLength='10' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_EXAM_SQ' rs:number='3' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO' rs:basecolumn='ECC_EXAM_SQ'>
			<s:datatype dt:type='string' dt:maxLength='6' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_CFRM_CD' rs:number='4' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_CFRM_CD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_OBEX_DT' rs:number='5' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_OBEX_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_OBTP_KD' rs:number='6' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_OBTP_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_OBRT_CD' rs:number='7' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_OBRT_CD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_OBRT_VL' rs:number='8' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_OBRT_VL'>
			<s:datatype dt:type='string' dt:maxLength='6'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_OBVL_VL' rs:number='9' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_OBVL_VL'>
			<s:datatype dt:type='string' dt:maxLength='6'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_GIEX_DT' rs:number='10' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_GIEX_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_GIEX_KD' rs:number='11' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_GIEX_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_GIRT1_KD' rs:number='12' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_GIRT1_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_GIRT1S_KD' rs:number='13' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_GIRT1S_KD'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_GIRT2_KD' rs:number='14' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_GIRT2_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_GIRT2S_KD' rs:number='15' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_GIRT2S_KD'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_GIRT3_KD' rs:number='16' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_GIRT3_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_GIRT3S_KD' rs:number='17' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_GIRT3S_KD'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_GIPL_VL' rs:number='18' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_GIPL_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_GIETC_KD' rs:number='19' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_GIETC_KD'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_GIRT_EX' rs:number='20' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_GIRT_EX'>
			<s:datatype dt:type='string' dt:maxLength='40'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENEX_DT' rs:number='21' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENEX_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENRT1_KD' rs:number='22' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENRT1_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENRT1S_KD' rs:number='23' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENRT1S_KD'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENRT2_KD' rs:number='24' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENRT2_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENRT2S_KD' rs:number='25' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENRT2S_KD'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENRT3_KD' rs:number='26' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENRT3_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENRT3S_KD' rs:number='27' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENRT3S_KD'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENPL_VL' rs:number='28' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENPL_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENPL_CT' rs:number='29' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENPL_CT'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENETC_KD' rs:number='30' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENETC_KD'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENRT_EX' rs:number='31' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENRT_EX'>
			<s:datatype dt:type='string' dt:maxLength='40'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_BIEX_YN' rs:number='32' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_BIEX_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_FOCP_KD' rs:number='33' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_FOCP_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_BIBF_KD' rs:number='34' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_BIBF_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_BICT_KD' rs:number='35' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_BICT_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_BIRT_KD' rs:number='36' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_BIRT_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_BICNCR_KD' rs:number='37' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_BICNCR_KD'>
			<s:datatype dt:type='string' dt:maxLength='13'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_BICNCR_EX' rs:number='38' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_BICNCR_EX'>
			<s:datatype dt:type='string' dt:maxLength='40'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_BIETC_KD' rs:number='39' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_BIETC_KD'>
			<s:datatype dt:type='string' dt:maxLength='5'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_BIETC_EX' rs:number='40' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_BIETC_EX'>
			<s:datatype dt:type='string' dt:maxLength='40'/>
		</s:AttributeType>
		<s:AttributeType name='c40' rs:name='ECC_RSLT_KD' rs:number='41' rs:nullable='true' rs:writeunknown='true'
			 rs:basetable='ET_CANCER_COLO' rs:basecolumn='ECC_RSLT_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ETC_EX' rs:number='42' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ETC_EX'>
			<s:datatype dt:type='string' dt:maxLength='40'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_STCN_YN' rs:number='43' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_STCN_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_RSLT_EX' rs:number='44' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_RSLT_EX'>
			<s:datatype dt:type='string' dt:maxLength='1200'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_RPT_DT' rs:number='45' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_RPT_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_CFRM_DT' rs:number='46' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_CFRM_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_LICEN_CD' rs:number='47' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_LICEN_CD'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_INPUT_DTT' rs:number='48' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_INPUT_DTT'>
			<s:datatype dt:type='dateTime' rs:dbtype='timestamp' dt:maxLength='16' rs:scale='0' rs:precision='19' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_INPUT_ID' rs:number='49' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_INPUT_ID'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_MODI_DTT' rs:number='50' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_MODI_DTT'>
			<s:datatype dt:type='dateTime' rs:dbtype='timestamp' dt:maxLength='16' rs:scale='0' rs:precision='19' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_MODI_ID' rs:number='51' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_MODI_ID'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENCE_KD' rs:number='52' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENCE_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENJJ_KD' rs:number='53' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENJJ_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_DECI_LICEN_CD' rs:number='54' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_DECI_LICEN_CD'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_CKUP_LICEN_CD' rs:number='55' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_CKUP_LICEN_CD'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_PATH_LICEN_CD' rs:number='56' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_PATH_LICEN_CD'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_FOCP_ADD_KD' rs:number='57' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_FOCP_ADD_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='IAU_PENL_NM' rs:number='58' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='ROWID' rs:number='59' rs:rowid='true' rs:basetable='ET_CANCER_COLO' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c59' rs:name='ROWID' rs:number='60' rs:rowid='true' rs:basetable='IT_AUTH_USER' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
