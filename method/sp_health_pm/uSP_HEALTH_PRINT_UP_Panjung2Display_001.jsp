...
SELECT * FROM (SELECT  SIR_EXAM_DT2, SIR_EXAM_SQ2
 ...
 WHERE SIR_EXAM_DT  = :EXAM_DT 
   ...
   AND SIR_ORGA_CD  = :ORGA_CD 
		...
		*/
		...
		sql = " SELECT *";
		sql += " FROM (";
		sql += "	SELECT SIR_EXAM_DT2, SIR_EXAM_SQ2";
		...
		sql += " WHERE ROWNUM = 1";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_HEALTH_PRINT_UP_Panjung2Display_001 \n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='SIR_EXAM_DT2' rs:number='1' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='SIR_EXAM_SQ2' rs:number='2' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
