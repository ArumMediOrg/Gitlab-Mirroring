...
SELECT IIM_ITEM_CD, IIM_KNME_NM, IIM_ENME_NM, IIM_SNME_NM
FROM IT_ITEM
WHERE IIM_ITEM_CD = :IIM_ITEM_CD 
		*/

		sql = " SELECT IIM_ITEM_CD, IIM_KNME_NM, IIM_ENME_NM, IIM_SNME_NM";
		sql += " FROM IT_ITEM";
		sql += " WHERE IIM_ITEM_CD = '" + IIM_ITEM_CD + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCommon_XML_IIM_002 \n";
			G_INFO += "설명 : 검사항목코드조회(코드,한글명,영문명,단축명) \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='IIM_ENME_NM' rs:number='3' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_ITEM'
