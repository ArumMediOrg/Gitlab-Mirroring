...
SELECT NVL(MAX(BBP_BILL_NO), 1) Max_no
  FROM BT_BILLHN_PR
 WHERE BBP_CHUNG_DT = :CHUNG_DT
   AND SUBSTR(BBP_BILL_FL,18,2) = :BILL_FL
		*/

		sql = " SELECT NVL(MAX(BBP_BILL_NO), 1) MAX_NO";
		sql += " FROM BT_BILLHN_PR";
		sql += " WHERE BBP_CHUNG_DT = '" + CHUNG_DT + "'";
		sql += " AND SUBSTR(BBP_BILL_FL,18,2) = '" + BILL_FL + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : UChungfile2020_JSON_UDF_FILENO_001 \n";
			G_INFO += "설명 : 청구파일 최종순번 조회 \n";
			G_INFO += "\n\n";
