...
SELECT * FROM ET_COMP_AGEA
 WHERE ECA_COMP_CD = :COMP_CD
   AND ECA_MNGT_YR = :MNGT_YR

 if :USE_YN <> '' then
 begin
   AND ECA_USE_YN = :USE_YN
 end;
		*/
		...
		if(! USE_YN.equals("")) {
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCOMP_AGEA_TRNS_OKBtnClick_001 \n";
			G_INFO += "설명 : 계약단가이관 내역 조회(전체) \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='ECA_COMP_CD' rs:number='1' rs:writeunknown='true' rs:basetable='ET_COMP_AGEA' rs:basecolumn='ECA_COMP_CD'>
			<s:datatype dt:type='string' dt:maxLength='12' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='ECA_MNGT_YR' rs:number='2' rs:writeunknown='true' rs:basetable='ET_COMP_AGEA' rs:basecolumn='ECA_MNGT_YR'>
			<s:datatype dt:type='string' dt:maxLength='4' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='ECA_AGEA_KD' rs:number='3' rs:writeunknown='true' rs:basetable='ET_COMP_AGEA' rs:basecolumn='ECA_AGEA_KD'>
			<s:datatype dt:type='string' dt:maxLength='1' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='ECA_ITEM_CD' rs:number='4' rs:writeunknown='true' rs:basetable='ET_COMP_AGEA' rs:basecolumn='ECA_ITEM_CD'>
			<s:datatype dt:type='string' dt:maxLength='10' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='ECA_AGEA_PR' rs:number='5' rs:writeunknown='true' rs:basetable='ET_COMP_AGEA' rs:basecolumn='ECA_AGEA_PR'>
			<s:datatype dt:type='number' rs:dbtype='numeric' dt:maxLength='19' rs:scale='0' rs:precision='10' rs:fixedlength='true'
			 rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='ECA_ITEM_PR' rs:number='6' rs:writeunknown='true' rs:basetable='ET_COMP_AGEA' rs:basecolumn='ECA_ITEM_PR'>
			<s:datatype dt:type='number' rs:dbtype='numeric' dt:maxLength='19' rs:scale='0' rs:precision='10' rs:fixedlength='true'
			 rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='ECA_REF1_NM' rs:number='7' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_COMP_AGEA'
			 rs:basecolumn='ECA_REF1_NM'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='ECA_REF1_TX' rs:number='8' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_COMP_AGEA'
			 rs:basecolumn='ECA_REF1_TX'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='ECA_USE_YN' rs:number='9' rs:writeunknown='true' rs:basetable='ET_COMP_AGEA' rs:basecolumn='ECA_USE_YN'>
			<s:datatype dt:type='string' dt:maxLength='1' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='ECA_NUSE_ID' rs:number='10' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_COMP_AGEA'
			 rs:basecolumn='ECA_NUSE_ID'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECA_NUSE_DTT' rs:number='11' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_COMP_AGEA'
			 rs:basecolumn='ECA_NUSE_DTT'>
			<s:datatype dt:type='dateTime' rs:dbtype='timestamp' dt:maxLength='16' rs:scale='0' rs:precision='19' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='ECA_INPT_ID' rs:number='12' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_COMP_AGEA'
			 rs:basecolumn='ECA_INPT_ID'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECA_INPT_DTT' rs:number='13' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_COMP_AGEA'
			 rs:basecolumn='ECA_INPT_DTT'>
			<s:datatype dt:type='dateTime' rs:dbtype='timestamp' dt:maxLength='16' rs:scale='0' rs:precision='19' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='ECA_MODI_ID' rs:number='14' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_COMP_AGEA'
			 rs:basecolumn='ECA_MODI_ID'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECA_MODI_DTT' rs:number='15' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_COMP_AGEA'
			 rs:basecolumn='ECA_MODI_DTT'>
			<s:datatype dt:type='dateTime' rs:dbtype='timestamp' dt:maxLength='16' rs:scale='0' rs:precision='19' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='ECA_TRNS_ID' rs:number='16' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_COMP_AGEA'
			 rs:basecolumn='ECA_TRNS_ID'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECA_TRNS_DTT' rs:number='17' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_COMP_AGEA'
			 rs:basecolumn='ECA_TRNS_DTT'>
			<s:datatype dt:type='dateTime' rs:dbtype='timestamp' dt:maxLength='16' rs:scale='0' rs:precision='19' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='ROWID' rs:number='18' rs:rowid='true' rs:writeunknown='true' rs:basetable='ET_COMP_AGEA'
