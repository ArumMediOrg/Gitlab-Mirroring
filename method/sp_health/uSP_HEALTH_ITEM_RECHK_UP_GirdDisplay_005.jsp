...
Select IIM_ITEM_CD, IIM_KNME_NM, IIM_SBCD_CD, IIM_USE_YN From IT_ITEM
 Where IIM_SBCD_CD = :SBCD_CD
   And IIM_USE_YN  = 'Y'
		*/

		sql = " SELECT IIM_ITEM_CD, IIM_KNME_NM, IIM_SBCD_CD, IIM_USE_YN";
		sql += " FROM IT_ITEM";
		sql += " WHERE IIM_SBCD_CD = '" + SBCD_CD + "'";
		sql += " AND IIM_USE_YN = 'Y'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_HEALTH_ITEM_RECHK_UP_GirdDisplay_005 \n";
			G_INFO += "설명 : 검사항목코드조회(산보코드조건) \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='IIM_USE_YN' rs:number='4' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_ITEM'
