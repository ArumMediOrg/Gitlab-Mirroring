...
ELSE 
  SELECT B.ICR_PENL_ID ICR_PENL_DE,
       ...
       A.EEA_EXAM_DT, A.EEA_EXAM_SQ, EEA_CHART_NO, A.EEA_PSNL_NM, A.EEA_EXAM_CD,A.EEA_SPCL_CD, A.EEA_CUST_NO, B.ICR_PENL_ID, A.EEA_MNGT_SPYM, 
       ...
       CASE WHEN A.EEA_EXAM_CD = '41001' OR A.EEA_SPSB_YN = 'Y' THEN '1' ELSE '2' END EEA_TKGM_CHA, 
       A.EEA_DIVI_NO, EEA_ZIP_CD, EEA_ZIP_AR, EEA_ROAD_AR, A.EEA_COMP_CD, C.ICY_COMP_NM, 
       A.EEA_DEPT_NM, A.EEA_TEL_NO, A.EEA_MOBL_NO, A.EEA_PLCE_CD, A.EEA_PSNL_AGE
 ...
 WHERE A.EEA_EXAM_DT = :EXAM_DT 
   AND A.EEA_EXAM_SQ = :EXAM_SQ
		*/
		...
		sql += " A.EEA_EXAM_DT, A.EEA_EXAM_SQ, EEA_CHART_NO, A.EEA_PSNL_NM, A.EEA_EXAM_CD,A.EEA_SPCL_CD, A.EEA_CUST_NO, B.ICR_PENL_ID, A.EEA_MNGT_SPYM";
		...
		sql += ", A.EEA_DIVI_NO, EEA_ZIP_CD, EEA_ZIP_AR, EEA_ROAD_AR, A.EEA_COMP_CD, C.ICY_COMP_NM, A.EEA_DEPT_NM, A.EEA_TEL_NO, A.EEA_MOBL_NO, A.EEA_PLCE_CD, A.EEA_PSNL_AGE";
		...
		sql += " AND A.EEA_EXAM_SQ = '" + EXAM_SQ + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_PostManagement_CustList_APPLY_FormShow_001 \n";
			G_INFO += "설명 : 접수 정보 조회 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='EEA_SPCL_CD' rs:number='7' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_EXAM_ACPT'
		...
		<s:AttributeType name='ICR_PENL_ID' rs:number='9' rs:writeunknown='true' rs:basetable='IT_CUSTOMER' rs:basecolumn='ICR_PENL_ID'>
			<s:datatype dt:type='string' dt:maxLength='13' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='EEA_MNGT_SPYM' rs:number='10' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_EXAM_ACPT'
		...
		<s:AttributeType name='EEA_TKGM_CHA' rs:number='13' rs:nullable='true'>
		...
		<s:AttributeType name='EEA_COMP_CD' rs:number='18' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_EXAM_ACPT'
			 rs:basecolumn='EEA_COMP_CD'>
			<s:datatype dt:type='string' dt:maxLength='12'/>
		</s:AttributeType>
		<s:AttributeType name='ICY_COMP_NM' rs:number='19' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_COMPANY'
			 rs:basecolumn='ICY_COMP_NM'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='EEA_DEPT_NM' rs:number='20' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_EXAM_ACPT'
