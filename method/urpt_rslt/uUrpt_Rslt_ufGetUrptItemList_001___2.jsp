...
<%
		...
		sql += " CASE WHEN NVL(IIM_SNME_NM, ' ') <> ' ' THEN IIM_SNME_NM ELSE IIM_KNME_NM END ITEM_NM";
		...
		sql += " AND (NVL(ERI_RSLT_VL, ' ') = ' ' AND NVL(ERI_RSLT_EX, ' ') = ' ')";
		sql += " AND NVL(ERI_CNCL_YN, 'N') <> 'Y'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uUrpt_Rslt_ufGetUrptItemList_001___2 \n";
			G_INFO += "설명 : 검진결과정보 로딩___2 \n";
			G_INFO += "\n\n";
