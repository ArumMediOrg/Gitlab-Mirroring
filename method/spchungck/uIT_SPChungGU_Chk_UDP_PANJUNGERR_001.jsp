...
SELECT *
  FROM ST_PANJUNG
 WHERE SPG_EXAM_DT >= :EXAM_SDT 
   AND SPG_EXAM_DT <= :EXAM_EDT
...
:PARAM_TX
		*/
		...
		sql = " SELECT *";
		sql += " FROM ST_PANJUNG";
		sql += " WHERE SPG_EXAM_DT >= '" + EXAM_SDT + "'";
		sql += " AND SPG_EXAM_DT <= '" + EXAM_EDT + "'";
		sql += PARAM_TX;

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uIT_SPChungGU_Chk_UDP_PANJUNGERR_001 \n";
			G_INFO += "설명 : 조건별 판정 조회 \n";
			G_INFO += "\n\n";
