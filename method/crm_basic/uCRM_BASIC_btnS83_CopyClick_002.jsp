...
<%
		...
		String NEW_EMP_NO = htMethod.get("NEW_EMP_NO");
		String USER_ID = htMethod.get("USER_ID");

		//
		if(PLAN_DT == null) { PLAN_DT = ""; }
		if(EMP_NO == null) { EMP_NO = ""; }
		if(NEW_EMP_NO == null) { NEW_EMP_NO = ""; }
		if(USER_ID == null) { USER_ID = ""; }

		// DB객체
		stmtExec = connect.createStatement();

		sql = func_uCRM_BASIC_btnS83_CopyClick_002(stmtExec, htMethod);

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCRM_BASIC_btnS83_CopyClick_002 \n";
			G_INFO += "설명 : 종검상담스케줄-상담스케줄복사(상담시간) \n";
			G_INFO += "\n\n";

			G_INFO += "전달인자 : \n";
			G_INFO += " PLAN_DT : " + PLAN_DT + " \n";
			G_INFO += " EMP_NO : " + EMP_NO + " \n";
			G_INFO += " NEW_EMP_NO : " + NEW_EMP_NO + " \n";
