...
@sSql =  (select ICY_COMP_CD from IT_COMPANY 
 WHERE ICY_CORE_NO = :saup OR ICY_COMP_CD = :saup)
return = @sSql
		*/

		sql = " SELECT ICY_COMP_CD";
		sql += " FROM IT_COMPANY";
		sql += " WHERE ICY_CORE_NO = '" + SAUP + "'";
		sql += " OR ICY_COMP_CD = '" + SAUP + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : UFM_Common_GF_CompanyMain_001 \n";
			G_INFO += "설명 : 대표사업자로 조회 쿼리(내부펑션으로 추가해야함) \n";
			G_INFO += "\n\n";
