...
SELECT * FROM ST_PANJUNG
 WHERE SPG_EXAM_DT = :EXAM_DT AND SPG_EXAM_SQ = :EXAM_SQ
   AND SPG_MATT_CD = :MATT_CD AND SPG_ORGA_CD = :ORGA_CD
   ...
   AND SPG_EXAM_CHA = '2'
		*/
		...
		sql += " AND SPG_EXAM_CHA = '2'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : Uspchungfile2020_UDP_PANJUNG_002 \n";
			G_INFO += "설명 : 특검청구 판정내역 조회(2차) \n";
			G_INFO += "\n\n";
