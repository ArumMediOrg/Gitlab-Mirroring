...
Select DISTINCT SPG_MATT_CD From ST_PANJUNG                               
 Where SPG_EXAM_DT = :EXAM_DT
  And SPG_EXAM_SQ = :EXAM_SQ
Order By SPG_MATT_CD                                                      

		*/

		sql = " SELECT DISTINCT SPG_MATT_CD";
		sql += " FROM ST_PANJUNG";
		sql += " WHERE SPG_EXAM_DT = '" + EXAM_DT + "'";
		sql += " AND SPG_EXAM_SQ = '" + EXAM_SQ + "'";
		sql += " ORDER BY SPG_MATT_CD";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uIT_ChungGU_Move_Up_afload_per_003 \n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='SPG_MATT_CD' rs:number='1' rs:basetable='ST_PANJUNG' rs:basecolumn='SPG_MATT_CD'>
