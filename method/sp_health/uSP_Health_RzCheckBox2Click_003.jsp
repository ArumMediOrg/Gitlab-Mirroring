...
Select EEA_ETSB_LT From ET_EXAM_ACPT
 Where EEA_EXAM_DT = :EXAM_DT
   And EEA_EXAM_SQ = :EXAM_SQ
		*/

		sql = " SELECT EEA_ETSB_LT";
		...
		sql += " AND EEA_EXAM_SQ = '" + EXAM_SQ + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_Health_RzCheckBox2Click_003 \n";
			G_INFO += "설명 : 특수검진항목만 보기 2차 물질조회 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='EEA_ETSB_LT' rs:number='1' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_EXAM_ACPT'
