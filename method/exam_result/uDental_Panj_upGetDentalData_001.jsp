...
FROM ET_RSLT_ITEM A INNER JOIN IT_ITEM B ON A.ERI_ITEM_CD = B.IIM_ITEM_CD AND ERI_ITEM_CD = 'M0020'
WHERE ERI_EXAM_DT = :EXAM_DT
  AND ERI_EXAM_SQ = :EXAM_SQ
		*/
		...
		sql += " AND ERI_ITEM_CD = 'M0020'";
		sql += " WHERE ERI_EXAM_DT = '" + EXAM_DT + "'";
		sql += " AND ERI_EXAM_SQ = '" + EXAM_SQ + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uDental_Panj_upGetDentalData_001 \n";
			G_INFO += "설명 : 구강판정(구강문진등록확인) \n";
			G_INFO += "\n\n";
