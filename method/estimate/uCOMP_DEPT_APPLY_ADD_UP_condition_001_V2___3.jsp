...
<%
        ...
        SELECT '[2]' || GetSP_COMMON_cdToNm('HM99G','2') VIP_ITKD_NM, A.* 
        FROM VIEW_IT_ITEM_PRICE A 
        WHERE VIP_SBCD_CD <> '' AND VIP_APLY_DT <= :APLY_DT
		...
		*/
		...
		sql = " SELECT '[2]' || GETSP_COMMON_CDTONM('HM99G','2') VIP_ITKD_NM, A.*";
		sql += " FROM VIEW_IT_ITEM_PRICE A";
		sql += " WHERE VIP_SBCD_CD <> ''";
		...
		sql += " ORDER BY VIP_SBCD_CD";
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCOMP_DEPT_APPLY_ADD_UP_condition_001_V2___3 \n";
			G_INFO += "설명 : 추가검색정보 로딩___3 \n";
			G_INFO += "\n\n";
