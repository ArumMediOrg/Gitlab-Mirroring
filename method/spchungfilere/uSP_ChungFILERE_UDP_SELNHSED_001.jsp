...
SELECT BBP_CHUNG_YY,BBP_CHUNG_KD,BBP_CHUNG_DT,BBP_CHUNG_NO,BBP_BILBE_NO,BBP_BILL_FL,BBH_ACPT_NO, 
       MIN(BBP_EXAM_DT) STDT,MAX(BBP_EXAM_DT) EDDT, COUNT(*) CNT, SUM(BBP_BILLSED_PR) AMT
...
WHERE BBP_CHUNG_DT>=:dp_fromdt AND BBP_CHUNG_DT<=:dp_todt
   AND BBP_CHUNG_KD like '2%' AND BBP_RETURN_KD='0'
...
GROUP BY  BBP_CHUNG_YY,BBP_CHUNG_KD,BBP_CHUNG_DT,BBP_CHUNG_NO,BBP_BILBE_NO,BBP_BILL_FL ,BBH_ACPT_NO
		*/
		...
		sql = " SELECT BBP_CHUNG_YY,BBP_CHUNG_KD,BBP_CHUNG_DT,BBP_CHUNG_NO,BBP_BILBE_NO,BBP_BILL_FL,BBH_ACPT_NO, MIN(BBP_EXAM_DT) STDT,MAX(BBP_EXAM_DT) EDDT, COUNT(*) CNT, SUM(BBP_BILLSED_PR) AMT";
		...
		sql += " GROUP BY BBP_CHUNG_YY,BBP_CHUNG_KD,BBP_CHUNG_DT,BBP_CHUNG_NO,BBP_BILBE_NO,BBP_BILL_FL ,BBH_ACPT_NO";
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_ChungFILERE_UDP_SELNHSED_001 \n";
			G_INFO += "설명 : 청구정보 로딩 \n";
			G_INFO += "\n\n";
