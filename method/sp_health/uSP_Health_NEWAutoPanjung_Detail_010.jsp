...
Select SPG_PANJ_CD From ST_PANJUNG 
     ...
     And SPG_MATT_CD  = :MATT_CD
		*/
		...
		sql += " AND SPG_MATT_CD = '" + MATT_CD + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_Health_NEWAutoPanjung_Detail_010 \n";
			G_INFO += "설명 : 특검자동판정-이비인후 판정1 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='SPG_PANJ_CD' rs:number='1' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_PANJUNG'
			 rs:basecolumn='SPG_PANJ_CD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ROWID' rs:number='2' rs:rowid='true' rs:basetable='ST_PANJUNG' rs:basecolumn='ROWID'
