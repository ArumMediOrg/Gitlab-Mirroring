...
SELECT A.CSP_JJ_CD, A.CSP_SBCD_CD,
  ...
  FROM CT_SP_PROF A INNER JOIN IT_ITEM           B ON A.CSP_SBCD_CD = B.IIM_SBCD_CD
                    LEFT OUTER JOIN ET_RSLT_ITEM C ON B.IIM_ITEM_CD = C.ERI_ITEM_CD AND C.ERI_CNCL_YN <> 'Y'
   ...
   AND C.ERI_EXAM_SQ = :EXAM_SQ
		*/
		...
		sql += " AND C.ERI_EXAM_SQ = '" + EXAM_SQ + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_RecheckList_UF_ItemDisplay_002 \n";
			G_INFO += "설명 : 특검 1차 유소견항목 조회 \n";
			G_INFO += "\n\n";
