...
SELECT  PDP_EXAM_DT
 ...
 WHERE EEA_EXAM_DT = :EXAM_DT AND EEA_EXAM_SQ = :EXAM_SQ
		*/
		...
		sql = " SELECT PDP_EXAM_DT ,SUBSTR(EEA_HLTH_KD, 5, 1) AS HABIT_05 ,SUBSTR(EEA_HLTH_KD, 6, 1) AS HABIT_06 ,SUBSTR(EEA_HLTH_KD, 7, 1) AS HABIT_07 ,SUBSTR(EEA_HLTH_KD, 8, 1) AS HABIT_08 ,PSP_PRSCR_SM_YN, PSP_PRSCR_DRN_YN, PSP_PRSCR_SPT_YN, PSP_PRSCR_NUT_YN, PSP_PRSCR_PYC_YN, PSP_CESD_INFO_YN, QQN_RESULT QQN_RESULT_53, PSP_KDSQC, EEA_HCV_YN";
