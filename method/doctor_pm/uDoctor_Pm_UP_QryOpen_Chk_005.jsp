...
<%
		...
		sql = " SELECT A.* FROM ET_CANCER_CRVC A ";
        ...
        sql += " AND (NVL(A.ECV_PATH_LICEN_CD, ' ') <> ' ' OR NVL(A.ECV_COLL_LICEN_CD, ' ') <> ' ') ";


			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uDoctor_Pm_UP_QryOpen_Chk_005 \n";
			G_INFO += "설명 : 자궁암 검진정보 로딩(검사/진단의) \n";
			G_INFO += "\n\n";
