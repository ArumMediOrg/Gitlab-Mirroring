...
<%
		...
		sql = " SELECT ERI_EXAM_DT, ERI_EXAM_SQ, IIC_RSLT_GROUP from ET_RSLT_ITEM A ";
		...
		sql += " Group by ERI_EXAM_DT, ERI_EXAM_SQ, IIC_RSLT_GROUP ";


			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uEmail_Send_PAN_Send_001 \n";
			G_INFO += "설명 : 결과전송 검사그룹 조회 \n";
			G_INFO += "\n\n";
