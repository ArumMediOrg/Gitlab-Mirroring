...
SELECT A.*, B.*, C.*
  FROM ET_EXAM_ACPT A
 INNER JOIN IT_CUSTOMER B ON
       ICR_CUST_NO = EEA_CUST_NO
  LEFT OUTER JOIN ET_CANCER_LUNG C ON
       ECG_EXAM_DT = EEA_EXAM_DT AND
       ECG_EXAM_SQ = EEA_EXAM_SQ
 WHERE EEA_EXAM_DT = :EXAM_DT
   AND EEA_EXAM_SQ = :EXAM_SQ
   AND NVL(EEA_LUNG_CD, '0') <>  '0'
		*/

		sql = " SELECT A.*, B.*, C.*";
		sql += " FROM ET_EXAM_ACPT A INNER JOIN IT_CUSTOMER B";
		sql += " ON ICR_CUST_NO = EEA_CUST_NO LEFT OUTER JOIN ET_CANCER_LUNG C";
		...
		sql += " AND NVL(EEA_LUNG_CD, '0') <> '0'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCancer_Sahu_A4_DetailBand1BeforePrint_001 \n";
			G_INFO += "설명 : 폐암 사후관리 상담 통보서 조회 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='ECG_EXAM_DT' rs:number='190' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_EXAM_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_EXAM_SQ' rs:number='191' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_EXAM_SQ'>
			<s:datatype dt:type='string' dt:maxLength='6'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_CFRM_CD' rs:number='192' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_CFRM_CD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_LUEX_DT' rs:number='193' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_LUEX_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_LUEX_KD' rs:number='194' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_LUEX_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_CTDI_VL' rs:number='195' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_CTDI_VL'>
			<s:datatype dt:type='string' dt:maxLength='6'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_BEFO_YN' rs:number='196' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_BEFO_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_BEFO_YY' rs:number='197' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_BEFO_YY'>
			<s:datatype dt:type='string' dt:maxLength='4'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_BEFO_MM' rs:number='198' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_BEFO_MM'>
			<s:datatype dt:type='string' dt:maxLength='2'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT_YN' rs:number='199' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT1_YN' rs:number='200' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT1_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT1IC_KD' rs:number='201' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT1IC_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT1SL_KD' rs:number='202' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT1SL_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT1SZ1_VL' rs:number='203' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT1SZ1_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT1SZ2_VL' rs:number='204' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT1SZ2_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT1FT_KD' rs:number='205' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT1FT_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT1TR1_KD' rs:number='206' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT1TR1_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT1TR2_KD' rs:number='207' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT1TR2_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT2_YN' rs:number='208' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT2_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT2IC_KD' rs:number='209' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT2IC_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT2SL_KD' rs:number='210' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT2SL_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT2SZ1_VL' rs:number='211' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT2SZ1_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT2SZ2_VL' rs:number='212' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT2SZ2_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT2FT_KD' rs:number='213' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT2FT_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT2TR1_KD' rs:number='214' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT2TR1_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT2TR2_KD' rs:number='215' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT2TR2_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT3_YN' rs:number='216' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT3_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT3IC_KD' rs:number='217' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT3IC_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT3SL_KD' rs:number='218' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT3SL_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT3SZ1_VL' rs:number='219' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT3SZ1_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT3SZ2_VL' rs:number='220' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT3SZ2_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT3FT_KD' rs:number='221' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT3FT_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT3TR1_KD' rs:number='222' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT3TR1_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT3TR2_KD' rs:number='223' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT3TR2_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT4_YN' rs:number='224' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT4_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT4IC_KD' rs:number='225' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT4IC_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT4SL_KD' rs:number='226' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT4SL_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT4SZ1_VL' rs:number='227' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT4SZ1_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT4SZ2_VL' rs:number='228' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT4SZ2_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT4FT_KD' rs:number='229' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT4FT_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT4TR1_KD' rs:number='230' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT4TR1_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT4TR2_KD' rs:number='231' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT4TR2_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT5_YN' rs:number='232' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT5_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT5IC_KD' rs:number='233' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT5IC_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT5SL_KD' rs:number='234' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT5SL_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT5SZ1_VL' rs:number='235' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT5SZ1_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT5SZ2_VL' rs:number='236' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT5SZ2_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT5FT_KD' rs:number='237' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT5FT_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT5TR1_KD' rs:number='238' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT5TR1_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT5TR2_KD' rs:number='239' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT5TR2_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT6_YN' rs:number='240' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT6_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT6IC_KD' rs:number='241' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT6IC_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT6SL_KD' rs:number='242' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT6SL_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT6SZ1_VL' rs:number='243' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT6SZ1_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT6SZ2_VL' rs:number='244' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT6SZ2_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT6FT_KD' rs:number='245' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT6FT_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT6TR1_KD' rs:number='246' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT6TR1_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT6TR2_KD' rs:number='247' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT6TR2_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_BRLE_YN' rs:number='248' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_BRLE_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_BRLE_EX' rs:number='249' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_BRLE_EX'>
			<s:datatype dt:type='string' dt:maxLength='40'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_LUCN_KD' rs:number='250' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_LUCN_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_LUCN_EX' rs:number='251' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_LUCN_EX'>
			<s:datatype dt:type='string' dt:maxLength='40'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_SCRT_CD' rs:number='252' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_SCRT_CD'>
			<s:datatype dt:type='string' dt:maxLength='9'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_SCRT_EX' rs:number='253' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_SCRT_EX'>
			<s:datatype dt:type='string' dt:maxLength='40'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_INPT_YN' rs:number='254' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_INPT_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_RSLT_KD' rs:number='255' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_RSLT_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_RSLT2_KD' rs:number='256' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_RSLT2_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_ETC_EX' rs:number='257' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_ETC_EX'>
			<s:datatype dt:type='string' dt:maxLength='40'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_RSLT_EX' rs:number='258' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_RSLT_EX'>
			<s:datatype dt:type='string' dt:maxLength='1200'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_RSLT_ETC_EX' rs:number='259' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_RSLT_ETC_EX'>
			<s:datatype dt:type='string' dt:maxLength='1200'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_CFRM_DT' rs:number='260' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_CFRM_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_LICEN_CD' rs:number='261' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_LICEN_CD'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_DECI_LICEN_CD' rs:number='262' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_DECI_LICEN_CD'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_LUCN_YN' rs:number='263' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_LUCN_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_AFRL_EX' rs:number='264' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_AFRL_EX'>
			<s:datatype dt:type='string' dt:maxLength='1200'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_AFSM_EX' rs:number='265' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_AFSM_EX'>
			<s:datatype dt:type='string' dt:maxLength='1200'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_AFDT_DT' rs:number='266' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_AFDT_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_AFPL_CD' rs:number='267' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_AFPL_CD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_AFTE_LICEN_CD' rs:number='268' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_AFTE_LICEN_CD'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_INPUT_DTT' rs:number='269' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_INPUT_DTT'>
			<s:datatype dt:type='dateTime' rs:dbtype='timestamp' dt:maxLength='16' rs:scale='0' rs:precision='19' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_INPUT_ID' rs:number='270' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_INPUT_ID'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_MODI_DTT' rs:number='271' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_MODI_DTT'>
			<s:datatype dt:type='dateTime' rs:dbtype='timestamp' dt:maxLength='16' rs:scale='0' rs:precision='19' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_MODI_ID' rs:number='272' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_MODI_ID'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_ETC_KD' rs:number='273' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_ETC_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ROWID' rs:number='274' rs:rowid='true' rs:basetable='ET_EXAM_ACPT' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c274' rs:name='ROWID' rs:number='275' rs:rowid='true' rs:basetable='IT_CUSTOMER' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c275' rs:name='ROWID' rs:number='276' rs:rowid='true' rs:basetable='ET_CANCER_LUNG'
...
<%
		...
		while(cRsList.next()) {
			...
			String c274_T = cRsList.getString("c274");
			String c275_T = cRsList.getString("c275");
%>
			<z:row
<%
