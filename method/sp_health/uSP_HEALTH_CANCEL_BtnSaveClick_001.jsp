...
<%
		...
		String CANC_LT = htMethod.get("CANC_LT");
		...
		sql = func_uSP_HEALTH_CANCEL_BtnSaveClick_001(stmtExec, htMethod);

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_HEALTH_CANCEL_BtnSaveClick_001 \n";
			G_INFO += "설명 : 미실시사유 저장(inert,update) \n";
			G_INFO += "\n\n";
