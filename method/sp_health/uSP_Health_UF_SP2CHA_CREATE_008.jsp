...
Insert Into ST_ITEM_RECHECK
(SIR_EXAM_DT,  SIR_EXAM_SQ,   SIR_EXAM_CHA, SIR_MATT_CD,  SIR_ORGA_CD,
 SIR_MKJJ_CD,  SIR_SWING_CD,  SIR_CUST_NO,  SIR_EITEM_LT, SIR_EXAM_DT2,
 SIR_EXAM_SQ2, SIR_ETITEM_LT, SIR_INPT_ID,  SIR_INPT_DTT)
Values
||:sSQL_ADD
		*/
		...
		stmtExec.executeUpdate(sql);
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_Health_UF_SP2CHA_CREATE_008 \n";
			G_INFO += "설명 : 2차접수생성-2차 대상테이블 저장(insert) \n";
			G_INFO += "\n\n";
