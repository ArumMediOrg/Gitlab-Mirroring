   ...
   AND ERI_ITEM_CD = :ITEM_CD                                                                                                                             
		*/
		...
		sql += " AND ERI_ITEM_CD = '" + ITEM_CD + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uExam_Result_grdDevRsltDblClickCell_001 \n";
			G_INFO += "설명 : 검사결과조회(PACS 결과) \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='ERI_PACS_RSLT' rs:number='1' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_RSLT_ITEM'
