...
<%
		...
		sql = func_uSP_Health_GrdEXAM_ACPTSelectionChanged_010(stmtExec, htMethod);

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_Health_GrdEXAM_ACPTSelectionChanged_010 \n";
			G_INFO += "설명 : 접수정보저장(입사일자) 특검1차 =&#62; 2차 \n";
			G_INFO += "\n\n";
