...
Select IIM_ITEM_CD, IIM_KNME_NM, IIM_SNME_NM, IIM_SBCD_CD, IIM_TUSE_YN
  From IT_ITEM
 Where 1 =1
 ||:sSQL_ADD
		*/

		sql = " SELECT IIM_ITEM_CD, IIM_KNME_NM, IIM_SNME_NM, IIM_SBCD_CD, IIM_TUSE_YN";
		sql += " FROM IT_ITEM";
		sql += " WHERE 1 =1";
		sql += SSQL_ADD;
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_HEALTH_JINPE_BtnQueryClick_001 \n";
			G_INFO += "설명 : 출력대상 검사항목조회(흉부,폐) \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='IIM_TUSE_YN' rs:number='5' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_ITEM'
