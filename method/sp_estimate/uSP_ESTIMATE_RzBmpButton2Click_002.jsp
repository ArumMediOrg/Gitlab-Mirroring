...
SELECT B.IIM_ITEM_CD, B.IIM_KNME_NM  CSP_SBCD_NM,
 ...
 ORDER BY B.IIM_ITEM_CD
		*/
		...
		sql = " SELECT B.IIM_ITEM_CD, B.IIM_KNME_NM CSP_SBCD_NM, C.IIP_SBSG_PR, C.IIP_TGSG_PR, C.IIP_GBSG_PR, GETSP_COMMON_CDTONM('HM05D',A.CSP_JANGGI_CD) CSP_JANGGI_NM, A.*, B.IIM_TBIO_YN ";
