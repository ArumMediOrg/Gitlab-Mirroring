...
SELECT ICY_SUTK_YN FROM IT_COMPANY
 WHERE ICY_COMP_CD = :COMP_CD
		*/

		sql = " SELECT ICY_SUTK_YN";
		sql += " FROM IT_COMPANY";
		sql += " WHERE ICY_COMP_CD = '" + COMP_CD + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uIT_SPChungGU_FILE_RzBmpButton2Click_001 \n";
			G_INFO += "설명 : 국고사업장 유무확인 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='ICY_SUTK_YN' rs:number='1' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_COMPANY'
