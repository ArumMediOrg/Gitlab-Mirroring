...
<%
		...
		String SMARK_CD = htMethod.get("SMARK_CD");
		String SMAX_SQ = htMethod.get("SMAX_SQ");
		String PRNT_SQ = htMethod.get("PRNT_SQ");
		...
		sql = func_uPack_Mark_btnSave_MkClick_003_TRAN002(stmtExec, htMethod);

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uPack_Mark_btnSave_MkClick_003_TRAN002 \n";
			...
			G_INFO += " GUSER : " + GUSER + " \n";
			G_INFO += " SMARK_CD : " + SMARK_CD + " \n";
			G_INFO += " SMAX_SQ : " + SMAX_SQ + " \n";
			G_INFO += " PRNT_SQ : " + PRNT_SQ + " \n";
			G_INFO += "\n\n";
