...
<%!
	public String func_uItem_BatchYN_btnSaveClick_009(Statement argStmtExec, HashMap argHtMethod) throws Exception {
		...
		try {
			...
			CallStmtExec.setString(4, ORDER_CD);
