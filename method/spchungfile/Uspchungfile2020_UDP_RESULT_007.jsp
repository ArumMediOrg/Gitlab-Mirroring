...
<%
		...
		sql = " SELECT ";
		sql += " A.CSM_MATT_CD, A.CSM_MATT_NM, A.CSM_COMM_CD, ";
		sql += " B.CSC_FULL_NM, B.CSC_ETC1_CD ";
		sql += " FROM CT_SP_MATTER A ";
		sql += " INNER JOIN CT_SP_COMMON B ON B.CSC_LARGE = 'HM99A' ";
		...
		sql += " AND A.CSM_USE_YN = 'Y' ";
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : Uspchungfile2020_UDP_RESULT_007 \n";
			G_INFO += "설명 : 특수검진 1차 표적장기 조회 \n";
			G_INFO += "\n\n";
