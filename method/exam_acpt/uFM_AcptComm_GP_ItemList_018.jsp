...
<%
		...
		String CS_SMALL = htMethod.get("CS_SMALL");

		//
		if(CS_SMALL == null) { CS_SMALL = ""; }
...
SELECT CSC_ETC1_CD, CSC_ETC2_CD 
  FROM CT_SP_COMMON 
 WHERE CSC_LARGE = 'HM05G'
   AND CSC_SMALL = :CS_SMALL
		*/

		sql = " SELECT CSC_ETC1_CD, CSC_ETC2_CD";
		sql += " FROM CT_SP_COMMON";
		sql += " WHERE CSC_LARGE = 'HM05G'";
		sql += " AND CSC_SMALL = '" + CS_SMALL + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uFM_AcptComm_GP_ItemList_018 \n";
			G_INFO += "설명 : 특검 재료대 검사항목 조회 \n";
			G_INFO += "\n\n";

			G_INFO += "전달인자 : \n";
			G_INFO += " CS_SMALL : " + CS_SMALL + " \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='CSC_ETC2_CD' rs:number='2' rs:nullable='true' rs:writeunknown='true' rs:basetable='CT_SP_COMMON'
