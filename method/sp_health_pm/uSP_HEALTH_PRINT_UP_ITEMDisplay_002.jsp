...
Where ERI_EXAM_DT = :EXAM_DT
      ...
      And ERI_RSLT_KD In ('1', '2', '4', '5', '7')
      And ERI_ITEM_CD Not In ('A0001', 'A0002', 'A0014', 'A0015', 'F0002', 'S0020')
      And ERI_CNCL_YN = 'N'
		*/
		...
		sql += " AND ERI_RSLT_KD IN ('1', '2', '4', '5', '7')";
		sql += " AND ERI_ITEM_CD NOT IN ('A0001', 'A0002', 'A0014', 'A0015', 'F0002', 'S0020')";
		sql += " AND ERI_CNCL_YN = 'N'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_HEALTH_PRINT_UP_ITEMDisplay_002 \n";
			G_INFO += "설명 : 검사결과정보 로딩 \n";
			G_INFO += "\n\n";
