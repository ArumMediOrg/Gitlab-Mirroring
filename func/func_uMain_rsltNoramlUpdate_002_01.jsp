...
<%!
	public String func_uMain_rsltNoramlUpdate_002_01(Statement argStmtExec, HashMap argHtMethod) throws Exception {
		...
		try {
			...
			sql += " , ERI_CHAR_CD   = '" + END_221114 + "' ";
			sql += " , ERI_PACS_RSLT = '" + END_221114 + "' ";
			sql += " , ERI_PRCH_VL   = '" + END_221114 + "' ";
			sql += " , ERI_PRNM_VL   = '" + END_221114 + "' ";
			sql += " , ERI_RSLT_KD   = '" + END_221114 + "' ";
			sql += " , ERI_MODI_ID   = '" + END_221114 + "' ";
			sql += " , ERI_MODI_DTT = SYSDATE ";
			sql += " , ERI_OCS_VL   = '" + END_221114 + "'  ";

			if(!RSLT_EX.equals("")) {
			sql += " ,  ERI_RSLT_EX = '" + END_221114 + "' ";
			}

			sql += " WHERE ERI_EXAM_DT = '" + END_221114 + "' ";
			sql += " AND ERI_EXAM_SQ = '" + END_221114 + "' ";

			if(CODE_GBN.equals("ITEM_CD")) {
				sql += " AND (ERI_ITEM_CD = '" + END_221114 + "') ";
			} else {
				sql += " AND (NVL(ERI_OSRL_CD,'XXX') = '" + END_221114 +"') ";
			}
