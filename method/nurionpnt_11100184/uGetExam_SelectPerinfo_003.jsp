...
<%
		...
		String SPACK_CD = htMethod.get("SPACK_CD");
		String SCOMP_CD = htMethod.get("SCOMP_CD");

		//
		if(SPACK_CD == null) { SPACK_CD = ""; }
		if(SCOMP_CD == null) { SCOMP_CD = ""; }

		// DB객체
		stmtList = connect.createStatement();

		sql = " SELECT F_PACK_FIND('" + SPACK_CD + "', '" + SCOMP_CD + "') AS PACK_NM";
		sql += " FROM DUAL";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uGetExam_SelectPerinfo_003 \n";
			G_INFO += "설명 : 인적조회(검진명,묶음코드명칭) \n";
			G_INFO += "\n\n";

			G_INFO += "전달인자 : \n";
			G_INFO += " SPACK_CD : " + SPACK_CD + " \n";
