...
<%
		...
		sql += " (SELECT CCN_FULL_NM FROM CT_COMMON WHERE CCN_LARGE= '0401' AND CCN_SMALL = EEA_EXAM_CD) EXAM_NM, ";
		sql += " (SELECT IAU_PENL_NM FROM IT_AUTH_USER WHERE IAU_EMP_NO = CAP_DOCTOR) CAP_DOCTOR_NM ";
		sql += " ,GetCOMMON_LvCdToNm('0314',A.CAP_RSVN_TM,'5',2) RSVN_TM ";
		...
		sql += " WHERE A.CAP_RSVN_DT = '" + EXAM_DT + "' ";
		sql += " ORDER BY CAP_RSVN_DT, CAP_RSVN_TM ";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSchedule_Apply_UF_GridDisplay_001 \n";
			G_INFO += "설명 : 상담스케줄 조회 \n";
			G_INFO += "\n\n";
