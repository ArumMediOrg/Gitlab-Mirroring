...
SELECT CCN_SMALL
from CT_COMMON
WHERE CCN_LARGE = :LARGE
  AND CCN_LEVEL = :LEVEL
  AND (CCN_FULL_NM = :FULL_NM OR CCN_SMALL = :SMALL)
		*/
		...
		sql += " AND (CCN_FULL_NM = '" + FULL_NM + "' OR CCN_SMALL = '" + SMALL + "')";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCOMP_CNRT_CUST_APPLY_BtnEXCEL_ErrorChkClick_004 \n";
			G_INFO += "설명 : 엑셀오류체크-코드오류체크 \n";
			G_INFO += "\n\n";
