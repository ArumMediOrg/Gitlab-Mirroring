...
From ST_PANJUNG A
 ...
 ||:sSQL_ADD
		...
		*/
		...
		sql += " OR B.EEA_SEX_CD = '' THEN B.EEA_SEX_CD ELSE GETCOMMON_LVCDTONM('0411',B.EEA_SEX_CD,'5',1) END EEA_SEX_NM";
		...
		sql += SSQL_ADD;
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_HEALTH_JINPE_BtnQueryClick_005 \n";
			G_INFO += "설명 : 진폐정도관리(흉부) 대상조회 메인 \n";
			G_INFO += "\n\n";
