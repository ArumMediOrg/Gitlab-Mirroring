...
Select count(IAP_USER_ID) From IT_AUTH_PRGM_ID Where IAP_USER_ID = :USER_ID and nvl(IAP_MENU_ID, ' ') <> ' '
		*/

		sql = " SELECT COUNT(IAP_USER_ID)";
		sql += " FROM IT_AUTH_PRGM_ID";
		sql += " WHERE IAP_USER_ID = '" + USER_ID + "'";
		sql += " AND NVL(IAP_MENU_ID, ' ') <> ' '";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uUserAuthManagement_setGroupProgramInfo_003 \n";
			G_INFO += "설명 : 계정에 해당하는 메뉴개수 로딩 \n";
			G_INFO += "\n\n";
