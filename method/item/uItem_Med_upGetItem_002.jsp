...
SELECT IIM_KNME_NM, IIM_USE_YN 
FROM IT_ITEM 
WHERE IIM_ITEM_CD = :IIM_ITEM_CD 
		*/

		sql = " SELECT IIM_KNME_NM, IIM_USE_YN";
		sql += " FROM IT_ITEM";
		sql += " WHERE IIM_ITEM_CD = '" + IIM_ITEM_CD + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uItem_Med_upGetItem_002 \n";
			G_INFO += "설명 : 검사항목명 조회(사용유무 포함) \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='IIM_USE_YN' rs:number='2' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_ITEM'
