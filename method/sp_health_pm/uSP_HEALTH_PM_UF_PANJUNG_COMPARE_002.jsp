...
SELECT GetSP_COMMON_cdToNm('HM05E',SPG_PANJ_CD) SPG_PANJ_NM, A.* FROM ST_PANJUNG A
WHERE SPG_EXAM_DT  = :EXAM_DT
  AND SPG_EXAM_SQ  = :EXAM_SQ
  AND SPG_EXAM_CHA = '2'                                                              
  AND SPG_MATT_CD  = :MATT_CD
  AND SPG_ORGA_CD  = :ORGA_CD
		*/

		sql = " SELECT GETSP_COMMON_CDTONM('HM05E',SPG_PANJ_CD) SPG_PANJ_NM, A.*";
		...
		sql += " AND SPG_ORGA_CD = '" + ORGA_CD + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_HEALTH_PM_UF_PANJUNG_COMPARE_002 \n";
			G_INFO += "설명 : 판정정보 로딩 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='SPG_PANJ_NM' rs:number='1' rs:nullable='true'>
		...
		<s:AttributeType name='ROWID' rs:number='41' rs:rowid='true' rs:basetable='ST_PANJUNG' rs:basecolumn='ROWID'
