...
<%
		...
		sql += " Select * From ET_COMP_CNRT_CUST ";
		sql += " Where ECT_EXAM_DT Is Null ";
		sql += " And ECT_COMP_CD = '" + COMP_CD + "' ";
		sql += " 	And ECT_MNGT_YR = '" + MNGT_YR + "' ";


		if(!PSNL_NM.equals("")){
			sql += " AND ECT_CUST_NM LIKE '%" + PSNL_NM + "%' ";
		}
		...
		if(!CNRT_SQ.equals("")){
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uMain_btnSearchClick_007 \n";
			G_INFO += "설명 : 사업장 일괄예약 인원 조회 \n";
			G_INFO += "\n\n";
