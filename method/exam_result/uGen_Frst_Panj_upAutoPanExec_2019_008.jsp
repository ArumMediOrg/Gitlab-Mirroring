...
SELECT QQN_RESULT SMK
 ...
 WHERE QQN_EXAM_DT = :EXAM_DT
   ...
   AND IIQ_ITQU_LV1 = :ITQU_LV1
   AND IIQ_ITQU_LV2 = :ITQU_LV2
		*/

		sql = " SELECT QQN_RESULT SMK";
		...
		sql += " AND IIQ_ITQU_LV1 = '" + ITQU_LV1 + "'";
		sql += " AND IIQ_ITQU_LV2 = '" + ITQU_LV2 + "'";
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uGen_Frst_Panj_upAutoPanExec_2019_008 \n";
			G_INFO += "설명 : 일검자동판정(문진 흡연1) \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='SMK' rs:number='1' rs:nullable='true' rs:writeunknown='true' rs:basetable='QT_QUESTION'
		...
		<s:AttributeType name='c2' rs:name='ROWID' rs:number='3' rs:rowid='true' rs:basetable='IT_ITEM_QUESTION' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
...
<%
		...
		while(cRsList.next()) {
			...
			String SMK_T = cRsList.getString("SMK");
