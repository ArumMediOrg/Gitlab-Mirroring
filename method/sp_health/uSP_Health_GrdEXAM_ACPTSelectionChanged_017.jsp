...
where A.ERI_EXAM_DT = :EXAM_DT
  ...
  and B.IIM_SBCD_CD = '0373'
		*/
		...
		sql += " AND B.IIM_SBCD_CD = '0373'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_Health_GrdEXAM_ACPTSelectionChanged_017 \n";
			G_INFO += "설명 : 특검 구강검사 유무 조회 \n";
			G_INFO += "\n\n";
