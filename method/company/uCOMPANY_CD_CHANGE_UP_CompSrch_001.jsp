...
SELECT ICY_COMP_CD, ICY_COMP_NM, ICY_COMP_SQ, ICY_USE_YN
  FROM IT_COMPANY
 WHERE ICY_COMP_CD LIKE :COMP_CD||'%'
 ORDER BY ICY_COMP_CD

		*/

		sql = " SELECT ICY_COMP_CD, ICY_COMP_NM, ICY_COMP_SQ, ICY_USE_YN";
		sql += " FROM IT_COMPANY";
		sql += " WHERE ICY_COMP_CD LIKE '" + COMP_CD + "%'";
		sql += " ORDER BY ICY_COMP_CD";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCOMPANY_CD_CHANGE_UP_CompSrch_001 \n";
			G_INFO += "설명 : 사업장리스트(대표번호공통인경우) \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='ICY_COMP_SQ' rs:number='3' rs:writeunknown='true' rs:basetable='IT_COMPANY' rs:basecolumn='ICY_COMP_SQ'>
			<s:datatype dt:type='string' dt:maxLength='2' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='ICY_USE_YN' rs:number='4' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_COMPANY'
