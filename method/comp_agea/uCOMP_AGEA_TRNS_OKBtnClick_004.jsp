...
<%
		...
		String AGEA_KD = htMethod.get("AGEA_KD");
		...
		sql = func_uCOMP_AGEA_TRNS_OKBtnClick_004(stmtExec, htMethod);

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCOMP_AGEA_TRNS_OKBtnClick_004 \n";
			G_INFO += "설명 : 계약단가이관 insert(이관)  검사항목개별 \n";
			G_INFO += "\n\n";

			G_INFO += "전달인자 : \n";
			G_INFO += " COMP_CD : " + COMP_CD + " \n";
			G_INFO += " MNGT_YR : " + MNGT_YR + " \n";
			G_INFO += " AGEA_KD : " + AGEA_KD + " \n";
