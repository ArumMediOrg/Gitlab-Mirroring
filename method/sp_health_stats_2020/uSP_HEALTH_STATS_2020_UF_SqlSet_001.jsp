...
SELECT MIN(EEA_EXAM_DT) AS EEA_MIN_DT, MAX(EEA_EXAM_DT) AS EEA_MAX_DT
  FROM ET_EXAM_ACPT
:PARAM_TX 
		*/

		sql = " SELECT MIN(EEA_EXAM_DT) AS EEA_MIN_DT, MAX(EEA_EXAM_DT) AS EEA_MAX_DT";
		sql += " FROM ET_EXAM_ACPT";
		sql += PARAM_TX;

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_HEALTH_STATS_2020_UF_SqlSet_001 \n";
			G_INFO += "설명 : 특검1차 검진기간 조회 \n";
			G_INFO += "\n\n";
