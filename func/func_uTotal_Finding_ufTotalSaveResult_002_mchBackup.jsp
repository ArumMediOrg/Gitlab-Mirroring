		...
		try {
			...
			if(PRNT_DT == null) { PRNT_DT = ""; }
				...
				if(ICNT.equals("0")) {
						...
						sql = "INSERT INTO ST_SYTH_VIEW ( SSV_EXAM_DT , SSV_EXAM_SQ , SSV_PACK_CD , SSV_VIEW_EX , SSV_DOCTOR , SSV_RPT_DT , SSV_INPT_ID , SSV_INPT_DTT , SSV_VIEW_RTF) VALUES (";
						sql += "  ?";
						sql += ", ?";
						sql += ", ?";
						sql += ", ?";
						...
						CallStmtExec.setString(9,  PACK_CD);
