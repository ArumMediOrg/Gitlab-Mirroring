...
<%
    ...
    if (:g_Encrt_Kd = '1') then
      ...
      SELECT B.ICR_PENL_ID AS ICR_PENL_DE,
            ...
            A.*, S.*, B.ICR_PENL_ID, 
            C.IAU_LICEN1_NO LICEN_NO1, C.IAU_PENL_NM LICEN_NM1, 
            D.IAU_LICEN1_NO LICEN_NO2, D.IAU_PENL_NM LICEN_NM2  
      FROM ET_EXAM_ACPT A  
      ...
      LEFT OUTER JOIN ET_CANCER_LUNG S ON
             S.ECG_EXAM_DT = A.EEA_EXAM_DT AND 
             S.ECG_EXAM_SQ = A.EEA_EXAM_SQ
      LEFT OUTER JOIN IT_AUTH_USER C ON 
             C.IAU_EMP_NO = S.ECG_LICEN_CD AND NVL(S.ECG_LICEN_CD, ' ') <> ' '  
      LEFT OUTER JOIN IT_AUTH_USER D ON 
             D.IAU_EMP_NO = S.ECG_DECI_LICEN_CD AND NVL(S.ECG_DECI_LICEN_CD, ' ') <> ' ' 
      WHERE A.EEA_EXAM_DT = :EXAM_DT
		...
		*/
		...
		sql += " AND H.ECH_EXAM_SQ = A.EEA_EXAM_SQ LEFT OUTER JOIN ET_CANCER_LUNG S";
		sql += " ON S.ECG_EXAM_DT = A.EEA_EXAM_DT";
		sql += " AND S.ECG_EXAM_SQ = A.EEA_EXAM_SQ LEFT OUTER JOIN IT_AUTH_USER C";
		sql += " ON C.IAU_EMP_NO = S.ECG_LICEN_CD";
		sql += " AND NVL(S.ECG_LICEN_CD, ' ') <> ' ' LEFT OUTER JOIN IT_AUTH_USER D";
		sql += " ON D.IAU_EMP_NO = S.ECG_DECI_LICEN_CD";
		sql += " AND NVL(S.ECG_DECI_LICEN_CD, ' ') <> ' '";
		sql += " WHERE A.EEA_EXAM_DT = '" + EXAM_DT + "'";
		sql += " AND A.EEA_EXAM_SQ = '" + EXAM_SQ + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCancer_Record_Lung_DetailBand1BeforePrint_001 \n";
			G_INFO += "설명 : 폐암 검사정보 로딩 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='ECG_EXAM_DT' rs:number='146' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_EXAM_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_EXAM_SQ' rs:number='147' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_EXAM_SQ'>
			<s:datatype dt:type='string' dt:maxLength='6'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_CFRM_CD' rs:number='148' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_CFRM_CD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_LUEX_DT' rs:number='149' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_LUEX_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_LUEX_KD' rs:number='150' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_LUEX_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_CTDI_VL' rs:number='151' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_CTDI_VL'>
			<s:datatype dt:type='string' dt:maxLength='6'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_BEFO_YN' rs:number='152' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_BEFO_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_BEFO_YY' rs:number='153' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_BEFO_YY'>
			<s:datatype dt:type='string' dt:maxLength='4'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_BEFO_MM' rs:number='154' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_BEFO_MM'>
			<s:datatype dt:type='string' dt:maxLength='2'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT_YN' rs:number='155' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT1_YN' rs:number='156' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT1_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT1IC_KD' rs:number='157' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT1IC_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT1SL_KD' rs:number='158' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT1SL_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT1SZ1_VL' rs:number='159' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT1SZ1_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT1SZ2_VL' rs:number='160' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT1SZ2_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT1FT_KD' rs:number='161' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT1FT_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT1TR1_KD' rs:number='162' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT1TR1_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT1TR2_KD' rs:number='163' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT1TR2_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT2_YN' rs:number='164' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT2_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT2IC_KD' rs:number='165' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT2IC_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT2SL_KD' rs:number='166' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT2SL_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT2SZ1_VL' rs:number='167' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT2SZ1_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT2SZ2_VL' rs:number='168' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT2SZ2_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT2FT_KD' rs:number='169' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT2FT_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT2TR1_KD' rs:number='170' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT2TR1_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT2TR2_KD' rs:number='171' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT2TR2_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT3_YN' rs:number='172' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT3_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT3IC_KD' rs:number='173' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT3IC_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT3SL_KD' rs:number='174' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT3SL_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT3SZ1_VL' rs:number='175' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT3SZ1_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT3SZ2_VL' rs:number='176' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT3SZ2_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT3FT_KD' rs:number='177' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT3FT_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT3TR1_KD' rs:number='178' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT3TR1_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT3TR2_KD' rs:number='179' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT3TR2_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT4_YN' rs:number='180' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT4_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT4IC_KD' rs:number='181' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT4IC_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT4SL_KD' rs:number='182' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT4SL_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT4SZ1_VL' rs:number='183' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT4SZ1_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT4SZ2_VL' rs:number='184' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT4SZ2_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT4FT_KD' rs:number='185' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT4FT_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT4TR1_KD' rs:number='186' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT4TR1_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT4TR2_KD' rs:number='187' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT4TR2_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT5_YN' rs:number='188' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT5_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT5IC_KD' rs:number='189' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT5IC_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT5SL_KD' rs:number='190' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT5SL_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT5SZ1_VL' rs:number='191' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT5SZ1_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT5SZ2_VL' rs:number='192' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT5SZ2_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT5FT_KD' rs:number='193' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT5FT_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT5TR1_KD' rs:number='194' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT5TR1_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT5TR2_KD' rs:number='195' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT5TR2_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT6_YN' rs:number='196' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT6_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT6IC_KD' rs:number='197' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT6IC_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT6SL_KD' rs:number='198' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT6SL_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT6SZ1_VL' rs:number='199' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT6SZ1_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT6SZ2_VL' rs:number='200' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT6SZ2_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT6FT_KD' rs:number='201' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT6FT_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT6TR1_KD' rs:number='202' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT6TR1_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_PNRT6TR2_KD' rs:number='203' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_PNRT6TR2_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_BRLE_YN' rs:number='204' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_BRLE_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_BRLE_EX' rs:number='205' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_BRLE_EX'>
			<s:datatype dt:type='string' dt:maxLength='40'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_LUCN_KD' rs:number='206' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_LUCN_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_LUCN_EX' rs:number='207' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_LUCN_EX'>
			<s:datatype dt:type='string' dt:maxLength='40'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_SCRT_CD' rs:number='208' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_SCRT_CD'>
			<s:datatype dt:type='string' dt:maxLength='9'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_SCRT_EX' rs:number='209' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_SCRT_EX'>
			<s:datatype dt:type='string' dt:maxLength='40'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_INPT_YN' rs:number='210' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_INPT_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_RSLT_KD' rs:number='211' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_RSLT_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_RSLT2_KD' rs:number='212' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_RSLT2_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_ETC_EX' rs:number='213' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_ETC_EX'>
			<s:datatype dt:type='string' dt:maxLength='40'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_RSLT_EX' rs:number='214' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_RSLT_EX'>
			<s:datatype dt:type='string' dt:maxLength='1200'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_RSLT_ETC_EX' rs:number='215' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_RSLT_ETC_EX'>
			<s:datatype dt:type='string' dt:maxLength='1200'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_CFRM_DT' rs:number='216' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_CFRM_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_LICEN_CD' rs:number='217' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_LICEN_CD'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_DECI_LICEN_CD' rs:number='218' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_DECI_LICEN_CD'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_LUCN_YN' rs:number='219' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_LUCN_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_AFRL_EX' rs:number='220' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_AFRL_EX'>
			<s:datatype dt:type='string' dt:maxLength='1200'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_AFSM_EX' rs:number='221' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_AFSM_EX'>
			<s:datatype dt:type='string' dt:maxLength='1200'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_AFDT_DT' rs:number='222' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_AFDT_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_AFPL_CD' rs:number='223' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_AFPL_CD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_AFTE_LICEN_CD' rs:number='224' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_AFTE_LICEN_CD'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_INPUT_DTT' rs:number='225' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_INPUT_DTT'>
			<s:datatype dt:type='dateTime' rs:dbtype='timestamp' dt:maxLength='16' rs:scale='0' rs:precision='19' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_INPUT_ID' rs:number='226' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_INPUT_ID'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_MODI_DTT' rs:number='227' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_MODI_DTT'>
			<s:datatype dt:type='dateTime' rs:dbtype='timestamp' dt:maxLength='16' rs:scale='0' rs:precision='19' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_MODI_ID' rs:number='228' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_MODI_ID'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECG_ETC_KD' rs:number='229' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ECG_ETC_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ICR_PENL_ID' rs:number='230' rs:writeunknown='true' rs:basetable='IT_CUSTOMER' rs:basecolumn='ICR_PENL_ID'>
			<s:datatype dt:type='string' dt:maxLength='13' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='LICEN_NO1' rs:number='231' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
			 rs:basecolumn='IAU_LICEN1_NO'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='LICEN_NM1' rs:number='232' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
			 rs:basecolumn='IAU_PENL_NM'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='LICEN_NO2' rs:number='233' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
			 rs:basecolumn='IAU_LICEN1_NO'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='LICEN_NM2' rs:number='234' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
			 rs:basecolumn='IAU_PENL_NM'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='ROWID' rs:number='235' rs:rowid='true' rs:basetable='ET_EXAM_ACPT' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c235' rs:name='ROWID' rs:number='236' rs:rowid='true' rs:basetable='IT_CUSTOMER' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c236' rs:name='ROWID' rs:number='237' rs:rowid='true' rs:basetable='ET_CANCER_HEADER'
			 rs:basecolumn='ROWID' rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c237' rs:name='ROWID' rs:number='238' rs:rowid='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ROWID' rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c238' rs:name='ROWID' rs:number='239' rs:rowid='true' rs:basetable='IT_AUTH_USER' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c239' rs:name='ROWID' rs:number='240' rs:rowid='true' rs:basetable='IT_AUTH_USER' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
...
<%
		...
		while(cRsList.next()) {
			...
			String c235_T = cRsList.getString("c235");
			String c236_T = cRsList.getString("c236");
			String c237_T = cRsList.getString("c237");
