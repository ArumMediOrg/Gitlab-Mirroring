...
SELECT CSC_FULL_NM
  FROM CT_SP_COMMON
 WHERE CSC_LARGE = 'HM05A'
   AND CSC_CODE_EX = '사후관리 조치'
		*/

		sql = " SELECT CSC_FULL_NM";
		sql += " FROM CT_SP_COMMON";
		sql += " WHERE CSC_LARGE = 'HM05A'";
		sql += " AND CSC_CODE_EX = '사후관리 조치'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uExam_Result_upSetComboBox_004 \n";
			G_INFO += "설명 : 특검공통코드조회(사후조치) \n";
			G_INFO += "\n\n";
