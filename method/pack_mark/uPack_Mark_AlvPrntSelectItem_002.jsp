...
select a.emi_item_cd item_cd,
       ...
       f_ocs_find(a.emi_item_cd) ocs_cd, a.emi_rslt_up item_up, a.emi_rslt_dn item_dn
  from et_pack_mark_item a
 where a.emi_mark_kd = '2'
 ...
 order by a.emi_sort_sq 
		...
		*/
		...
		sql = " SELECT A.EMI_ITEM_CD ITEM_CD, F_ITEM_FIND('', A.EMI_ITEM_CD, 'K') ITEM_NM, F_ITEM_FIND('', A.EMI_ITEM_CD, 'S') PRNT_NM, F_OCS_FIND(A.EMI_ITEM_CD) OCS_CD, A.EMI_RSLT_UP ITEM_UP, A.EMI_RSLT_DN ITEM_DN";
		sql += " FROM ET_PACK_MARK_ITEM A";
		sql += " WHERE A.EMI_MARK_KD = '2'";
		...
		sql += " ORDER BY A.EMI_SORT_SQ";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uPack_Mark_AlvPrntSelectItem_002 \n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='ROWID' rs:number='7' rs:rowid='true' rs:basetable='ET_PACK_MARK_ITEM' rs:basecolumn='ROWID'
