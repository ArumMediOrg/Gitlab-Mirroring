...
<%
		...
		sql = " SELECT DISTINCT A.EEA_EXAM_DT, A.EEA_CUST_NO, A.EEA_PSNL_NM, SUBSTR(B.ICR_PENL_ID,1,6) EEA_BIRTH_DT, B.ICR_BIRH_KD, A.EEA_EXAM_SQ, A.EEA_PSNL_AGE, B.ICR_TEL_NO, B.ICR_MOBL_NO, A.EEA_COMP_CD, C.ICY_COMP_NM, A.EEA_SEX_CD, A.EEA_2ND_YN, LENGTH(A.EEA_RFID_NO) AS EEA_RFID_NO, CASE WHEN A.EEA_EXAM_CD = '41001'";
		...
		sql += " OR B.ICR_SEX_KD = '' THEN B.ICR_SEX_KD ELSE '[' || B.ICR_SEX_KD || ']' || GETCOMMON_LVCDTONM('0411',B.ICR_SEX_KD ,'5',1) END ICR_SEX_NM, A.EEA_EXAM_CD, A.EEA_HDMD_YN, A.EEA_SDMD_YN, A.EEA_SPCL_LT, A.EEA_SPCL_CD, A.EEA_SPHT_CD, B.ICR_SEX_KD, LENGTH(A.EEA_CHART_NO) AS EEA_CHART_NO, D.SBE_PANJ_YN, D.SBE_EXAM_CHA, D.SBE_TPAN_NM, A.EEA_PLCE_CD, B.ICR_PENL_ID, A.EEA_EMSB_CD, A.EEA_DIVI_CD";
