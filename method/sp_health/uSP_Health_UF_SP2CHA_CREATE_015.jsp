...
Insert Into ET_EXAM_ITEM
(EEI_EXAM_DT, EEI_EXAM_SQ, EEI_ORDER_DTT, EEI_ORDER_CD, EEI_ITEM_CD,
 EEI_LINK_NO, EEI_FST_KD,  EEI_ORG_PR,    EEI_FST_PR,
 EEI_INPT_ID, EEI_INPT_DTT)
Values
||:sSQL_ADD
		*/
		...
		stmtExec.executeUpdate(sql);
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_Health_UF_SP2CHA_CREATE_015 \n";
			G_INFO += "설명 : 2차접수생성-검사항목별수가저장(insert) \n";
			G_INFO += "\n\n";
