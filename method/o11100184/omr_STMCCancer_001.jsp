...
SELECT * 
FROM ET_CANCER_STMC 
WHERE ECS_EXAM_SQ = :EXAM_SQ
AND ECS_EXAM_DT = :EXAM_DT
		*/

		sql = " SELECT *";
		sql += " FROM ET_CANCER_STMC";
		sql += " WHERE ECS_EXAM_SQ = '" + EXAM_SQ + "'";
		sql += " AND ECS_EXAM_DT = '" + EXAM_DT + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : omr_STMCCancer_001 \n";
			G_INFO += "설명 : OMR 위암 기록지 조회 \n";
			G_INFO += "\n\n";
