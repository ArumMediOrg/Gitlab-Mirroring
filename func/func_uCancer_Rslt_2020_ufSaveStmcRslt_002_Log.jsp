...
<%!
	public String func_uCancer_Rslt_2020_ufSaveStmcRslt_002_Log(Statement argStmtExec, HashMap argHtMethod) throws Exception {
		...
		try {
			...
			sql = " Insert Into ET_CANCER_STMC_LOG ";
