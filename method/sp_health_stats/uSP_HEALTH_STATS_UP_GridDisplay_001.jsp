...
SELECT EEA_EXAM_DT, EEA_CUST_NO, EEA_CHART_NO, EEA_EXAM_SQ, EEA_PSNL_NM,             
       EEA_SPCL_LT, EEA_HTSB_CD, EEA_SPCL_CD,  EEA_SEX_CD,  EEA_PSNL_AGE,            
       TO_DATE(EEA_ENTRY_DT, 'YYYY-MM-DD') EEA_ENTRY_DT      
  FROM ET_EXAM_ACPT A      
       INNER JOIN ST_BASE B 
               ON A.EEA_EXAM_DT = B.SBE_EXAM_DT
              AND A.EEA_EXAM_SQ = B.SBE_EXAM_SQ 
              AND B.SBE_PANJ_YN = 'Y'

:PARAM_TX
		*/

		sql = " SELECT EEA_EXAM_DT, EEA_CUST_NO, EEA_CHART_NO, EEA_EXAM_SQ, EEA_PSNL_NM, EEA_SPCL_LT, EEA_HTSB_CD, EEA_SPCL_CD, EEA_SEX_CD, EEA_PSNL_AGE, TO_DATE(EEA_ENTRY_DT, 'YYYY-MM-DD') EEA_ENTRY_DT";
		...
		sql += PARAM_TX;
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_HEALTH_STATS_UP_GridDisplay_001 \n";
			G_INFO += "설명 : 물질별 건강진단현황 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='EEA_ENTRY_DT' rs:number='11' rs:nullable='true'>
...
<%
		...
		while(cRsList.next()) {
			...
			String EEA_ENTRY_DT_T = cRsList.getDate2("EEA_ENTRY_DT");
