...
SELECT A.CSM_LARGE, A.CSM_MATT_CD, A.CSM_MATT_NM, B.CSC_ETC1_NM, B.CSC_ETC1_CD, B.CSC_ETC2_NM, B.CSC_ETC2_CD
   ...
   AND B.CSC_LARGE   = 'HM99A'
		*/
		...
		sql += " AND B.CSC_LARGE = 'HM99A'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_HEALTH_ITEM_RECHK_UP_GirdDisplay_001 \n";
			G_INFO += "설명 : 해당물질 표적장기 묶음 조회 \n";
			G_INFO += "\n\n";
