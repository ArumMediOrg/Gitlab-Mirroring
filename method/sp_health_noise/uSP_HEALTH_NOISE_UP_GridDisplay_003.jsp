...
Select Count(DISTINCT B.EEA_CUST_NO) Count From ST_PANJUNG A
 ...
 ||:sSQL_ADD
		*/
		...
		sql = " SELECT COUNT(DISTINCT B.EEA_CUST_NO) COUNT";
		...
		sql += SSQL_ADD;
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_HEALTH_NOISE_UP_GridDisplay_003 \n";
			G_INFO += "설명 : 소음특수건강진단 실시자 수(사업장별) \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='COUNT' rs:number='1' rs:nullable='true'>
...
<%
		...
		while(cRsList.next()) {
			...
			String COUNT_T = cRsList.getString("COUNT");
%>
			<z:row
<%
			if(! COUNT_T.equals("")) {
