...
SELECT dbo.GetSP_COMMON_cdToNm('HM99A',:sValue) SF_NAME from dual
		*/

		sql = " SELECT GETSP_COMMON_CDTONM('HM99A','" + SVALUE + "') SF_NAME";
		sql += " FROM DUAL";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : UFM_Common_GP_GetCodeToName_001___8 \n";
			G_INFO += "설명 : 이름값을 적절한 코드값으로 변환___8 \n";
			G_INFO += "\n\n";
