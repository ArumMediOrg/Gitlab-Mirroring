...
SELECT RRL_EXAM_DT, RRL_HOLI_CD, RRL_HOLI_NM FROM RT_RSVT_EQUIP_LIMIT  
where RRL_EXAM_DT >= :EXAM_DT1
  and RRL_EXAM_DT <= :EXAM_DT2
  and RRL_EQUI_CD = '00'
  and RRL_HOLI_CD = '3'
GROUP BY RRL_EXAM_DT, RRL_HOLI_CD, RRL_HOLI_NM 
		...
		*/
		...
		sql = " SELECT RRL_EXAM_DT, RRL_HOLI_CD, RRL_HOLI_NM";
		sql += " FROM RT_RSVT_EQUIP_LIMIT";
		sql += " WHERE RRL_EXAM_DT >= '" + EXAM_DT1 + "'";
		sql += " AND RRL_EXAM_DT <= '" + EXAM_DT2 + "'";
		...
		sql += " GROUP BY RRL_EXAM_DT, RRL_HOLI_CD, RRL_HOLI_NM";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uBT_ESTIMATE_UP_SetCalendar_001 \n";
			G_INFO += "설명 : 장비 예약정보 \n";
			G_INFO += "\n\n";
