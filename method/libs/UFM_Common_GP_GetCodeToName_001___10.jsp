...
SELECT dbo.GetITEM_cdToNm(:sValue','S') SF_NAME from dual
		*/

		sql = " SELECT GETITEM_CDTONM('" + SVALUE + "','S') SF_NAME";
		sql += " FROM DUAL";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : UFM_Common_GP_GetCodeToName_001___10 \n";
			G_INFO += "설명 : 이름값을 적절한 코드값으로 변환___10 \n";
			G_INFO += "\n\n";
