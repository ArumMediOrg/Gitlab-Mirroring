...
if :edtSearch <> '' then
  WHERE ECP_PROF_TL LIKE '%' || :edtSearch || '%'

ORDER BY ECP_MNGT_YR DESC 
		*/

		sql = " SELECT *";
		sql += " FROM ET_COMP_CNRT_PROF";
		if(!EDTSEARCH.equals("")) {
			sql += " WHERE ECP_PROF_TL LIKE '%" + EDTSEARCH + "%'";

		} 
		sql += " ORDER BY ECP_MNGT_YR DESC";
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uMake_Excel_Apply_upGetCompPack_001 \n";
			G_INFO += "설명 : 사업장 항목정보 로딩 \n";
			G_INFO += "\n\n";
