...
Select * From ST_PANJUNG
 Where SUBSTR(SPG_BUSI_CD,1,1) in ('1', '2', '3', '4')
   And SPG_EXAM_DT = :EXAM_DT
   and SPG_EXAM_SQ = :EXAM_SQ
		*/

		sql = " SELECT *";
		sql += " FROM ST_PANJUNG";
		sql += " WHERE SUBSTR(SPG_BUSI_CD,1,1) IN ('1', '2', '3', '4')";
		sql += " AND SPG_EXAM_DT = '" + EXAM_DT + "'";
		sql += " AND SPG_EXAM_SQ = '" + EXAM_SQ + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_Health_BtnSave_BaseClick_001 \n";
			G_INFO += "설명 : 특검판정조회(업무적합성조건) \n";
			G_INFO += "\n\n";
