...
<%
		...
		sql = func_uRT_RSVT_EQUIP_LIMIT_ALL_APPLY_UP_TimeInsert_003(stmtExec, htMethod);

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uRT_RSVT_EQUIP_LIMIT_ALL_APPLY_UP_TimeInsert_003 \n";
			G_INFO += "설명 : 장비예약 스케쥴 일괄 저장 \n";
			G_INFO += "\n\n";
