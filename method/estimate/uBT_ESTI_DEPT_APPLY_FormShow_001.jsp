...
SELECT BEE_MNGT_YR, BEE_ESTI_CD, BEE_COMP_CD, BEE_ESTI_NM, BEE_CALC_CD, BEE_ITKD_CD, BEE_TBAS_CD FROM BT_ESTIMATE 
 WHERE BEE_MNGT_YR = :MNGT_YR AND BEE_ESTI_CD = :ESTI_CD 
		*/

		sql = " SELECT BEE_MNGT_YR, BEE_ESTI_CD, BEE_COMP_CD, BEE_ESTI_NM, BEE_CALC_CD, BEE_ITKD_CD, BEE_TBAS_CD";
		...
		sql += " AND BEE_ESTI_CD = '" + ESTI_CD + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uBT_ESTI_DEPT_APPLY_FormShow_001 \n";
			G_INFO += "설명 : 유형정보 로딩 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='ROWID' rs:number='8' rs:rowid='true' rs:basetable='BT_ESTIMATE' rs:basecolumn='ROWID'
