...
SELECT ERI_EXAM_DT, ERI_EXAM_SQ, ERI_ITEM_CD, ERI_RSLT_VL, IIM_KNME_NM
FROM ET_RSLT_ITEM A
     INNER JOIN IT_ITEM B ON
     A.ERI_ITEM_CD = B.IIM_ITEM_CD
...
:sSQL_ADD
		...
		*/
		...
		sql = " SELECT ERI_EXAM_DT, ERI_EXAM_SQ, ERI_ITEM_CD, ERI_RSLT_VL, IIM_KNME_NM";
		...
		sql += SSQL_ADD;
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uTotal_Finding_ufCompareValueToRef_001 \n";
			G_INFO += "설명 : 자동소견대상 검사항목조회 \n";
			G_INFO += "\n\n";
