...
SELECT GetSP_COMMON_cdToNm('HM99G','1') VIP_ITKD_NM, A.* FROM VIEW_IT_ITEM_PRICE A ORDER BY VIP_APLY_DT DESC
		*/
		...
		sql += " ORDER BY VIP_APLY_DT DESC";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uBT_ESTI_DEPT_APPLY_UP_ReSet_001 \n";
			G_INFO += "설명 : 항목 금액정보 로딩 \n";
			G_INFO += "\n\n";
