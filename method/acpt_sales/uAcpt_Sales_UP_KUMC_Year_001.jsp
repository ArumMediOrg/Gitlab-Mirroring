...
<%
		...
		sql =  " SELECT EXAM_YM, SUM(EXAM_MCNT) EXAM_MCNT, SUM(EXAM_WCNT) EXAM_WCNT, SUM(EXAM_MCNT+EXAM_WCNT) EXAM_CNT ";
		sql += " FROM (SELECT SUBSTR(EEA_EXAM_DT, 1, 7) EXAM_YM, ";
		sql += " CASE EEA_SEX_CD WHEN '1' THEN 1 ELSE 0 END EXAM_MCNT, ";
		sql += " CASE EEA_SEX_CD WHEN '2' THEN 1 ELSE 0 END EXAM_WCNT  ";
		...
		sql += " ORDER BY EXAM_YM ";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uAcpt_Sales_UP_KUMC_Year_001 \n";
			G_INFO += "설명 : 진단인원 통계(남, 여) \n";
			G_INFO += "\n\n";
