...
<%
		...
		vcAddItemList = (Vector<Object>)request.getAttribute("ADDITEMLIST");
		...
		if(cRsList.next()){
			...
			//
			String STREXAMLT = "";
			STREXAMLT += "'P001' || '" + RSVDATE.substring(0,4) + "' || '" + PACKCODE + "$" + PACKCOST + "|'";
			...
			//
			sql = " INSERT INTO RT_RSVT_WEBPAGE ( RRT_RSVN_NO, RRT_CUST_NO, RRT_EXAM_DT, RRT_EXAM_TM, RRT_PSNL_NM, RRT_SEX_CD, RRT_PSNL_AGE, ";
			sql += " RRT_TEL_NO, RRT_MOBL_NO, RRT_ZIP_CD, RRT_ZIP_AR, RRT_ROAD_AR, RRT_COMP_PR, RRT_PSNL_PR, RRT_RSVN_TX, RRT_WEB_ID, RRT_EXAM_LT, ";
			sql += " RRT_ACPT_CD, RRT_EXAM_CD, RRT_INPT_ID, RRT_INPT_DTT ) VALUES (";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : SetEachReserve \n";
			G_INFO += "설명 : 09. 개인 건강검진 예약 입력 \n";
			G_INFO += "\n\n";
...
<KUMC>
    <Header>
        <ServiceID>SetEachReserve</ServiceID>
        <Result>
