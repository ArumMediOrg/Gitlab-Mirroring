...
<%!
	public String func_uRsvn_Acpt_UF_EquipUpdate_001(Statement argStmtExec, HashMap argHtMethod) throws Exception {
		...
		try {
			...
			sql += ", RRL_CUST_LT = REPLACE(RRL_CUST_LT, '" + CUST_LT + "', '')";
			sql += " WHERE RRL_EXAM_DT = '" + EXAM_DT + "'";
			sql += " AND RRL_EQUI_CD = '" + EQUI_CD + "'";
			sql += " AND RRL_CUST_LT LIKE '%'|| '" + CUST_LT + "' ||'%'";
