 ...
 ORDER BY A.SSV_PACK_CD
		*/
		...
		sql += " ORDER BY A.SSV_PACK_CD";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uInsuranceReport_UP_SetReportform_007 \n";
			G_INFO += "설명 : 종합소견 조회 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='SSV_EXAM_DT' rs:number='1' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW' rs:basecolumn='SSV_EXAM_DT'>
			<s:datatype dt:type='string' dt:maxLength='10' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='SSV_EXAM_SQ' rs:number='2' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW' rs:basecolumn='SSV_EXAM_SQ'>
			<s:datatype dt:type='string' dt:maxLength='6' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='SSV_PACK_CD' rs:number='3' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW' rs:basecolumn='SSV_PACK_CD'>
			<s:datatype dt:type='string' dt:maxLength='2' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='SSV_CFRM_CD' rs:number='4' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
			 rs:basecolumn='SSV_CFRM_CD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SSV_CLIC_CD' rs:number='5' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
			 rs:basecolumn='SSV_CLIC_CD'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='SSV_CLIC_SQ' rs:number='6' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
			 rs:basecolumn='SSV_CLIC_SQ'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='SSV_EQUI_CD' rs:number='7' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
			 rs:basecolumn='SSV_EQUI_CD'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='SSV_VIEW_EX' rs:number='8' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
			 rs:basecolumn='SSV_VIEW_EX'>
			<s:datatype dt:type='string' dt:maxLength='1073741823' rs:long='true'/>
		</s:AttributeType>
		<s:AttributeType name='SSV_FINDING' rs:number='9' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
			 rs:basecolumn='SSV_FINDING'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='SSV_COMMT' rs:number='10' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
			 rs:basecolumn='SSV_COMMT'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='SSV_CLIC_FT' rs:number='11' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
			 rs:basecolumn='SSV_CLIC_FT'>
			<s:datatype dt:type='string' dt:maxLength='50'/>
		</s:AttributeType>
		<s:AttributeType name='SSV_EQUI_FT' rs:number='12' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
			 rs:basecolumn='SSV_EQUI_FT'>
			<s:datatype dt:type='string' dt:maxLength='50'/>
		</s:AttributeType>
		<s:AttributeType name='SSV_VIEW_FT' rs:number='13' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
			 rs:basecolumn='SSV_VIEW_FT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='SSV_MON_FT' rs:number='14' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
			 rs:basecolumn='SSV_MON_FT'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='SSV_VIEWFIN_DT' rs:number='15' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
			 rs:basecolumn='SSV_VIEWFIN_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='SSV_DOCTOR' rs:number='16' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
			 rs:basecolumn='SSV_DOCTOR'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='SSV_EMAIL_DT' rs:number='17' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
			 rs:basecolumn='SSV_EMAIL_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='SSV_SMS_DT' rs:number='18' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
			 rs:basecolumn='SSV_SMS_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='SSV_MON_VIEW' rs:number='19' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
			 rs:basecolumn='SSV_MON_VIEW'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='SSV_INPT_ID' rs:number='20' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
			 rs:basecolumn='SSV_INPT_ID'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='SSV_INPT_DTT' rs:number='21' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
			 rs:basecolumn='SSV_INPT_DTT'>
			<s:datatype dt:type='dateTime' rs:dbtype='timestamp' dt:maxLength='16' rs:scale='0' rs:precision='19' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='SSV_MODI_ID' rs:number='22' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
			 rs:basecolumn='SSV_MODI_ID'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='SSV_MODI_DTT' rs:number='23' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
			 rs:basecolumn='SSV_MODI_DTT'>
			<s:datatype dt:type='dateTime' rs:dbtype='timestamp' dt:maxLength='16' rs:scale='0' rs:precision='19' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='SSV_RPT_DT' rs:number='24' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
			 rs:basecolumn='SSV_RPT_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='SSV_PRNT_DT' rs:number='25' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
			 rs:basecolumn='SSV_PRNT_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='SSV_VIEW_RTF' rs:number='26' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
			 rs:basecolumn='SSV_VIEW_RTF'>
			<s:datatype dt:type='string' dt:maxLength='1073741823' rs:long='true'/>
		</s:AttributeType>
		<s:AttributeType name='ROWID' rs:number='27' rs:rowid='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
