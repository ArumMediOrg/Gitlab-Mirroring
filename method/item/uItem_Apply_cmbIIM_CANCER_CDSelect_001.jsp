...
SELECT CCN_FULL_NM, CCN_SMALL
  FROM CT_COMMON
 WHERE CCN_LARGE = ''0516''
   AND SUBSTRING(CCN_SMALL,1,1) = :CCN_SMALL
   AND CCN_LEVEL = ''5''
		*/

		sql = " SELECT CCN_FULL_NM, CCN_SMALL";
		sql += " FROM CT_COMMON";
		sql += " WHERE CCN_LARGE = '0516'";
		sql += " AND SUBSTR(CCN_SMALL,1,1) = '" + CCN_SMALL + "'";
		sql += " AND CCN_LEVEL = '5'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uItem_Apply_cmbIIM_CANCER_CDSelect_001 \n";
			G_INFO += "설명 : 공통코드조회(특정조건) \n";
			G_INFO += "\n\n";
