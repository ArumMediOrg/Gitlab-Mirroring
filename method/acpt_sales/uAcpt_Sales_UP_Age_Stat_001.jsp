...
SELECT AGE_TERM TERM_CD, AGE_TERM TERM_KD,
  ...
  FROM (SELECT 1 TOT_CNT, EEA_PSNL_AGE, 
               CASE WHEN EEA_PSNL_AGE < 20 THEN '00 - 19' 
                    WHEN EEA_PSNL_AGE < 30 THEN '20 - 29'
                    WHEN EEA_PSNL_AGE < 40 THEN '30 - 39'
                    WHEN EEA_PSNL_AGE < 50 THEN '40 - 49'
                    WHEN EEA_PSNL_AGE < 60 THEN '50 - 59'
                    WHEN EEA_PSNL_AGE < 70 THEN '60 - 69'
                    WHEN EEA_PSNL_AGE < 80 THEN '70 - 79'
                    ELSE '80 이상' END AGE_TERM,
...
IF (:RECE_NO = 'R') THEN
        ...
        UNION ALL
        SELECT 0 TOT_CNT, 0 EEA_PSNL_AGE, 
               '00 - 19' AGE_TERM,
               0 EXAM_MCNT, 0 EXAM_WCNT, 0 PSNL_MPR, 0 PSNL_WPR, 0 COMP_MPR,
               0 COMP_WPR,  0 HLTH_MPR,  0 HLTH_WPR, 0 SPCL_MPR, 0 SPCL_WPR,
               0 EXAM_MPR,  0 EXAM_WPR,  0 TOT_PR, 
               0 DISC_MCNT, 0 DISC_WCNT, 0 DISC_MPR, 0 DISC_WPR, 0 DISC_CNT, 0 DISC_PR
          FROM DUAL
        UNION ALL
        SELECT 0 TOT_CNT, 0 EEA_PSNL_AGE, 
               '20 - 29' AGE_TERM,
 ...
 ORDER BY AGE_TERM
		...
		*/
		...
		sql = " SELECT AGE_TERM TERM_CD, AGE_TERM TERM_KD, SUM(TOT_CNT) EXAM_CNT, SUM(TOT_PR) EXAM_PR, SUM(EXAM_MCNT) EXAM_MCNT, SUM(PSNL_MPR) PSNL_MPR, SUM(COMP_MPR) COMP_MPR, SUM(HLTH_MPR) HLTH_MPR, SUM(SPCL_MPR) SPCL_MPR, SUM(EXAM_MPR) EXAM_MPR, SUM(EXAM_WCNT) EXAM_WCNT, SUM(PSNL_WPR) PSNL_WPR, SUM(COMP_WPR) COMP_WPR, SUM(HLTH_WPR) HLTH_WPR, SUM(SPCL_WPR) SPCL_WPR, SUM(EXAM_WPR) EXAM_WPR, SUM(DISC_CNT) DISC_CNT, SUM(DISC_PR) DISC_PR, SUM(DISC_MCNT) DISC_MCNT, SUM(DISC_MPR) DISC_MPR, SUM(DISC_WCNT) DISC_WCNT, SUM(DISC_WPR) DISC_WPR";
		sql += " FROM (SELECT 1 TOT_CNT, EEA_PSNL_AGE, CASE WHEN EEA_PSNL_AGE < 20 THEN '00 - 19' WHEN EEA_PSNL_AGE < 30 THEN '20 - 29' WHEN EEA_PSNL_AGE < 40 THEN '30 - 39' WHEN EEA_PSNL_AGE < 50 THEN '40 - 49' WHEN EEA_PSNL_AGE < 60 THEN '50 - 59' WHEN EEA_PSNL_AGE < 70 THEN '60 - 69' WHEN EEA_PSNL_AGE < 80 THEN '70 - 79' ELSE '80 이상' END AGE_TERM, CASE EEA_SEX_CD WHEN '1' THEN 1 ELSE 0 END EXAM_MCNT, CASE EEA_SEX_CD WHEN '2' THEN 1 ELSE 0 END EXAM_WCNT, CASE EEA_SEX_CD WHEN '1' THEN EEA_PSNLR_PR ELSE 0 END PSNL_MPR, CASE EEA_SEX_CD WHEN '2' THEN EEA_PSNLR_PR ELSE 0 END PSNL_WPR, CASE EEA_SEX_CD WHEN '1' THEN EEA_COMPR_PR ELSE 0 END COMP_MPR, CASE EEA_SEX_CD WHEN '2' THEN EEA_COMPR_PR ELSE 0 END COMP_WPR, CASE EEA_SEX_CD WHEN '1' THEN EEA_HLTHR_PR ELSE 0 END HLTH_MPR, CASE EEA_SEX_CD WHEN '2' THEN EEA_HLTHR_PR ELSE 0 END HLTH_WPR, CASE EEA_SEX_CD WHEN '1' THEN EEA_SPCLR_PR ELSE 0 END SPCL_MPR, CASE EEA_SEX_CD WHEN '2' THEN EEA_SPCLR_PR ELSE 0 END SPCL_WPR, CASE EEA_SEX_CD WHEN '1' THEN EEA_PSNLR_PR+EEA_COMPR_PR+EEA_HLTHR_PR+EEA_SPCLR_PR ELSE 0 END EXAM_MPR, CASE EEA_SEX_CD WHEN '2' THEN EEA_PSNLR_PR+EEA_COMPR_PR+EEA_HLTHR_PR+EEA_SPCLR_PR ELSE 0 END EXAM_WPR, EEA_PSNLR_PR+EEA_COMPR_PR+EEA_HLTHR_PR+EEA_SPCLR_PR TOT_PR, CASE WHEN EEA_SEX_CD = '1'";
		...
		sql += " UNION";
		sql += " ALL SELECT 0 TOT_CNT, 0 EEA_PSNL_AGE, '00 - 19' AGE_TERM, 0 EXAM_MCNT, 0 EXAM_WCNT, 0 PSNL_MPR, 0 PSNL_WPR, 0 COMP_MPR, 0 COMP_WPR, 0 HLTH_MPR, 0 HLTH_WPR, 0 SPCL_MPR, 0 SPCL_WPR, 0 EXAM_MPR, 0 EXAM_WPR, 0 TOT_PR, 0 DISC_MCNT, 0 DISC_WCNT, 0 DISC_MPR, 0 DISC_WPR, 0 DISC_CNT, 0 DISC_PR";
		sql += " FROM DUAL";
		sql += " UNION";
		sql += " ALL SELECT 0 TOT_CNT, 0 EEA_PSNL_AGE, '20 - 29' AGE_TERM, 0 EXAM_MCNT, 0 EXAM_WCNT, 0 PSNL_MPR, 0 PSNL_WPR, 0 COMP_MPR, 0 COMP_WPR, 0 HLTH_MPR, 0 HLTH_WPR, 0 SPCL_MPR, 0 SPCL_WPR, 0 EXAM_MPR, 0 EXAM_WPR, 0 TOT_PR, 0 DISC_MCNT, 0 DISC_WCNT, 0 DISC_MPR, 0 DISC_WPR, 0 DISC_CNT, 0 DISC_PR";
		sql += " FROM DUAL";
		sql += " UNION";
		sql += " ALL SELECT 0 TOT_CNT, 0 EEA_PSNL_AGE, '30 - 39' AGE_TERM, 0 EXAM_MCNT, 0 EXAM_WCNT, 0 PSNL_MPR, 0 PSNL_WPR, 0 COMP_MPR, 0 COMP_WPR, 0 HLTH_MPR, 0 HLTH_WPR, 0 SPCL_MPR, 0 SPCL_WPR, 0 EXAM_MPR, 0 EXAM_WPR, 0 TOT_PR, 0 DISC_MCNT, 0 DISC_WCNT, 0 DISC_MPR, 0 DISC_WPR, 0 DISC_CNT, 0 DISC_PR";
		sql += " FROM DUAL";
		sql += " UNION";
		sql += " ALL SELECT 0 TOT_CNT, 0 EEA_PSNL_AGE, '40 - 49' AGE_TERM, 0 EXAM_MCNT, 0 EXAM_WCNT, 0 PSNL_MPR, 0 PSNL_WPR, 0 COMP_MPR, 0 COMP_WPR, 0 HLTH_MPR, 0 HLTH_WPR, 0 SPCL_MPR, 0 SPCL_WPR, 0 EXAM_MPR, 0 EXAM_WPR, 0 TOT_PR, 0 DISC_MCNT, 0 DISC_WCNT, 0 DISC_MPR, 0 DISC_WPR, 0 DISC_CNT, 0 DISC_PR";
		sql += " FROM DUAL";
		sql += " UNION";
		sql += " ALL SELECT 0 TOT_CNT, 0 EEA_PSNL_AGE, '50 - 59' AGE_TERM, 0 EXAM_MCNT, 0 EXAM_WCNT, 0 PSNL_MPR, 0 PSNL_WPR, 0 COMP_MPR, 0 COMP_WPR, 0 HLTH_MPR, 0 HLTH_WPR, 0 SPCL_MPR, 0 SPCL_WPR, 0 EXAM_MPR, 0 EXAM_WPR, 0 TOT_PR, 0 DISC_MCNT, 0 DISC_WCNT, 0 DISC_MPR, 0 DISC_WPR, 0 DISC_CNT, 0 DISC_PR";
		sql += " FROM DUAL";
		sql += " UNION";
		sql += " ALL SELECT 0 TOT_CNT, 0 EEA_PSNL_AGE, '60 - 69' AGE_TERM, 0 EXAM_MCNT, 0 EXAM_WCNT, 0 PSNL_MPR, 0 PSNL_WPR, 0 COMP_MPR, 0 COMP_WPR, 0 HLTH_MPR, 0 HLTH_WPR, 0 SPCL_MPR, 0 SPCL_WPR, 0 EXAM_MPR, 0 EXAM_WPR, 0 TOT_PR, 0 DISC_MCNT, 0 DISC_WCNT, 0 DISC_MPR, 0 DISC_WPR, 0 DISC_CNT, 0 DISC_PR";
		sql += " FROM DUAL";
		sql += " UNION";
		sql += " ALL SELECT 0 TOT_CNT, 0 EEA_PSNL_AGE, '70 - 79' AGE_TERM, 0 EXAM_MCNT, 0 EXAM_WCNT, 0 PSNL_MPR, 0 PSNL_WPR, 0 COMP_MPR, 0 COMP_WPR, 0 HLTH_MPR, 0 HLTH_WPR, 0 SPCL_MPR, 0 SPCL_WPR, 0 EXAM_MPR, 0 EXAM_WPR, 0 TOT_PR, 0 DISC_MCNT, 0 DISC_WCNT, 0 DISC_MPR, 0 DISC_WPR, 0 DISC_CNT, 0 DISC_PR";
		sql += " FROM DUAL";
		sql += " UNION";
		sql += " ALL SELECT 0 TOT_CNT, 0 EEA_PSNL_AGE, '80 이상' AGE_TERM, 0 EXAM_MCNT, 0 EXAM_WCNT, 0 PSNL_MPR, 0 PSNL_WPR, 0 COMP_MPR, 0 COMP_WPR, 0 HLTH_MPR, 0 HLTH_WPR, 0 SPCL_MPR, 0 SPCL_WPR, 0 EXAM_MPR, 0 EXAM_WPR, 0 TOT_PR, 0 DISC_MCNT, 0 DISC_WCNT, 0 DISC_MPR, 0 DISC_WPR, 0 DISC_CNT, 0 DISC_PR";
		sql += " FROM DUAL ) B";
		sql += " GROUP BY AGE_TERM";
		sql += " ORDER BY AGE_TERM";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uAcpt_Sales_UP_Age_Stat_001 \n";
			G_INFO += "설명 : 나이대별 현황 \n";
			G_INFO += "\n\n";
