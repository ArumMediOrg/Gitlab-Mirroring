...
Select A.SSV_VIEW_EX, A.SSV_DOCTOR, B.IAU_PENL_NM, A.SSV_RPT_DT
  From ST_SYTH_VIEW A                                          
 ...
 Where A.SSV_EXAM_DT = :EXAM_DT
   ...
   And A.SSV_VIEW_EX Is Not Null                               
		...
		*/
		...
		sql = " SELECT A.SSV_VIEW_EX, A.SSV_DOCTOR, B.IAU_PENL_NM, A.SSV_RPT_DT";
		...
		sql += " AND A.SSV_VIEW_EX IS NOT NULL";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uPostManagement_NEWCustList_APPLY_UP_PanjungDispaly_001 \n";
			G_INFO += "설명 : 종검정보 로딩 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='ROWID' rs:number='5' rs:rowid='true' rs:basetable='ST_SYTH_VIEW' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c5' rs:name='ROWID' rs:number='6' rs:rowid='true' rs:basetable='IT_AUTH_USER' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
