...
SELECT  UUC_USER_NO,UUC_CFG_CD,UUC_CFG_NM,IAP_PRGM_NM  FROM UT_USRCFG A left outer join IT_AUTH_PRGM b on a.UUC_CFG_NM=IAP_MENU_ID 
WHERE UUC_USER_NO= :USER_NO AND UUC_CFG_CD='10002'  
		...
		*/
		...
		sql += " AND UUC_CFG_CD='10002'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : UConfig_UP_MYMENU_001 \n";
			G_INFO += "설명 : 마이메뉴 수정권한 확인 \n";
			G_INFO += "\n\n";
