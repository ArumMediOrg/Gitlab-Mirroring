...
<%
		...
		String RGIDR_USE_YN = htMethod.get("RGIDR_USE_YN");
		...
		sql = func_uVT1000Apply_M_ufSave_004(stmtExec, htMethod);

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uVT1000Apply_M_ufSave_004 \n";
			G_INFO += "설명 : 소견 결과 수정 \n";
			G_INFO += "\n\n";
			...
			G_INFO += " RGIDR_USE_YN : " + RGIDR_USE_YN + " \n";
