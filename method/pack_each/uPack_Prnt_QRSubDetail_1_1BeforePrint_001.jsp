...
SELECT IIM_ITEM_CD, IIM_OSCD_CD, IIM_KNME_NM FROM IT_ITEM
		*/

		sql = " SELECT IIM_ITEM_CD, IIM_OSCD_CD, IIM_KNME_NM";
		sql += " FROM IT_ITEM";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uPack_Prnt_QRSubDetail_1_1BeforePrint_001 \n";
			G_INFO += "설명 : 아이템 목록 로딩 \n";
			G_INFO += "\n\n";
