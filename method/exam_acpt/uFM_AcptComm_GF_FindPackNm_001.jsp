...
SELECT F_PACK_FIND(:EXAM_CD, :COMP_CD) AS PACK_NM
  FROM DUAL

		*/

		sql = " SELECT F_PACK_FIND('" + EXAM_CD + "', '" + COMP_CD + "') AS PACK_NM";
		sql += " FROM DUAL";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uFM_AcptComm_GF_FindPackNm_001 \n";
			G_INFO += "설명 : 개별/사업장묶음명 조회 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='PACK_NM' rs:number='1' rs:nullable='true'>
