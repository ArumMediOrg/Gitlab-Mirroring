...
<%!
	public String func_uExam_Result_upGetRcpt_002(Statement argStmtExec, HashMap argHtMethod) throws Exception {
		...
		try {
			...
			sql += " AND (SUBSTR(EEA_EXAM_CD, 1, 1) IN ('2', '3', '9') OR SUBSTR(EEA_ETSB_CD, 1, 1) = '9' )";
			sql += " AND NOT EXISTS ( SELECT SSV_EXAM_DT, SSV_EXAM_SQ";
			sql += " FROM ST_SYTH_VIEW";
			sql += " WHERE SSV_EXAM_DT = EEA_EXAM_DT";
