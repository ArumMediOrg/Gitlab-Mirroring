...
<%
		...
		sql = func_uCancer_Rslt_2020_ufSaveLiverRslt_002_Log(stmtExec, htMethod);

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCancer_Rslt_2020_ufSaveLiverRslt_002_Log \n";
			G_INFO += "설명 : 간암 결과판정 저장로그(insert) \n";
			G_INFO += "\n\n";
