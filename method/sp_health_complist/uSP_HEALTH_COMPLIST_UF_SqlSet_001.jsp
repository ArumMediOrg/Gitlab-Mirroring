...
SELECT A.EEA_EXAM_DT, A.EEA_COMP_CD, B.ICY_COMP_NM, B.ICY_ZIP_AR || B.ICY_ROAD_AR AS ICR_ADRESS, B.ICY_TEL_NO
  FROM ET_EXAM_ACPT A
...
:ORDER_BY
		...
		*/
		...
		sql = " SELECT A.EEA_EXAM_DT, A.EEA_COMP_CD, B.ICY_COMP_NM, B.ICY_ZIP_AR || B.ICY_ROAD_AR AS ICR_ADRESS, B.ICY_TEL_NO";
		...
		sql += ORDER_BY;
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_HEALTH_COMPLIST_UF_SqlSet_001 \n";
			G_INFO += "설명 : 01-근로자 건강진단 실시현황 대상자 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='EEA_COMP_CD' rs:number='2' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_EXAM_ACPT'
			 rs:basecolumn='EEA_COMP_CD'>
			<s:datatype dt:type='string' dt:maxLength='12'/>
		</s:AttributeType>
		<s:AttributeType name='ICY_COMP_NM' rs:number='3' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_COMPANY'
			 rs:basecolumn='ICY_COMP_NM'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='ICR_ADRESS' rs:number='4' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='400'/>
		</s:AttributeType>
		<s:AttributeType name='ICY_TEL_NO' rs:number='5' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_COMPANY'
