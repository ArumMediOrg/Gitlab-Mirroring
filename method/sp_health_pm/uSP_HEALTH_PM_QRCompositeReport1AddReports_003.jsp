...
SELECT SUBSTR(EEA_HLTH_KD, 6, 1) AS HABIT_06, SUBSTR(EEA_HLTH_KD, 7, 1) AS HABIT_07
  FROM ET_EXAM_ACPT
 WHERE EEA_EXAM_DT = :EXAM_DT
   and EEA_EXAM_SQ = :EXAM_SQ
		*/

		sql = " SELECT SUBSTR(EEA_HLTH_KD, 6, 1) AS HABIT_06, SUBSTR(EEA_HLTH_KD, 7, 1) AS HABIT_07";
		...
		sql += " AND EEA_EXAM_SQ = '" + EXAM_SQ + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_HEALTH_PM_QRCompositeReport1AddReports_003 \n";
			G_INFO += "설명 : 검사정보 로딩 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='HABIT_06' rs:number='1' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='2'/>
		</s:AttributeType>
		<s:AttributeType name='HABIT_07' rs:number='2' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='2'/>
		</s:AttributeType>
