...
SELECT CASE :PENCRT_KD WHEN '1' THEN F_PERID_FIND1(A.EEA_EXAM_DT, A.EEA_EXAM_SQ, '1')
       ...
       B.SSM_EXAM_DT, B.SSM_SYMP_SQ, B.SSM_SYSQ_CD, B.SSM_SYSQ_NM
  FROM ET_EXAM_ACPT A 
       LEFT OUTER JOIN ST_SYMPTOM B ON B.SSM_EXAM_DT = A.EEA_EXAM_DT AND B.SSM_EXAM_SQ = A.EEA_EXAM_SQ AND B.SSM_SYMP_CD = :SYMP_CD
...
:PARAM_TX2
 ...
 ORDER BY A.EEA_EXAM_DT, A.EEA_EXAM_SQ
		...
		*/
		...
		sql = " SELECT CASE '" + PENCRT_KD + "' WHEN '1' THEN F_PERID_FIND1(A.EEA_EXAM_DT, A.EEA_EXAM_SQ, '1') WHEN '2' THEN ECL_DECRYPT(F_PERID_FIND1(A.EEA_EXAM_DT, A.EEA_EXAM_SQ, '1')) ELSE F_PERID_FIND1(A.EEA_EXAM_DT, A.EEA_EXAM_SQ, '0') END ICR_PENL_ID, A.EEA_EXAM_DT, A.EEA_EXAM_SQ, A.EEA_PSNL_NM, B.SSM_EXAM_DT, B.SSM_SYMP_SQ, B.SSM_SYSQ_CD, B.SSM_SYSQ_NM";
		...
		sql += " AND B.SSM_SYMP_CD = '" + SYMP_CD + "' LEFT OUTER JOIN ST_BASE C";
		...
		sql += " ORDER BY A.EEA_EXAM_DT, A.EEA_EXAM_SQ";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uIT_SPChungGU_Chk_UDP_HSTCSERR_001 \n";
			G_INFO += "설명 : 1-과거병력 / 2-현재증상 / 4-진찰자료 조회 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='SSM_EXAM_DT' rs:number='5' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYMPTOM'
			 rs:basecolumn='SSM_EXAM_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='SSM_SYMP_SQ' rs:number='6' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYMPTOM'
			 rs:basecolumn='SSM_SYMP_SQ'>
			<s:datatype dt:type='number' rs:dbtype='varnumeric' dt:maxLength='38' rs:scale='255' rs:precision='38'/>
		</s:AttributeType>
		<s:AttributeType name='SSM_SYSQ_CD' rs:number='7' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYMPTOM'
			 rs:basecolumn='SSM_SYSQ_CD'>
			<s:datatype dt:type='string' dt:maxLength='6'/>
		</s:AttributeType>
		<s:AttributeType name='SSM_SYSQ_NM' rs:number='8' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYMPTOM'
