...
SELECT IAU_EMP_NO, IAU_PENL_NM, IAU_EMAI_AR, 
       GETCOMMON_LVCDTONM('0501', IAU_DEPT_CD, '5', 4) IAU_DEPT_NM
  FROM IT_AUTH_USER 
 WHERE IAU_EMP_NO = :EMP_NO
		*/

		sql = " SELECT IAU_EMP_NO, IAU_PENL_NM, IAU_EMAI_AR, GETCOMMON_LVCDTONM('0501', IAU_DEPT_CD, '5', 4) IAU_DEPT_NM";
		sql += " FROM IT_AUTH_USER";
		sql += " WHERE IAU_EMP_NO = '" + EMP_NO + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_RecheckList_EdtUser_CdChange_001 \n";
			G_INFO += "설명 : 담당자 정보 조회 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='IAU_EMAI_AR' rs:number='3' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
			 rs:basecolumn='IAU_EMAI_AR'>
			<s:datatype dt:type='string' dt:maxLength='50'/>
		</s:AttributeType>
		<s:AttributeType name='IAU_DEPT_NM' rs:number='4' rs:nullable='true'>
