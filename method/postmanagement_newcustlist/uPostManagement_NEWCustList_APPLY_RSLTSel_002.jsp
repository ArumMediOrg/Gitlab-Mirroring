...
Select SSV_VIEW_EX, SSV_VIEW_RTF
  From ST_SYTH_VIEW
 Where SSV_EXAM_DT = :EXAM_DT
   And SSV_EXAM_SQ = :EXAM_SQ
		...
		*/
		...
		sql = " SELECT SSV_VIEW_EX, SSV_VIEW_RTF";
		...
		sql += " AND SSV_EXAM_SQ = '" + EXAM_SQ + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uPostManagement_NEWCustList_APPLY_RSLTSel_002 \n";
			G_INFO += "설명 : 종검정보 로딩 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='SSV_VIEW_RTF' rs:number='2' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_SYTH_VIEW'
			 rs:basecolumn='SSV_VIEW_RTF'>
			<s:datatype dt:type='string' dt:maxLength='1073741823' rs:long='true'/>
		</s:AttributeType>
		<s:AttributeType name='ROWID' rs:number='3' rs:rowid='true' rs:basetable='ST_SYTH_VIEW' rs:basecolumn='ROWID'
