...
SELECT A.IIQ_APLY_DT, A.IIQ_ITEM_CD, A.IIQ_SORT_NO, IIQ_QGTN_CD, IIQ_ITQU_LV1, IIQ_ITQU_LV2, IIQ_ITQU_SQ, IIQ_USE_YN, IIQ_ITQU_MC, 
       ...
       B.CQN_QSTN_NM, B.CQN_ANSE_EX, B.CQN_QSTN_CP, B.CQN_DEFULT, CQN_EXEM_CD, CQN_QSKD_CD, CQN_QSTN_SQ, CQN_QSTN_LV 
...
ORDER BY IIQ_SORT_NO 
		*/
		...
		sql = " SELECT A.IIQ_APLY_DT, A.IIQ_ITEM_CD, A.IIQ_SORT_NO, IIQ_QGTN_CD, IIQ_ITQU_LV1, IIQ_ITQU_LV2, IIQ_ITQU_SQ, IIQ_USE_YN, IIQ_ITQU_MC, CASE WHEN B.CQN_ANSR_CD IS NULL";
		sql += " OR B.CQN_ANSR_CD = '' THEN B.CQN_ANSR_CD ELSE '[' || B.CQN_ANSR_CD || ']' || GETCOMMON_LVCDTONM('0415',B.CQN_ANSR_CD,'5',1) END IIQ_ANSR_NM, B.CQN_QSTN_NM, B.CQN_ANSE_EX, B.CQN_QSTN_CP, B.CQN_DEFULT, CQN_EXEM_CD, CQN_QSKD_CD, CQN_QSTN_SQ, CQN_QSTN_LV";
		...
		sql += " ORDER BY IIQ_SORT_NO";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uIT_ITEM_QUESTION_APPLY_FormShow_001 \n";
			G_INFO += "설명 : 문진정보 로딩 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='IIQ_ITQU_MC' rs:number='9' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_ITEM_QUESTION'
			 rs:basecolumn='IIQ_ITQU_MC'>
			<s:datatype dt:type='string' dt:maxLength='50'/>
		</s:AttributeType>
		<s:AttributeType name='IIQ_ANSR_NM' rs:number='10' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='CQN_QSTN_NM' rs:number='11'>
			<s:datatype dt:type='string' dt:maxLength='500' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='CQN_ANSE_EX' rs:number='12' rs:nullable='true' rs:writeunknown='true' rs:basetable='CT_QUESTION'
			 rs:basecolumn='CQN_ANSE_EX'>
			<s:datatype dt:type='string' dt:maxLength='500'/>
		</s:AttributeType>
		<s:AttributeType name='CQN_QSTN_CP' rs:number='13' rs:writeunknown='true' rs:basetable='CT_QUESTION' rs:basecolumn='CQN_QSTN_CP'>
			<s:datatype dt:type='number' rs:dbtype='numeric' dt:maxLength='19' rs:scale='0' rs:precision='10' rs:fixedlength='true'
			 rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='CQN_DEFULT' rs:number='14' rs:nullable='true' rs:writeunknown='true' rs:basetable='CT_QUESTION'
			 rs:basecolumn='CQN_DEFULT'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='CQN_EXEM_CD' rs:number='15' rs:writeunknown='true' rs:basetable='CT_QUESTION' rs:basecolumn='CQN_EXEM_CD'>
			<s:datatype dt:type='string' dt:maxLength='2' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='CQN_QSKD_CD' rs:number='16' rs:writeunknown='true' rs:basetable='CT_QUESTION' rs:basecolumn='CQN_QSKD_CD'>
			<s:datatype dt:type='string' dt:maxLength='4' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='CQN_QSTN_SQ' rs:number='17' rs:writeunknown='true' rs:basetable='CT_QUESTION' rs:basecolumn='CQN_QSTN_SQ'>
			<s:datatype dt:type='number' rs:dbtype='numeric' dt:maxLength='19' rs:scale='0' rs:precision='10' rs:fixedlength='true'
			 rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='CQN_QSTN_LV' rs:number='18' rs:writeunknown='true' rs:basetable='CT_QUESTION' rs:basecolumn='CQN_QSTN_LV'>
			<s:datatype dt:type='string' dt:maxLength='4' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='ROWID' rs:number='19' rs:rowid='true' rs:basetable='IT_ITEM_QUESTION' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c19' rs:name='ROWID' rs:number='20' rs:rowid='true' rs:basetable='CT_QUESTION' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
