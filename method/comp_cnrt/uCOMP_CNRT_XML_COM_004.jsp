...
SELECT ECP_PROF_SQ, ECP_PROF_TL, ECP_PROF_NM  FROM ET_COMP_CNRT_PROF
WHERE ECP_COMP_CD = :COMP_CD
  AND ECP_MNGT_YR = :MNGT_YR
  AND ECP_CNRT_SQ = :CNRT_SQ
		*/

		sql = " SELECT ECP_PROF_SQ, ECP_PROF_TL, ECP_PROF_NM";
		...
		sql += " AND ECP_CNRT_SQ = '" + CNRT_SQ + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCOMP_CNRT_XML_COM_004 \n";
			G_INFO += "설명 : 사업장 계약 검진유형 리스트 조회(검진유형명) \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='ECP_PROF_TL' rs:number='2' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_COMP_CNRT_PROF'
			 rs:basecolumn='ECP_PROF_TL'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='ECP_PROF_NM' rs:number='3' rs:writeunknown='true' rs:basetable='ET_COMP_CNRT_PROF' rs:basecolumn='ECP_PROF_NM'>
