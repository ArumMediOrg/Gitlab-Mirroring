...
Select ERI_RSLT_EX, ERI_PACS_RSLT From ET_RSLT_ITEM
 Where ERI_EXAM_DT = :EXAM_DT
   And ERI_EXAM_SQ = :EXAM_SQ
   And ERI_ITEM_CD = :ITEM_CD
		*/

		sql = " SELECT ERI_RSLT_EX, ERI_PACS_RSLT";
		...
		sql += " AND ERI_ITEM_CD = '" + ITEM_CD + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_Health_GirdSPITEMClickCell_002 \n";
			G_INFO += "설명 : 검사항목 검사결과 조회 (인터페이스결과포함) \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='ERI_RSLT_EX' rs:number='1' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_RSLT_ITEM'
			 rs:basecolumn='ERI_RSLT_EX'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='ERI_PACS_RSLT' rs:number='2' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_RSLT_ITEM'
