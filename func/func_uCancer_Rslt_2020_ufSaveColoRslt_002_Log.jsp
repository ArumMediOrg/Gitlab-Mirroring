...
<%!
	public String func_uCancer_Rslt_2020_ufSaveColoRslt_002_Log(Statement argStmtExec, HashMap argHtMethod) throws Exception {
		...
		try {
			...
			sql = " Insert Into ET_CANCER_COLO_LOG ";
