...
<%
		...
		sql += " SELECT * FROM RT_KUMC_POINT_NEW ";
		sql += " WHERE ";
		sql += " RKP_RECE_NO = '" + RECE_NO + "' ";
		sql += " AND  RKP_RECE_SEQ = '" + RECE_SEQ + "' ";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uKUMC_Point_Management_usePointNew_002 \n";
			G_INFO += "설명 : 포인트 인적정보 조회_New \n";
			G_INFO += "\n\n";
