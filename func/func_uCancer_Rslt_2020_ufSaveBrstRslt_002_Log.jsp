...
<%!
	public String func_uCancer_Rslt_2020_ufSaveBrstRslt_002_Log(Statement argStmtExec, HashMap argHtMethod) throws Exception {
		...
		try {
			...
			sql = " Insert Into ET_CANCER_BRST_LOG ";
