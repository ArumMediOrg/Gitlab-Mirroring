...
SELECT A.EEA_EXAM_DT, COUNT(EEA_EXAM_DT) EEA_Count 
  FROM ET_EXAM_ACPT A
...
:PARAM_TX     
 ...
 GROUP BY A.EEA_EXAM_DT
		*/
		...
		sql = " SELECT A.EEA_EXAM_DT, COUNT(EEA_EXAM_DT) EEA_COUNT";
		...
		sql += " GROUP BY A.EEA_EXAM_DT";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uExam_Cnt_UF_SqlSet_001 \n";
			G_INFO += "설명 : 검진일자별 접수건수 조회 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='EEA_COUNT' rs:number='2' rs:nullable='true'>
...
<%
		...
		while(cRsList.next()) {
			...
			String EEA_COUNT_T = cRsList.getString("EEA_COUNT");
%>
			<z:row
<%
...
<%
			...
			if(! EEA_COUNT_T.equals("")) {
%>
		 		EEA_COUNT='<%= EEA_COUNT_T%>'
<%
			}
%>
			/>
