...
Select eea_2nd_yn From ET_EXAM_ACPT
 Where EEA_EXAM_DT = :EXAM_DT
   And EEA_EXAM_SQ = :EXAM_SQ

		*/

		sql = " SELECT EEA_2ND_YN";
		...
		sql += " AND EEA_EXAM_SQ = '" + EXAM_SQ + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_HEALTH_NOISE_UP_GridDisplay_001 \n";
			G_INFO += "설명 : 접수조회(2차동시실시유무) \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='EEA_2ND_YN' rs:number='1' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_EXAM_ACPT'
