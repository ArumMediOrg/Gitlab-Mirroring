...
SELECT IIM_ITEM_CD, IIM_KNME_NM, IIM_OSCD_CD FROM IT_ITEM
		*/

		sql = " SELECT IIM_ITEM_CD, IIM_KNME_NM, IIM_OSCD_CD";
		sql += " FROM IT_ITEM";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCOMP_CNRT_XML_COM_001 \n";
			G_INFO += "설명 : 검사항목 조회(전체)-Filter용 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='IIM_OSCD_CD' rs:number='3' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_ITEM'
