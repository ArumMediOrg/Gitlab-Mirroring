...
SELECT ICY_COMP_NM FROM IT_COMPANY WHERE ICY_COMP_CD = :AParam1
		*/

		sql = " SELECT ICY_COMP_NM";
		sql += " FROM IT_COMPANY";
		sql += " WHERE ICY_COMP_CD = '" + APARAM1 + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uTiberoTemplate_F_COMP_FIND_001 \n";
			G_INFO += "설명 : 회사코드에 맞는 회사명 추출 \n";
			G_INFO += "\n\n";
