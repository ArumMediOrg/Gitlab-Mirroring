...
SELECT * 
FROM ET_CANCER_CRVC
WHERE ECV_EXAM_SQ = :EXAM_SQ
AND ECV_EXAM_DT = :EXAM_DT
		*/

		sql = " SELECT *";
		sql += " FROM ET_CANCER_CRVC";
		sql += " WHERE ECV_EXAM_SQ = '" + EXAM_SQ + "'";
		sql += " AND ECV_EXAM_DT = '" + EXAM_DT + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : omr_CRVCCancer_001 \n";
			G_INFO += "설명 : OMR 자궁경부암 기록지 조회 \n";
			G_INFO += "\n\n";
