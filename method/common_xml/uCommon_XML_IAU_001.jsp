...
<%
 ...
 SELECT * FROM IT_AUTH_USER
  WHERE 1 = 1
if :IAU_EMP_NO <> '' then
    AND IAU_EMP_NO = :IAU_EMP_NO
if :IAU_USE_YN <> '' then
    AND IAU_USE_YN = :IAU_USE_YN
		...
		*/
		...
		sql += " WHERE 1 = 1";
		if(IAU_EMP_NO != null && ! IAU_EMP_NO.equals("")) {
			sql += " AND IAU_EMP_NO = '" + IAU_EMP_NO + "'";
		}
		if(IAU_USE_YN != null && ! IAU_USE_YN.equals("")) {
			sql += " AND IAU_USE_YN = '" + IAU_USE_YN + "'";
		}

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCommon_XML_IAU_001 \n";
			G_INFO += "설명 : 사용자조회(전체항목) \n";
			G_INFO += "\n\n";
