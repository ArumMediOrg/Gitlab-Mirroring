...
SELECT * FROM ST_DENTAL
WHERE SDP_EXAM_DT  = :EXAM_DT
  AND SDP_EXAM_SQ  = :EXAM_SQ
  AND SDP_EXAM_CHA = :EXAM_CHA
		*/
		...
		sql += " AND SDP_EXAM_CHA = '" + EXAM_CHA + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_Dental_Prt_QRBand1BeforePrint_001 \n";
			G_INFO += "설명 : 치아검사 및 치주조직검사 결과 조회 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='SDP_EXAM_DT' rs:number='1' rs:writeunknown='true' rs:basetable='ST_DENTAL' rs:basecolumn='SDP_EXAM_DT'>
			<s:datatype dt:type='string' dt:maxLength='10' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_EXAM_SQ' rs:number='2' rs:writeunknown='true' rs:basetable='ST_DENTAL' rs:basecolumn='SDP_EXAM_SQ'>
			<s:datatype dt:type='string' dt:maxLength='10' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_EXAM_CHA' rs:number='3' rs:writeunknown='true' rs:basetable='ST_DENTAL' rs:basecolumn='SDP_EXAM_CHA'>
			<s:datatype dt:type='string' dt:maxLength='1' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GUL7_YN' rs:number='4' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GUL7_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GUL6_YN' rs:number='5' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GUL6_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GUL5_YN' rs:number='6' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GUL5_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GUL4_YN' rs:number='7' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GUL4_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GUL3_YN' rs:number='8' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GUL3_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GUL2_YN' rs:number='9' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GUL2_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GUL1_YN' rs:number='10' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GUL1_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GUR1_YN' rs:number='11' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GUR1_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GUR2_YN' rs:number='12' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GUR2_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GUR3_YN' rs:number='13' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GUR3_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GUR4_YN' rs:number='14' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GUR4_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GUR5_YN' rs:number='15' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GUR5_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GUR6_YN' rs:number='16' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GUR6_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GUR7_YN' rs:number='17' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GUR7_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GUR8_YN' rs:number='18' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GUR8_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GDL7_YN' rs:number='19' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GDL7_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GDL6_YN' rs:number='20' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GDL6_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GDL5_YN' rs:number='21' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GDL5_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GDL4_YN' rs:number='22' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GDL4_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GDL3_YN' rs:number='23' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GDL3_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GDL2_YN' rs:number='24' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GDL2_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GDL1_YN' rs:number='25' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GDL1_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GDR1_YN' rs:number='26' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GDR1_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GDR2_YN' rs:number='27' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GDR2_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GDR3_YN' rs:number='28' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GDR3_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GDR4_YN' rs:number='29' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GDR4_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GDR5_YN' rs:number='30' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GDR5_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GDR6_YN' rs:number='31' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GDR6_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GDR7_YN' rs:number='32' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GDR7_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_GDR8_YN' rs:number='33' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_GDR8_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_BUL_YN' rs:number='34' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_BUL_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_BUF_YN' rs:number='35' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_BUF_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_BUR_YN' rs:number='36' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_BUR_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_BDL_YN' rs:number='37' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_BDL_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_BDF_YN' rs:number='38' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_BDF_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_BDR_YN' rs:number='39' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_BDR_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_BRSLT_TX' rs:number='40' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_BRSLT_TX'>
			<s:datatype dt:type='string' dt:maxLength='500'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_DE0_YN' rs:number='41' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_DE0_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_DE1_YN' rs:number='42' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_DE1_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_DE2_YN' rs:number='43' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_DE2_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_DE3_YN' rs:number='44' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_DE3_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_DE4_YN' rs:number='45' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_DE4_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_DE5_YN' rs:number='46' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_DE5_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_PT0_YN' rs:number='47' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_PT0_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_PT1_YN' rs:number='48' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_PT1_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_PT2_YN' rs:number='49' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_PT2_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_PT3_YN' rs:number='50' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_PT3_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_PT4_YN' rs:number='51' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_PT4_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_P0_YN' rs:number='52' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_P0_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_P1_YN' rs:number='53' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_P1_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_P2_YN' rs:number='54' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_P2_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_P3_YN' rs:number='55' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_P3_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_P4_YN' rs:number='56' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_P4_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_P5_YN' rs:number='57' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_P5_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_P5_ETC' rs:number='58' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_P5_ETC'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_DENT_DT' rs:number='59' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_DENT_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_HOSP_CD' rs:number='60' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_HOSP_CD'>
			<s:datatype dt:type='string' dt:maxLength='2'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_INPT_ID' rs:number='61' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_INPT_ID'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_INPT_DTT' rs:number='62' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_INPT_DTT'>
			<s:datatype dt:type='dateTime' rs:dbtype='timestamp' dt:maxLength='16' rs:scale='0' rs:precision='19' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_MODI_ID' rs:number='63' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_MODI_ID'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='SDP_MODI_DTT' rs:number='64' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
			 rs:basecolumn='SDP_MODI_DTT'>
			<s:datatype dt:type='dateTime' rs:dbtype='timestamp' dt:maxLength='16' rs:scale='0' rs:precision='19' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='ROWID' rs:number='65' rs:rowid='true' rs:writeunknown='true' rs:basetable='ST_DENTAL'
