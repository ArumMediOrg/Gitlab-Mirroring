...
<%
		...
		sql = " SELECT GetSP_COMMON_cdToNm('HM05D',CSP_JANGGI_CD) CSP_JANGGI_NM, ";
		sql += " 	B.IIM_KNME_NM, ";
		sql += " 	GetSP_COMMON_cdToNm('HM99D',CSP_CHASU) CSP_CHASU_NM, ";
		sql += " 	GetSP_COMMON_cdToNm('HM99E',CSP_CHOC_KD) CSP_CHOC_NM, A.* ";
		sql += " FROM CT_SP_PROF A ";
		sql += " Inner Join IT_ITEM B On B.IIM_SBCD_CD = A.CSP_SBCD_CD ";
		sql += " WHERE 0 = 0 ";
		...
		sql += " ORDER BY CSP_JJ_CD ";
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_PROF_SBtnQueryClick_002 \n";
			G_INFO += "설명 : 특검 유형정보 로딩(한양대 구리병원) \n";
			G_INFO += "\n\n";
