...
<%
		...
		/*
Select
EEA_STOMA_CD, EEA_COLON_CD, EEA_LIVER_CD,
EEA_BAST_CD,  EEA_UTER_CD,  EEA_LUNG_CD,
EEA_CNCR_DT
From ET_EXAM_ACPT
 Where EEA_EXAM_DT = :sEXAM_DT
   And EEA_EXAM_SQ = :sEXAM_SQ
		*/

		sql = " Select ";
		sql += " EEA_STOMA_CD, EEA_COLON_CD, EEA_LIVER_CD, ";
		sql += " EEA_BAST_CD,  EEA_UTER_CD,  EEA_LUNG_CD, ";
		sql += " EEA_CNCR_DT ";
		...
		sql += " And EEA_EXAM_SQ = '" + SEXAM_SQ + "' ";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCRM_BASIC_CRMMain_GridDisplay_025 \n";
			G_INFO += "설명 : 상담관리-접수-검사결과-암 통보일자 \n";
			G_INFO += "\n\n";
