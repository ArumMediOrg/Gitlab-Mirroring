...
<%
		...
		sql += " SELECT RCR_TID, ";
		sql += " 	RCR_TRACE_CD, ";
		sql += " 	RCR_ALLOT_MM||'개월' RCR_ALLOT_MM, ";
		sql += " 	RCR_RECE_PR, ";
		sql += " 	RCR_APPR_NO, ";
		sql += " 	RCR_APPR_DT, ";
		sql += " 	RCR_RECE_NO, ";
		sql += " RCR_STORE_CD, RCR_ISSUE_CD, RCR_CARD_NO, RCR_INPUT_DTT, RCR_CARD_NM, RCR_DEAL_NO, RCR_XLS_DT, RCR_CARDTOKEN ";
		...
		sql += " ORDER BY RCR_INPUT_DTT ";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uBT_Rece_HYUMC_RECEPRT_001 \n";
			G_INFO += "설명 : 영수증 인적정보 조회 \n";
			G_INFO += "\n\n";
