...
SELECT IIQ_ITEM_CD, IIQ_SORT_NO, IIQ_QGTN_CD, IIQ_ITQU_LV1, IIQ_ITQU_LV2, IIQ_ITQU_SQ, IIQ_ITQU_TX, QQN_RESULT, CQN_ANSE_EX, QQN_ANSR_CD, QQN_QSTN_CP 
  FROM QT_QUESTION A 
       INNER JOIN IT_ITEM_QUESTION B ON A.QQN_QSTN_CD = B.IIQ_QGTN_CD AND B.IIQ_ITEM_CD = 'M0018' AND B.IIQ_APLY_DT = GetITEM_QUESTION_ApplyDate('M0018',:EXAM_DT) AND B.IIQ_USE_YN = 'Y' 
 ...
 WHERE QQN_EXAM_DT = :EXAM_DT
   AND QQN_EXAM_SQ = :EXAM_SQ
		...
		*/
		...
		sql += " AND B.IIQ_ITEM_CD = 'M0018'";
		sql += " AND B.IIQ_APLY_DT = GETITEM_QUESTION_APPLYDATE('M0018','" + EXAM_DT + "')";
		...
		sql += " AND QQN_EXAM_SQ = '" + EXAM_SQ + "'";
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uDT_CCDT_PANJ_GrdEXAM_ACPTSelectionChanged_006 \n";
			G_INFO += "설명 : 일반검진 문진정보 로딩 \n";
			G_INFO += "\n\n";
