...
SELECT SBP_EXAM_DT,SBP_EXAM_SQ,ICR_PENL_ID,ICR_PENL_NM, SBP_BILLE_DT,SBP_BILL_FL 
...
WHERE SBP_CHUNG_DT = :schungdt
   ...
   AND SBP_RETURN_KD= :RETURN_KD
		...
		*/
		...
		sql = " SELECT SBP_EXAM_DT,SBP_EXAM_SQ,ICR_PENL_ID,ICR_PENL_NM, SBP_BILLE_DT,SBP_BILL_FL";
		...
		sql += " AND SBP_RETURN_KD= '" + RETURN_KD + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_ChungPer_RzPageControl1Change_002 \n";
			G_INFO += "설명 : 반송정보 로딩 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='SBP_BILLE_DT' rs:number='5' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_BILLHN_PR'
