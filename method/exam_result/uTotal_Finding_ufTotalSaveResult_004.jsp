...
FROM QT_QUESTION A                                                             
          LEFT OUTER JOIN IT_ITEM_QUESTION B                                   
            ...
            AND IIQ_ITEM_CD = 'M0017'                                        
WHERE QQN_EXAM_DT = :EXAM_DT                                           
 AND QQN_EXAM_SQ = :EXAM_SQ                                           
 AND IIQ_APLY_DT = dbo.GetITEM_QUESTION_ApplyDate('M0017',:EXAM_DT ) 
		...
		*/
		...
		sql += " AND IIQ_ITEM_CD = 'M0017'";
		sql += " WHERE QQN_EXAM_DT = '" + EXAM_DT + "'";
		sql += " AND QQN_EXAM_SQ = '" + EXAM_SQ + "'";
		sql += " AND IIQ_APLY_DT = GETITEM_QUESTION_APPLYDATE('M0017','" + EXAM_DT + "')";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uTotal_Finding_ufTotalSaveResult_004 \n";
			G_INFO += "설명 : 종합소견 흡연,음주여부 체크(고대) \n";
			G_INFO += "\n\n";
