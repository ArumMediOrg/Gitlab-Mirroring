...
<%
		...
		sql = " SELECT B.EEA_PSNL_NM, EEA_EXAM_DT, EEA_MNGT_HTYR , ";
		sql += " CASE WHEN EEA_SEX_CD = '1' THEN '남성' WHEN EEA_SEX_CD = '2' THEN '여성' END AS EEA_SEX_NM , ";
		sql += " F_DOCLICNE(C.PFP_DOCTORFIR,'의사') FIR_LICEN, E.IAU_PENL_NM FIR_DOC_NM, C.PFP_DOCTORFIR , ";
		sql += " F_DOCLICNE(D.PSP_DOCTORSED,'의사') SED_LICEN, F.IAU_PENL_NM SED_DOC_NM, D.PSP_DOCTORSED , A.*";
		...
		sql += " AND PLR_EXAM_SQ = '" + EXAM_SQ + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uExam_Result_XML_COM_001 \n";
			G_INFO += "설명 : 처방전조회 전체 \n";
			G_INFO += "\n\n";
