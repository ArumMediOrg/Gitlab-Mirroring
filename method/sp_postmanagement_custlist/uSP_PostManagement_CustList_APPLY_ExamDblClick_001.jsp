...
SELECT A.EEA_EXAM_DT, A.EEA_CUST_NO, A.EEA_PSNL_NM, A.EEA_EXAM_SQ, A.EEA_PSNL_AGE, A.EEA_COMP_CD, A.EEA_HTSB_CD,  
       A.EEA_EXAM_CD, A.EEA_HDMD_YN, A.EEA_SDMD_YN, A.EEA_SPCL_LT, A.EEA_SPCL_CD,  A.EEA_SPHT_CD, A.EEA_CHART_NO, A.EEA_DEPT_NM, 
       ...
       CASE WHEN A.EEA_SPHT_CD IS NULL OR A.EEA_SPHT_CD = '' THEN A.EEA_SPHT_CD ELSE '[' || A.EEA_SPHT_CD || ']' || GETCOMMON_LVCDTONM('0911',A.EEA_SPHT_CD,'5',1) END EEA_SPHT_MN, 
       SUBSTR(B.ICR_PENL_ID,1,6) EEA_BIRTH_DT, B.ICR_BIRH_KD, B.ICR_TEL_NO, B.ICR_MOBL_NO, B.ICR_SEX_KD  
 ...
 ORDER BY A.EEA_EXAM_DT DESC
		*/
		...
		sql = " SELECT A.EEA_EXAM_DT, A.EEA_CUST_NO, A.EEA_PSNL_NM, A.EEA_EXAM_SQ, A.EEA_PSNL_AGE, A.EEA_COMP_CD, A.EEA_HTSB_CD, A.EEA_EXAM_CD, A.EEA_HDMD_YN, A.EEA_SDMD_YN, A.EEA_SPCL_LT, A.EEA_SPCL_CD, A.EEA_SPHT_CD, A.EEA_CHART_NO, A.EEA_DEPT_NM";
		...
		sql += ", CASE WHEN A.EEA_SPHT_CD IS NULL OR A.EEA_SPHT_CD = '' THEN A.EEA_SPHT_CD ELSE '[' || A.EEA_SPHT_CD || ']' || GETCOMMON_LVCDTONM('0911',A.EEA_SPHT_CD,'5',1) END EEA_SPHT_MN";
		sql += ", SUBSTR(B.ICR_PENL_ID,1,6) EEA_BIRTH_DT, B.ICR_BIRH_KD, B.ICR_TEL_NO, B.ICR_MOBL_NO, B.ICR_SEX_KD";
		...
		sql += " ORDER BY A.EEA_EXAM_DT DESC";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_PostManagement_CustList_APPLY_ExamDblClick_001 \n";
			G_INFO += "설명 : 과거 판정 조회용 접수 조회 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='EEA_SPCH_KD' rs:number='16' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='1' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='EEA_SPCL_NM' rs:number='17' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='EEA_SPHT_MN' rs:number='18' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='EEA_BIRTH_DT' rs:number='19' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='12'/>
		</s:AttributeType>
		<s:AttributeType name='ICR_BIRH_KD' rs:number='20' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_CUSTOMER'
			 rs:basecolumn='ICR_BIRH_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ICR_TEL_NO' rs:number='21' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_CUSTOMER'
			 rs:basecolumn='ICR_TEL_NO'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ICR_MOBL_NO' rs:number='22' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_CUSTOMER'
			 rs:basecolumn='ICR_MOBL_NO'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ICR_SEX_KD' rs:number='23' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_CUSTOMER'
