...
SELECT RRL_EXAM_DT, RRL_HOLI_CD, RRL_HOLI_NM
 ...
 WHERE RRL_EXAM_DT >= :EXAM_DTS
   AND RRL_EXAM_DT <= :EXAM_DTE
   AND RRL_EQUI_CD  = '00'
   AND RRL_HOLI_CD  IN ('3', '4')
 GROUP BY RRL_EXAM_DT, RRL_HOLI_CD, RRL_HOLI_NM
		*/

		sql = " SELECT RRL_EXAM_DT, RRL_HOLI_CD, RRL_HOLI_NM";
		sql += " FROM RT_RSVT_EQUIP_LIMIT";
		sql += " WHERE RRL_EXAM_DT >= '" + EXAM_DTS + "'";
		sql += " AND RRL_EXAM_DT <= '" + EXAM_DTE + "'";
		sql += " AND RRL_EQUI_CD = '00'";
		sql += " AND RRL_HOLI_CD IN ('3', '4')";
		sql += " GROUP BY RRL_EXAM_DT, RRL_HOLI_CD, RRL_HOLI_NM";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uFM_AcptComm_GF_FindHoliday_001 \n";
			G_INFO += "설명 : 휴일 조회 \n";
			G_INFO += "\n\n";
