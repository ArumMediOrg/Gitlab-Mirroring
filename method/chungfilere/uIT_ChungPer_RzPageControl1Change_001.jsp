...
<%
		...
		sql += " BBP_EXAM_DT,BBP_EXAM_SQ ,ICR_PENL_NM,  BBP_BILL_FL, BBP_ADDSUB_RSN,";
		sql += "  BBP_CHUNG_KD, ";

		if(SCHGBN.equals("1")) {
			sql += " BBP_BILLFIR_PR AMT";
		} else if(SCHGBN.equals("2")) {
			sql += " BBP_BILLSED_PR AMT";
		} else if(SCHGBN.equals("3")) {
			sql += " BBP_BILLCAN_PR AMT";
		} else if(SCHGBN.equals("4")) {
			sql += " BBP_BILLCANFN_PR AMT";
		} else if(SCHGBN.equals("5")) {
			sql += " BBP_BILLORAL_PR AMT";
		} else if(SCHGBN.equals("6")) {
			sql += " BBP_BILLOS_PR AMT";
		} else if(SCHGBN.equals("7")) {
			sql += " BBP_BILLOSC_PR AMT";
		} else if(SCHGBN.equals("8")) {
			sql += " BBP_BILLOSD_PR AMT";
		...
		sql += " AND BBP_RETURN_KD = '0'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uIT_ChungPer_RzPageControl1Change_001 \n";
			G_INFO += "설명 : 청구인원조회 \n";
			G_INFO += "\n\n";
