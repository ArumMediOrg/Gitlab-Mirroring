...
SELECT F_MAKE_EXAMSQ(:EXAM_DT, :PLCE_CD) AS EXAM_SQ
  FROM DUAL

		*/

		sql = " SELECT F_MAKE_EXAMSQ('" + EXAM_DT + "', '" + PLCE_CD + "') AS EXAM_SQ";
		sql += " FROM DUAL";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uFM_AcptComm_GF_MakeExamSq_001 \n";
			G_INFO += "설명 : 접수순번 생성 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='EXAM_SQ' rs:number='1' rs:nullable='true'>
