...
SELECT * FROM ET_RSLT_ITEM
 WHERE ERI_EXAM_DT = :EXAM_DT
   ...
   AND ERI_ITEM_CD in ('S0240','S0241','S0242','S0243',
                       'S0246','S0247','S0248','S0249')
   AND ERI_CNCL_YN <> 'Y'
		*/
		...
		sql += " AND ERI_ITEM_CD IN ('S0240','S0241','S0242','S0243', 'S0246','S0247','S0248','S0249')";
		sql += " AND ERI_CNCL_YN <> 'Y'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_Health_GrdEXAM_ACPTSelectionChanged_018 \n";
			G_INFO += "설명 : 검사항목결과조회(촬영재료대) \n";
			G_INFO += "\n\n";
