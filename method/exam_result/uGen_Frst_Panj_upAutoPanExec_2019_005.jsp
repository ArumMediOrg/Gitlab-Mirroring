...
select * from ET_RSLT_ITEM
 where ERI_EXAM_DT = :EXAM_DT
   ...
   and ERI_ITEm_CD in ('R0024','R0026','S0252')
		*/
		...
		sql += " AND ERI_ITEM_CD IN ('R0024','R0026','S0252')";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uGen_Frst_Panj_upAutoPanExec_2019_005 \n";
			G_INFO += "설명 : 일검자동판정(노인신체 / 낙상 / 예방접종 조회) \n";
			G_INFO += "\n\n";
