...
<%
 ...
 SELECT G1.*, RSPT AS RSPT_CNT
   FROM (
    ...
    LEFT OUTER JOIN TABLE(GetItemVldtTable_PKG.GetItemVldtTable(G1.ERI_ITEM_CD, G1.EEA_SEX_CD, G1.EEA_PSNL_AGE, G1.ERI_EXAM_DT, G1.VLDT_KD)) A
      ON A.ITEM_CD = G1.ERI_ITEM_CD
		*/
		...
		sql += " AND ERI_EXAM_SQ = '" + EXAM_SQ + "') G1 LEFT OUTER JOIN TABLE(GETITEMVLDTTABLE_PKG.GETITEMVLDTTABLE(G1.ERI_ITEM_CD, G1.EEA_SEX_CD, G1.EEA_PSNL_AGE, G1.ERI_EXAM_DT, G1.VLDT_KD)) A";
