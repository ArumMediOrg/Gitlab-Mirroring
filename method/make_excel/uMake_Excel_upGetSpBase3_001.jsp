...
<%
		...
		String TBLE_NM = htMethod.get("TBLE_NM");

		//
		if(TBLE_NM == null) { TBLE_NM = ""; }
...
Select * From IT_EXCEL_PAN         
 ...
 Order bY IEI_ITEM_SQ               
		...
		*/
		...
		sql += " WHERE IEI_TBLE_NM = '" + TBLE_NM + "'";
		sql += " ORDER BY IEI_ITEM_SQ";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uMake_Excel_upGetSpBase3_001 \n";
			G_INFO += "설명 : 엑셀용 판정정보 로딩 \n";
			G_INFO += "\n\n";

			G_INFO += "전달인자 : \n";
			G_INFO += " TBLE_NM : " + TBLE_NM + " \n";
			G_INFO += "\n\n";
