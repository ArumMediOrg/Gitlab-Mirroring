...
<%
		...
		String ORGA_ETC = htMethod.get("ORGA_ETC");
		...
		sql = func_uSP_Health_NEWAutoPanjung_004(stmtExec, htMethod);

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_Health_NEWAutoPanjung_004 \n";
			G_INFO += "설명 : 특검자동판정-소음 R 판정으로 변경 \n";
			G_INFO += "\n\n";
