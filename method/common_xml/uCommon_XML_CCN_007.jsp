...
<%
		...
		sql += " UNION ";
		sql += " SELECT '배치전 검사' AS CCN_FULL_NM, '49001' AS CCN_SMALL FROM DUAL ";
		sql += " UNION ";
		sql += " SELECT '2차검진(일+특)' AS CCN_FULL_NM, '43002' AS CCN_SMALL FROM DUAL ";
		sql += " UNION ";
		sql += " SELECT '생활습관평가' AS CCN_FULL_NM, '12009' AS CCN_SMALL FROM DUAL ";
		sql += " UNION ";
		sql += " SELECT '정신건강' AS CCN_FULL_NM, '12008' AS CCN_SMALL FROM DUAL ";
		sql += " ORDER BY CCN_SMALL ";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCommon_XML_CCN_007 \n";
