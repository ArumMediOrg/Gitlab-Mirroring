...
<%
		...
		sql += " SELECT * FROM CR_CLDR_MEMO ";
		sql += " WHERE CCM_MEMO_DT = '" + MEMO_DT + "' ";
		sql += " AND CCM_MEMO_KD = '" + MEMO_KD + "' ";


			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uMemo_Apply_CRM_UF_GridDisplay_001 \n";
			G_INFO += "설명 : 종검상담스케줄-종검상담일정메모 조회 \n";
			G_INFO += "\n\n";
