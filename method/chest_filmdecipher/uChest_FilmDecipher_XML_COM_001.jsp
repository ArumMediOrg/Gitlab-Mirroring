...
WHERE IAU_DEPT_CD = '0206'
  AND (IAU_LICEN1_CD = '11' OR IAU_LICEN1_CD = '12' OR IAU_LICEN2_CD = '11' OR IAU_LICEN2_CD = '12')
ORDER BY IAU_EMP_NO
		...
		*/
		...
		sql += " WHERE IAU_DEPT_CD = '0206'";
		sql += " AND (";
		sql += "	IAU_LICEN1_CD = '11'";
		sql += " 	OR IAU_LICEN1_CD = '12'";
		sql += " 	OR IAU_LICEN2_CD = '11'";
		sql += " 	OR IAU_LICEN2_CD = '12'";
		sql += " )";
		sql += " ORDER BY IAU_EMP_NO";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uChest_FilmDecipher_XML_COM_001 \n";
			G_INFO += "설명 : 흉부영상판독의 리스트 조회(전체) \n";
			G_INFO += "\n\n";
