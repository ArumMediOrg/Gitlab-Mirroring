...
SELECT RRL_EXAM_DT,   MAX(ECM_RSVT_TX) ECM_RSVT_TX,
 ...
 GROUP BY RRL_EXAM_DT
		*/
		...
		sql += " AND RRE_USE_YN = 'Y' THEN RRL_RSVN_CNT ELSE 0 END EQUIP_P08, CASE WHEN RRL_EQUI_CD = '09'";
