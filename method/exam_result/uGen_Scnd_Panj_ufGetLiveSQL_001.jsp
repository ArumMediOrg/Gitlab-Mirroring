<br />
<b>Warning</b>:  mysql_fetch_array(): supplied argument is not a valid MySQL result resource in <b>/home/arume/public_html/admin/board_method/create_source_code_select.php</b> on line <b>24</b><br />
...
<%
  ...
  SELECT SUM(QQN_SCORE) SCORE
   ...
   WHERE QQN_EXAM_DT = :EXAM_DT
     ...
     AND IIQ_APLY_DT = GetITEM_QUESTION_ApplyDate(:ITEM_CD,:EXAM_DT)



		*/

		sql = " SELECT SUM(QQN_SCORE) SCORE";
		...
		sql += " AND IIQ_APLY_DT = GETITEM_QUESTION_APPLYDATE('" + ITEM_CD + "', '" + EXAM_DT + "')";
