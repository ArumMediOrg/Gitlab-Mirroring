...
<%
		...
		String IAU_AUTH_GP = htMethod.get("IAU_AUTH_GP");

		//
		if(IAU_AUTH_GP == null) { IAU_AUTH_GP = ""; }
...
select IAU_EMP_NO from IT_AUTH_USER where IAU_AUTH_GP = :IAU_AUTH_GP 
		*/

		sql = " SELECT IAU_EMP_NO";
		sql += " FROM IT_AUTH_USER";
		sql += " WHERE IAU_AUTH_GP = '" + IAU_AUTH_GP + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uUserAuthManagement_setGridStatus_002 \n";
			G_INFO += "설명 : 그룹에 해당하는 계정정보 로딩 \n";
			G_INFO += "\n\n";

			G_INFO += "전달인자 : \n";
			G_INFO += " IAU_AUTH_GP : " + IAU_AUTH_GP + " \n";
			G_INFO += "\n\n";
