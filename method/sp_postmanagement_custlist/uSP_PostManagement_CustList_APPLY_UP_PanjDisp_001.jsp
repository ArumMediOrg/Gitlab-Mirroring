...
SELECT B.CSM_MATT_NM,  A.*, 
 ...
 WHERE A.SPG_EXAM_DT  = :EXAM_DT 
   ...
   AND A.SPG_EXAM_CHA = :EXAM_CHA 
   AND A.SPG_PANJ_CD in ('4', '5', '6', '7', '9', 'A', 'B') 
		*/

		sql = " SELECT B.CSM_MATT_NM, A.*, GETSP_COMMON_CDTONM('HM05E', A.SPG_PANJ_CD) SPG_PANJ_NM, GETSP_COMMON_CDTONM('HM05D', A.SPG_ORGA_CD) SPG_ORGA_NM, GETSP_COMMON_CDTONM('HM05A', A.SPG_POSM1_CD) SPG_POSM1_NM, GETSP_COMMON_CDTONM('HM05A', A.SPG_POSM2_CD) SPG_POSM2_NM, GETSP_COMMON_CDTONM('HM05A', A.SPG_POSM3_CD) SPG_POSM3_NM, GETSP_COMMON_CDTONM('HM05B', A.SPG_BUSI_CD) SPG_BUSI_NM";
		...
		sql += " AND A.SPG_PANJ_CD IN ('4', '5', '6', '7', '9', 'A', 'B')";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_PostManagement_CustList_APPLY_UP_PanjDisp_001 \n";
			G_INFO += "설명 : 판정조회 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='SPG_PANJ_NM' rs:number='41' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='SPG_ORGA_NM' rs:number='42' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='SPG_POSM1_NM' rs:number='43' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='SPG_POSM2_NM' rs:number='44' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='SPG_POSM3_NM' rs:number='45' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='SPG_BUSI_NM' rs:number='46' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='ROWID' rs:number='47' rs:rowid='true' rs:basetable='ST_PANJUNG' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c47' rs:name='ROWID' rs:number='48' rs:rowid='true' rs:basetable='CT_SP_MATTER' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
