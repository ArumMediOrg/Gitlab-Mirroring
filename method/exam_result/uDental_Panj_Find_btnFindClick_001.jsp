...
SELECT * FROM CT_COMM_PANJ
 WHERE CCP_MACH_NM like  '%'||:MACH_NM||'%'
 ...
 ORDER BY CCP_MACH_SQ
		*/
		...
		sql += " WHERE CCP_MACH_NM LIKE '%" + MACH_NM + "%'";
		...
		sql += " ORDER BY CCP_MACH_SQ";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uDental_Panj_Find_btnFindClick_001 \n";
			G_INFO += "설명 : 구강판정 소견 조회 \n";
			G_INFO += "\n\n";
