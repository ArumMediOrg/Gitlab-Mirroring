...
<%
      ...
      SELECT CSC_LARGE CSC_SMALL, CSC_FULL_NM FROM CT_SP_COMMON 
		...
		*/
		...
		sql += " WHERE CSC_LEVEL = '" + SLEVEL + "'";
		sql += " ORDER BY CSC_LARGE";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : UFM_Common_GP_ComboSetting_001___2 \n";
			G_INFO += "설명 : 구분값에 따른 콤보박스 정보 로딩___2 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='CSC_SMALL' rs:number='1' rs:writeunknown='true' rs:basetable='CT_SP_COMMON' rs:basecolumn='CSC_LARGE'>
