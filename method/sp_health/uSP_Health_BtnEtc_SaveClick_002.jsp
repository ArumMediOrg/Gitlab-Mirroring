...
<%
		...
		String REMARK_TX = htMethod.get("REMARK_TX");
		...
		sql = func_uSP_Health_BtnEtc_SaveClick_002(stmtExec, htMethod);

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_Health_BtnEtc_SaveClick_002 \n";
			G_INFO += "설명 : 특검 기본정보(환자비고) 저장(insert,update) \n";
			G_INFO += "\n\n";
