...
<%
		...
		/*
			...
			SELECT CCN_FULL_NM, CCN_SMALL, CCN_LARGE
			FROM CT_COMMON
			WHERE CCN_LARGE = :CCN_LARGE
		...
		*/
		...
		sql = " SELECT CCN_FULL_NM, CCN_SMALL, CCN_LARGE";
		sql += " FROM CT_COMMON";
		sql += " WHERE CCN_LARGE = '" + CCN_LARGE + "'";
		...
		sql += " ORDER BY CCN_SMALL";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uItem_upSetCombobox_001 \n";
			G_INFO += "설명 : 공통코드조회 \n";
			G_INFO += "\n\n";
	...
	<resultXml>
		...
		<s:Schema id='RowsetSchema'>
			<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
				...
				<s:AttributeType name='CCN_LARGE' rs:number='3' rs:writeunknown='true' rs:basetable='CT_COMMON' rs:basecolumn='CCN_LARGE'>
