...
Select RRT_EXAM_DT, RRT_EXAM_SQ
From RT_RSVT                   
 WHERE RRT_RSVN_NO = :SRVNO
		*/

		sql = " SELECT RRT_EXAM_DT, RRT_EXAM_SQ";
		sql += " FROM RT_RSVT";
		sql += " WHERE RRT_RSVN_NO = '" + SRVNO + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : EQuestionaire_MunjinXML_001 \n";
			G_INFO += "설명 : 예약정보 조회 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='RRT_EXAM_SQ' rs:number='2' rs:nullable='true' rs:writeunknown='true' rs:basetable='RT_RSVT'
			 rs:basecolumn='RRT_EXAM_SQ'>
			<s:datatype dt:type='string' dt:maxLength='6'/>
		</s:AttributeType>
		<s:AttributeType name='ROWID' rs:number='3' rs:rowid='true' rs:basetable='RT_RSVT' rs:basecolumn='ROWID' rs:keycolumn='true'
