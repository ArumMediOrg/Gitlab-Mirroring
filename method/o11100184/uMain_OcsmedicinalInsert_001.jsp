...
SELECT Distinct ERI_EXAM_DT, ERI_EXAM_SQ, ERI_OCS_CD, ERI_OCSC_SNO, ERI_OSSB_CD, IIM_MIN_VL
  FROM ET_RSLT_ITEM 
 ...
 WHERE ERI_EXAM_DT = :EXAM_DT
   ...
   And SUBSTR(ERI_ITEM_CD,1,1) = 'O'                          
 ORDER BY ERI_OCS_CD 
		*/

		sql = " SELECT DISTINCT ERI_EXAM_DT, ERI_EXAM_SQ, ERI_OCS_CD, ERI_OCSC_SNO, ERI_OSSB_CD, IIM_MIN_VL";
		...
		sql += " ORDER BY ERI_OCS_CD";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uMain_OcsmedicinalInsert_001 \n";
			G_INFO += "설명 : 검사결과정보 조회 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='IIM_MIN_VL' rs:number='6' rs:nullable='true' rs:basetable='IT_ITEM' rs:basecolumn='IIM_MIN_VL'>
