...
<%
		...
		/*
			...
			SELECT DISTINCT(IIV_APLY_DT)
			FROM IT_ITEM_VLDT
			WHERE IIV_ITEM_CD = :IIV_ITEM_CD 
			ORDER BY IIV_APLY_DT DESC

		*/

		sql = " SELECT DISTINCT(IIV_APLY_DT)";
		...
		sql += " ORDER BY IIV_APLY_DT DESC";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uItem_upSetVldtAplyDate_002 \n";
			G_INFO += "설명 : 검사항목 참고치 적용년도 리스트 조회 \n";
			G_INFO += "\n\n";
	...
	<resultXml>
		...
		<s:Schema id='RowsetSchema'>
			<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
				<s:AttributeType name='IIV_APLY_DT' rs:number='1' rs:basetable='IT_ITEM_VLDT' rs:basecolumn='IIV_APLY_DT'>
