...
<%!
	public String func_uIT_ChungGU_Inquiry_RZ_BTN_Chugu_REClick_001(Statement argStmtExec, HashMap argHtMethod) throws Exception {
		...
		try {
			...
			sql = "DELETE BT_BILL_COMP";
			sql += " WHERE BBC_COMP_CD = '" + COMP_CD + "'";
