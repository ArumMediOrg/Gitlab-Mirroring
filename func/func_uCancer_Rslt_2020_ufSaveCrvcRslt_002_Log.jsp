...
<%!
	public String func_uCancer_Rslt_2020_ufSaveCrvcRslt_002_Log(Statement argStmtExec, HashMap argHtMethod) throws Exception {
		...
		try {
			...
			sql = " Insert Into ET_CANCER_CRVC_LOG ";
