...
<%
		...
		sql = " SELECT RCR_TID, RCR_TRACE_CD, RCR_ALLOT_MM||'개월' RCR_ALLOT_MM, RCR_RECE_PR, RCR_APPR_NO, RCR_APPR_DT, RCR_RECE_NO, RCR_STORE_CD, RCR_ISSUE_CD, RCR_CARD_NO, RCR_INPUT_DTT, RCR_CARD_NM, RCR_DEAL_NO, RCR_XLS_DT, RCR_WCC, RCR_DSC_KD";
