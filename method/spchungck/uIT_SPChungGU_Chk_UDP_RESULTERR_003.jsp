...
SELECT A.ERI_ITEM_CD, A.ERI_RSLT_VL, A.ERI_SPRT_CD, B.IIM_TRTP_CD
  FROM ET_RSLT_ITEM A
 ...
 WHERE A.ERI_EXAM_DT = :EXAM_DT 
   ...
   AND A.ERI_ITEM_CD = 'BA012'
   AND A.ERI_SPCL_KD <> '0'   
   AND B.IIM_RSLT_KD IN ('1', '2', '4', '5', '7')
		*/

		sql = " SELECT A.ERI_ITEM_CD, A.ERI_RSLT_VL, A.ERI_SPRT_CD, B.IIM_TRTP_CD";
		...
		sql += " AND A.ERI_ITEM_CD = 'BA012'";
		sql += " AND A.ERI_SPCL_KD <> '0'";
		sql += " AND B.IIM_RSLT_KD IN ('1', '2', '4', '5', '7')";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uIT_SPChungGU_Chk_UDP_RESULTERR_003 \n";
			G_INFO += "설명 : LDL 실측정값 조회 \n";
			G_INFO += "\n\n";
