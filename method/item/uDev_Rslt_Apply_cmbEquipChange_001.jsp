...
SELECT CCN_SMALL, CCN_FULL_NM 
  FROM CT_COMMON
 WHERE CCN_LARGE = ''0420''
   AND CCN_LEVEL = ''5''
   AND CCN_SMALL LIKE  :CCN_SMALL||'%'

		*/

		sql = " SELECT CCN_SMALL, CCN_FULL_NM";
		sql += " FROM CT_COMMON";
		sql += " WHERE CCN_LARGE = '0420'";
		sql += " AND CCN_LEVEL = '5'";
		sql += " AND CCN_SMALL LIKE '" + CCN_SMALL + "%'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uDev_Rslt_Apply_cmbEquipChange_001 \n";
			G_INFO += "설명 : 공통코드조회(like 조회) \n";
			G_INFO += "\n\n";
