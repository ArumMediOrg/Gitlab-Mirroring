...
<%
		...
		String SCCN_LARGE = htMethod.get("SCCN_LARGE");
		String SCCN_SMALL = htMethod.get("SCCN_SMALL");

		//
		if(SCCN_LARGE == null) { SCCN_LARGE = ""; }
		if(SCCN_SMALL == null) { SCCN_SMALL = ""; }
...
Select CCN_FULL_NM From CT_COMMON                                                      
 Where CCN_LARGE = :sCCN_LARGE
  And CCN_SMALL = :sCCN_SMALL
   And CCN_LEVEL = '5'                                                               
    And CCN_USE_YN = 'Y'                                                             
		...
		*/
		...
		sql += " FROM CT_COMMON";
		sql += " WHERE CCN_LARGE = '" + SCCN_LARGE + "'";
		sql += " AND CCN_SMALL = '" + SCCN_SMALL + "'";
		sql += " AND CCN_LEVEL = '5'";
		sql += " AND CCN_USE_YN = 'Y'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : sp_Select_Print_ACPT_002 \n";
			G_INFO += "설명 : 업종명/작업공정 조회 \n";
			G_INFO += "\n\n";

			G_INFO += "전달인자 : \n";
			G_INFO += " SCCN_LARGE : " + SCCN_LARGE + " \n";
			G_INFO += " SCCN_SMALL : " + SCCN_SMALL + " \n";
			G_INFO += "\n\n";
