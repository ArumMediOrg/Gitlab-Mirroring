...
SELECT CSM_MATT_CD, CSM_MATT_NM, CSM_COMM_CD, CSM_PERIOD_TM, GetSP_COMMON_cdToNm('HM99B',CSM_PERIOD_TM) CSM_PERIOD_NM
  FROM CT_SP_MATTER
 WHERE CSM_MATT_CD IN (:MATT_CD)
		*/
		...
		sql += " WHERE CSM_MATT_CD IN ('" + MATT_CD + "')";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCOMP_DEPT_APPLY_UP_ListToMATTGird_001 \n";
			G_INFO += "설명 : 특수검진 취급물질 내역조회 \n";
			G_INFO += "\n\n";
