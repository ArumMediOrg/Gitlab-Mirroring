...
SELECT A.IIQ_ITQU_LV1, A.IIQ_ITQU_LV2, A.IIQ_ITQU_SQ, C.CQN_QSTN_CD, C.CQN_QSKD_CD, C.CQN_QSTN_SQ, C.CQN_QSTN_LV,
       C.CQN_QSTN_NM, C.CQN_ANSR_CD, C.CQN_ANSE_EX, C.CQN_QSTN_CP, C.CQN_DEFULT, RTRIM(B.QQN_RESULT) QQN_RESULT,
  ...
  FROM IT_ITEM_QUESTION A
       LEFT OUTER JOIN QT_QUESTION B ON A.IIQ_QGTN_CD = B.QQN_QSTN_CD
                                    AND B.QQN_EXAM_DT = :EXAM_DT AND B.QQN_EXAM_SQ = :EXAM_SQ
 ...
 ORDER BY A.IIQ_SORT_NO
		*/
		...
		sql = " SELECT A.IIQ_ITQU_LV1, A.IIQ_ITQU_LV2, A.IIQ_ITQU_SQ, C.CQN_QSTN_CD, C.CQN_QSKD_CD, C.CQN_QSTN_SQ, C.CQN_QSTN_LV, C.CQN_QSTN_NM, C.CQN_ANSR_CD, C.CQN_ANSE_EX, C.CQN_QSTN_CP, C.CQN_DEFULT, RTRIM(B.QQN_RESULT) QQN_RESULT, CASE WHEN C.CQN_ANSR_CD IS NULL";
		...
		sql += " ORDER BY A.IIQ_SORT_NO";
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_Health_UP_GridDisplay_003 \n";
			G_INFO += "설명 : 문진조회-현문진 조회 \n";
			G_INFO += "\n\n";
