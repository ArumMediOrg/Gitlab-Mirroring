...
Select EEA_EXAM_LT From ET_EXAM_ACPT
 Where EEA_EXAM_DT = :EXAM_DT
   And EEA_EXAM_SQ = :EXAM_SQ

		*/

		sql = " SELECT EEA_EXAM_LT";
		...
		sql += " AND EEA_EXAM_SQ = '" + EXAM_SQ + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uPostManagement_NEWCustList_APPLY_RSLTSel_003 \n";
			G_INFO += "설명 : 기타검진정보 로딩 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='EEA_EXAM_LT' rs:number='1' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_EXAM_ACPT'
