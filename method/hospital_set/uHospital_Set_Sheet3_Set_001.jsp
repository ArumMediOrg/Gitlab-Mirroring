...
Select * From CT_COMM_FIRVIEW               
 Where CCF_LCODE = '2'                    
ORDER BY  Cast(CCF_CODE As Int), CCF_PAN_CD 
		...
		*/
		...
		sql += " ORDER BY Cast(CCF_CODE As Int), CCF_PAN_CD";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uHospital_Set_Sheet3_Set_001 \n";
			G_INFO += "설명 : 일검판정 로딩 \n";
			G_INFO += "\n\n";
