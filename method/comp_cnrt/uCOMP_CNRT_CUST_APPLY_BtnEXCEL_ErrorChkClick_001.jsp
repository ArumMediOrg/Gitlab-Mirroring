...
SELECT CCN_SMALL, CCN_FULL_NM, CCN_SMALL || '-' || CCN_FULL_NM Name
 FROM CT_COMMON
 WHERE CCN_LARGE = '0411'
   AND CCN_LEVEL = '5'
   AND CCN_USE_YN = 'Y'
		*/

		sql = " SELECT CCN_SMALL, CCN_FULL_NM, CCN_SMALL || '-' || CCN_FULL_NM NAME";
		sql += " FROM CT_COMMON";
		sql += " WHERE CCN_LARGE = '0411'";
		sql += " AND CCN_LEVEL = '5'";
		sql += " AND CCN_USE_YN = 'Y'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCOMP_CNRT_CUST_APPLY_BtnEXCEL_ErrorChkClick_001 \n";
			G_INFO += "설명 : 엑셀오류체크-성별코드 내역 조회 \n";
			G_INFO += "\n\n";
