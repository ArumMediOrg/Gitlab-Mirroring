...
<%
		...
		sql += " 	FROM (";
		sql += "		SELECT MAX(GB) GB,MAX(CNT) CNT, MAX(AA) AA,MAX(BB) BB";
		sql += " 		FROM (";
		...
		sql += " T2";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uHERESULTPRT_UDP_SEL_SEDMI_001 \n";
			G_INFO += "설명 : 2차 미수검자 정보 로딩 \n";
			G_INFO += "\n\n";
