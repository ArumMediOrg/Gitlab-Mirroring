...
<%
		...
		String CHKINJAADD = htMethod.get("CHKINJAADD");
		...
		sql += " A.EEA_EXAM_DT, A.EEA_EXAM_SQ, A.EEA_CHART_NO, A.EEA_PSNL_NM, A.EEA_PSNL_AGE, EEA_SEX_CD, GETCOMMON_LVCDTONM('0411',A.EEA_SEX_CD,'5',1) EEA_SEX_NM, A.EEA_COMP_CD, C.ICY_COMP_NM, A.EEA_DEPT_NM, D.DCP_PAN_KD, DCP_WORK_KD, DCP_SOKUN_LT";
		...
		if(CHKINJAADD.equals("0")) {
			sql += " AND NVL(D.DCP_PAN_KD,' ') NOT IN ('1', '5', ' ')";
		}
		...
		if(CMBBOXSORT.equals("0")) {
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCcdt_Evaluation_SBtnQueryClick_001 \n";
			G_INFO += "설명 : 접수및 기본정보 로딩 \n";
			G_INFO += "\n\n";
