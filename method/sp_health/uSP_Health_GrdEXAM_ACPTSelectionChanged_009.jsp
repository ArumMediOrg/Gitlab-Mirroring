...
Select EEA_ENTRY_DT From ET_EXAM_ACPT
 Where EEA_EXAM_DT = :EXAM_DT
   And EEA_EXAM_SQ = :EXAM_SQ
		*/

		sql = " SELECT EEA_ENTRY_DT";
		...
		sql += " AND EEA_EXAM_SQ = '" + EXAM_SQ + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_Health_GrdEXAM_ACPTSelectionChanged_009 \n";
			G_INFO += "설명 : 접수정보조회(입사일자) \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='EEA_ENTRY_DT' rs:number='1' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_EXAM_ACPT'
