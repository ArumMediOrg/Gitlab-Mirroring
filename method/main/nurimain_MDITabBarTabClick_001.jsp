...
Select IAP_MENU_ID ,IAP_PRGM_NM,IAP_LIBR_NM 
  from IT_AUTH_PRGM where IAP_PRGM_NM = :PRGM_NM 
		*/

		sql = " SELECT IAP_MENU_ID ,IAP_PRGM_NM,IAP_LIBR_NM";
		sql += " FROM IT_AUTH_PRGM";
		sql += " WHERE IAP_PRGM_NM = '" + PRGM_NM + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : nurimain_MDITabBarTabClick_001 \n";
			G_INFO += "설명 : 특정 프로그램 정보를 가져옴 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='IAP_MENU_ID' rs:number='1' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_PRGM'
		...
		<s:AttributeType name='IAP_LIBR_NM' rs:number='3' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_PRGM'
			 rs:basecolumn='IAP_LIBR_NM'>
			<s:datatype dt:type='string' dt:maxLength='50'/>
		</s:AttributeType>
		<s:AttributeType name='ROWID' rs:number='4' rs:rowid='true' rs:basetable='IT_AUTH_PRGM' rs:basecolumn='ROWID'
