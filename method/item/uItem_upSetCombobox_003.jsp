...
<%
		...
		/*
			...
			FROM CT_SP_COMMON
			WHERE CSC_LARGE = ''HM06E''
			AND CSC_LEVEL = ''5''
			ORDER BY CSC_ETC1_CD

		*/

		sql = " SELECT DISTINCT(CSC_ETC1_CD) AS CSC_ETC1_CD, CSC_ETC2_NM";
		sql += " FROM CT_SP_COMMON";
		sql += " WHERE CSC_LARGE = 'HM06E'";
		sql += " AND CSC_LEVEL = '5'";
		sql += " ORDER BY CSC_ETC1_CD";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uItem_upSetCombobox_003 \n";
			G_INFO += "설명 : 특검 공통코드조회(공통대상 외) \n";
			G_INFO += "\n\n";
