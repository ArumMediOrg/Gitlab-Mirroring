...
<%
		...
		String STRTRACECD = htMethod.get("STRTRACECD");

		//
		if(RECE_NO == null) { RECE_NO = ""; }
		if(APPR_NO == null) { APPR_NO = ""; }
		if(STRTRACECD == null) { STRTRACECD = ""; }
		...
		sql += " AND RCR_TRACE_CD LIKE '%" + STRTRACECD + "%'";
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : ubt_raceVAN_BtnCancelSaveClick_001 \n";
			G_INFO += "설명 : 카드승인취소-기 승인취소 내역조회 \n";
			G_INFO += "\n\n";

			G_INFO += "전달인자 : \n";
			G_INFO += " RECE_NO : " + RECE_NO + " \n";
			G_INFO += " APPR_NO : " + APPR_NO + " \n";
			G_INFO += " STRTRACECD : " + STRTRACECD + " \n";
			G_INFO += "\n\n";
