 ...
 ORDER BY IEI_ITEM_SQ                      
		...
		*/
		...
		sql += " ORDER BY IEI_ITEM_SQ";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uMake_Excel_Apply_btnSrchPackClick_001 \n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='IEI_PACK_CD' rs:number='1' rs:writeunknown='true' rs:basetable='IT_EXCEL_ITEM' rs:basecolumn='IEI_PACK_CD'>
			<s:datatype dt:type='string' dt:maxLength='50' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='IEI_ITEM_CD' rs:number='2' rs:writeunknown='true' rs:basetable='IT_EXCEL_ITEM' rs:basecolumn='IEI_ITEM_CD'>
			<s:datatype dt:type='string' dt:maxLength='50' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='IEI_ITEM_NM' rs:number='3' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_EXCEL_ITEM'
			 rs:basecolumn='IEI_ITEM_NM'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='IEI_ITEM_SQ' rs:number='4' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_EXCEL_ITEM'
			 rs:basecolumn='IEI_ITEM_SQ'>
			<s:datatype dt:type='number' rs:dbtype='numeric' dt:maxLength='19' rs:scale='0' rs:precision='10' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='IEI_ITEM_KD' rs:number='5' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_EXCEL_ITEM'
			 rs:basecolumn='IEI_ITEM_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='IEI_INPT_ID' rs:number='6' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_EXCEL_ITEM'
			 rs:basecolumn='IEI_INPT_ID'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='IEI_INPT_DTT' rs:number='7' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_EXCEL_ITEM'
			 rs:basecolumn='IEI_INPT_DTT'>
			<s:datatype dt:type='dateTime' rs:dbtype='timestamp' dt:maxLength='16' rs:scale='0' rs:precision='19' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='IEI_MODI_ID' rs:number='8' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_EXCEL_ITEM'
			 rs:basecolumn='IEI_MODI_ID'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='IEI_MODI_DTT' rs:number='9' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_EXCEL_ITEM'
			 rs:basecolumn='IEI_MODI_DTT'>
			<s:datatype dt:type='dateTime' rs:dbtype='timestamp' dt:maxLength='16' rs:scale='0' rs:precision='19' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='IEI_COLM_DT' rs:number='10' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_EXCEL_ITEM'
			 rs:basecolumn='IEI_COLM_DT'>
			<s:datatype dt:type='string' dt:maxLength='30'/>
		</s:AttributeType>
		<s:AttributeType name='IEI_COLM_SQ' rs:number='11' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_EXCEL_ITEM'
			 rs:basecolumn='IEI_COLM_SQ'>
			<s:datatype dt:type='string' dt:maxLength='30'/>
		</s:AttributeType>
		<s:AttributeType name='IEI_TLBE_NM' rs:number='12' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_EXCEL_ITEM'
			 rs:basecolumn='IEI_TLBE_NM'>
			<s:datatype dt:type='string' dt:maxLength='30'/>
		</s:AttributeType>
		<s:AttributeType name='IEI_COMM_SP' rs:number='13' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_EXCEL_ITEM'
			 rs:basecolumn='IEI_COMM_SP'>
			<s:datatype dt:type='string' dt:maxLength='30'/>
		</s:AttributeType>
		<s:AttributeType name='ROWID' rs:number='14' rs:rowid='true' rs:writeunknown='true' rs:basetable='IT_EXCEL_ITEM'
