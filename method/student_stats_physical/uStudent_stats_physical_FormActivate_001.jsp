...
SELECT F_COMP_FIND(:MskEdtCOMP_CD) AS COMP_NM FROM DUAL 
		*/

		sql = " SELECT F_COMP_FIND('" + MSKEDTCOMP_CD + "') AS COMP_NM";
		sql += " FROM DUAL";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uStudent_stats_physical_FormActivate_001 \n";
			G_INFO += "설명 : 사업체정보 로딩 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='COMP_NM' rs:number='1' rs:nullable='true'>
