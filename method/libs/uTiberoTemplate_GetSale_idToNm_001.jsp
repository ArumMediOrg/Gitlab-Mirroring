...
SELECT IAU_PENL_NM FROM IT_AUTH_USER WHERE IAU_EMP_NO = :AParam1
		*/

		sql = " SELECT IAU_PENL_NM";
		sql += " FROM IT_AUTH_USER";
		sql += " WHERE IAU_EMP_NO = '" + APARAM1 + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uTiberoTemplate_GetSale_idToNm_001 \n";
			G_INFO += "설명 : 코드에 맞는 사용자명 추출 \n";
			G_INFO += "\n\n";
