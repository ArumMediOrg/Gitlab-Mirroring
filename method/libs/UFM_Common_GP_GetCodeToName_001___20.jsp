...
SELECT dbo.GetCOMMON_LvCdToNm('0803',:sValue,'5',1) SF_NAME from dual
		*/

		sql = " SELECT GETCOMMON_LVCDTONM('0803','" + SVALUE + "','5',1) SF_NAME";
		sql += " FROM DUAL";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : UFM_Common_GP_GetCodeToName_001___20 \n";
			G_INFO += "설명 : 이름값을 적절한 코드값으로 변환___20 \n";
			G_INFO += "\n\n";
