...
SELECT A.CSM_LARGE, A.CSM_MATT_CD, A.CSM_INJA_CD, C.CSC_FULL_NM AS CSM_INJA_NM, A.CSM_MATT_NM, B.CSC_ETC1_NM, B.CSC_ETC1_CD, B.CSC_ETC2_NM, B.CSC_ETC2_CD
  FROM CT_SP_MATTER A LEFT OUTER JOIN CT_SP_COMMON B ON A.CSM_COMM_CD = B.CSC_SMALL AND B.CSC_LARGE = 'HM99A'
		...
		*/
		...
		sql += " AND C.CSC_LARGE = 'HM06B'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uPostManagement_NEWCounseling_FormInit_001 \n";
			G_INFO += "설명 : 유해물질정보 로딩 \n";
			G_INFO += "\n\n";
