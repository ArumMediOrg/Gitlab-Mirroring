...
SELECT NVL(MAX(SUBSTR(BBC_BILL_NO,3,4)),0) Max_no FROM BT_BILL_COMP
WHERE  BBC_BILL_DT = :BILL_DT
  and  BBC_BILL_KD = :BILL_KD

		*/

		sql = " SELECT NVL(MAX(SUBSTR(BBC_BILL_NO,3,4)),0) MAX_NO";
		sql += " FROM BT_BILL_COMP";
		sql += " WHERE BBC_BILL_DT = '" + BILL_DT + "'";
		sql += " AND BBC_BILL_KD = '" + BILL_KD + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uIT_ChungGU_Move_Up_Insert_chungCmd_001 \n";
			G_INFO += "설명 : 사업장 청구정보 조회 \n";
			G_INFO += "\n\n";
