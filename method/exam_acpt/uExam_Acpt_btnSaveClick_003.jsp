...
<%
		...
		String CHA2_PK = htMethod.get("CHA2_PK");
		...
		sql = func_uExam_Acpt_btnSaveClick_003(stmtExec, htMethod);

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uExam_Acpt_btnSaveClick_003 \n";
			G_INFO += "설명 : 접수 저장 - 특검2차정보 저장 \n";
			G_INFO += "\n\n";
