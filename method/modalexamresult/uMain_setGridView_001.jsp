...
<%
		...
		String CHARTNO = htMethod.get("CHARTNO");
		...
		sql += " WHERE (EEA_CHART_NO = '" + CHARTNO + "') ";
		sql += " ORDER BY TO_DATE(EEA_EXAM_DT) DESC ";


			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uMain_setGridView_001 \n";
			G_INFO += "설명 : 차트번호에 대한 검진일자 리스트 획득 \n";
			G_INFO += "\n\n";

			G_INFO += "전달인자 : \n";
			G_INFO += " FROMDT : " + CHARTNO + " \n";
			G_INFO += " TODT : " + CHARTNO + " \n";
			G_INFO += " CHARTNO : " + CHARTNO + " \n";
			G_INFO += "\n\n";
