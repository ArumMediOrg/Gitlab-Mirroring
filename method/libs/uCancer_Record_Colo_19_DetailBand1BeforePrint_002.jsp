...
<%
    ...
    if (:g_Encrt_Kd = '1') then
      ...
      SELECT B.ICR_PENL_ID AS ICR_PENL_DE, 
                ...
                E.IAU_LICEN1_NO LICEN_NO3, E.IAU_PENL_NM LICEN_NM3, F.IAU_LICEN1_NO LICEN_NO4, F.IAU_PENL_NM LICEN_NM4 
      FROM ET_EXAM_ACPT A  
      ...
      LEFT OUTER JOIN ET_CANCER_COLO S ON 
                S.ECC_EXAM_DT = A.EEA_EXAM_DT AND 
                S.ECC_EXAM_SQ = A.EEA_EXAM_SQ 
      LEFT OUTER JOIN IT_AUTH_USER C ON 
                C.IAU_EMP_NO = S.ECC_LICEN_CD AND NVL(S.ECC_LICEN_CD, ' ') <> ' '
      LEFT OUTER JOIN IT_AUTH_USER D ON 
                D.IAU_EMP_NO = S.ECC_DECI_LICEN_CD AND NVL(S.ECC_DECI_LICEN_CD, ' ') <> ' '
      LEFT OUTER JOIN IT_AUTH_USER E ON 
                E.IAU_EMP_NO = S.ECC_CKUP_LICEN_CD AND NVL(S.ECC_CKUP_LICEN_CD, ' ') <> ' '  
      LEFT OUTER JOIN IT_AUTH_USER F ON 
                F.IAU_EMP_NO = S.ECC_PATH_LICEN_CD AND NVL(S.ECC_PATH_LICEN_CD, ' ') <> ' '  
      WHERE A.EEA_EXAM_DT = :EXAM_DT
		...
		*/
		...
		sql += " F_CODE_FIND('0908', A.EEA_CNTR_CD, '', '1') EEA_CNTR_NM, A.*, S.*, B.ICR_PENL_ID, C.IAU_LICEN1_NO LICEN_NO1, C.IAU_PENL_NM LICEN_NM1, D.IAU_LICEN1_NO LICEN_NO2, D.IAU_PENL_NM LICEN_NM2, E.IAU_LICEN1_NO LICEN_NO3, E.IAU_PENL_NM LICEN_NM3, F.IAU_LICEN1_NO LICEN_NO4, F.IAU_PENL_NM LICEN_NM4";
		...
		sql += " AND H.ECH_EXAM_SQ = A.EEA_EXAM_SQ LEFT OUTER JOIN ET_CANCER_COLO S";
		sql += " ON S.ECC_EXAM_DT = A.EEA_EXAM_DT";
		sql += " AND S.ECC_EXAM_SQ = A.EEA_EXAM_SQ LEFT OUTER JOIN IT_AUTH_USER C";
		sql += " ON C.IAU_EMP_NO = S.ECC_LICEN_CD";
		sql += " AND NVL(S.ECC_LICEN_CD, ' ') <> ' ' LEFT OUTER JOIN IT_AUTH_USER D";
		sql += " ON D.IAU_EMP_NO = S.ECC_DECI_LICEN_CD";
		sql += " AND NVL(S.ECC_DECI_LICEN_CD, ' ') <> ' ' LEFT OUTER JOIN IT_AUTH_USER E";
		sql += " ON E.IAU_EMP_NO = S.ECC_CKUP_LICEN_CD";
		sql += " AND NVL(S.ECC_CKUP_LICEN_CD, ' ') <> ' ' LEFT OUTER JOIN IT_AUTH_USER F";
		sql += " ON F.IAU_EMP_NO = S.ECC_PATH_LICEN_CD";
		sql += " AND NVL(S.ECC_PATH_LICEN_CD, ' ') <> ' '";
		sql += " WHERE A.EEA_EXAM_DT = '" + EXAM_DT + "'";
		sql += " AND A.EEA_EXAM_SQ = '" + EXAM_SQ + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCancer_Record_Colo_19_DetailBand1BeforePrint_002 \n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='ECC_EXAM_DT' rs:number='146' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_EXAM_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_EXAM_SQ' rs:number='147' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_EXAM_SQ'>
			<s:datatype dt:type='string' dt:maxLength='6'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_CFRM_CD' rs:number='148' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_CFRM_CD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_OBEX_DT' rs:number='149' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_OBEX_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_OBTP_KD' rs:number='150' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_OBTP_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_OBRT_CD' rs:number='151' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_OBRT_CD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_OBRT_VL' rs:number='152' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_OBRT_VL'>
			<s:datatype dt:type='string' dt:maxLength='6'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_OBVL_VL' rs:number='153' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_OBVL_VL'>
			<s:datatype dt:type='string' dt:maxLength='6'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_GIEX_DT' rs:number='154' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_GIEX_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_GIEX_KD' rs:number='155' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_GIEX_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_GIRT1_KD' rs:number='156' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_GIRT1_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_GIRT1S_KD' rs:number='157' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_GIRT1S_KD'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_GIRT2_KD' rs:number='158' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_GIRT2_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_GIRT2S_KD' rs:number='159' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_GIRT2S_KD'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_GIRT3_KD' rs:number='160' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_GIRT3_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_GIRT3S_KD' rs:number='161' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_GIRT3S_KD'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_GIPL_VL' rs:number='162' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_GIPL_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_GIETC_KD' rs:number='163' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_GIETC_KD'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_GIRT_EX' rs:number='164' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_GIRT_EX'>
			<s:datatype dt:type='string' dt:maxLength='40'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENEX_DT' rs:number='165' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENEX_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENRT1_KD' rs:number='166' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENRT1_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENRT1S_KD' rs:number='167' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENRT1S_KD'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENRT2_KD' rs:number='168' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENRT2_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENRT2S_KD' rs:number='169' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENRT2S_KD'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENRT3_KD' rs:number='170' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENRT3_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENRT3S_KD' rs:number='171' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENRT3S_KD'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENPL_VL' rs:number='172' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENPL_VL'>
			<s:datatype dt:type='string' dt:maxLength='3'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENPL_CT' rs:number='173' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENPL_CT'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENETC_KD' rs:number='174' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENETC_KD'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENRT_EX' rs:number='175' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENRT_EX'>
			<s:datatype dt:type='string' dt:maxLength='40'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_BIEX_YN' rs:number='176' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_BIEX_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_FOCP_KD' rs:number='177' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_FOCP_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_BIBF_KD' rs:number='178' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_BIBF_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_BICT_KD' rs:number='179' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_BICT_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_BIRT_KD' rs:number='180' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_BIRT_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_BICNCR_KD' rs:number='181' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_BICNCR_KD'>
			<s:datatype dt:type='string' dt:maxLength='13'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_BICNCR_EX' rs:number='182' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_BICNCR_EX'>
			<s:datatype dt:type='string' dt:maxLength='40'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_BIETC_KD' rs:number='183' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_BIETC_KD'>
			<s:datatype dt:type='string' dt:maxLength='5'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_BIETC_EX' rs:number='184' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_BIETC_EX'>
			<s:datatype dt:type='string' dt:maxLength='40'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_RSLT_KD' rs:number='185' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_RSLT_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ETC_EX' rs:number='186' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ETC_EX'>
			<s:datatype dt:type='string' dt:maxLength='40'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_STCN_YN' rs:number='187' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_STCN_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_RSLT_EX' rs:number='188' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_RSLT_EX'>
			<s:datatype dt:type='string' dt:maxLength='1200'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_RPT_DT' rs:number='189' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_RPT_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_CFRM_DT' rs:number='190' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_CFRM_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_LICEN_CD' rs:number='191' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_LICEN_CD'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_INPUT_DTT' rs:number='192' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_INPUT_DTT'>
			<s:datatype dt:type='dateTime' rs:dbtype='timestamp' dt:maxLength='16' rs:scale='0' rs:precision='19' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_INPUT_ID' rs:number='193' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_INPUT_ID'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_MODI_DTT' rs:number='194' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_MODI_DTT'>
			<s:datatype dt:type='dateTime' rs:dbtype='timestamp' dt:maxLength='16' rs:scale='0' rs:precision='19' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_MODI_ID' rs:number='195' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_MODI_ID'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENCE_KD' rs:number='196' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENCE_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_ENJJ_KD' rs:number='197' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_ENJJ_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_DECI_LICEN_CD' rs:number='198' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_DECI_LICEN_CD'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_CKUP_LICEN_CD' rs:number='199' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_CKUP_LICEN_CD'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_PATH_LICEN_CD' rs:number='200' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_PATH_LICEN_CD'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECC_FOCP_ADD_KD' rs:number='201' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ECC_FOCP_ADD_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ICR_PENL_ID' rs:number='202' rs:writeunknown='true' rs:basetable='IT_CUSTOMER' rs:basecolumn='ICR_PENL_ID'>
			<s:datatype dt:type='string' dt:maxLength='13' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='LICEN_NO1' rs:number='203' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
			 rs:basecolumn='IAU_LICEN1_NO'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='LICEN_NM1' rs:number='204' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
			 rs:basecolumn='IAU_PENL_NM'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='LICEN_NO2' rs:number='205' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
			 rs:basecolumn='IAU_LICEN1_NO'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='LICEN_NM2' rs:number='206' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
			 rs:basecolumn='IAU_PENL_NM'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='LICEN_NO3' rs:number='207' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
			 rs:basecolumn='IAU_LICEN1_NO'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='LICEN_NM3' rs:number='208' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
			 rs:basecolumn='IAU_PENL_NM'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='LICEN_NO4' rs:number='209' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
			 rs:basecolumn='IAU_LICEN1_NO'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='LICEN_NM4' rs:number='210' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
			 rs:basecolumn='IAU_PENL_NM'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='ROWID' rs:number='211' rs:rowid='true' rs:basetable='ET_EXAM_ACPT' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c211' rs:name='ROWID' rs:number='212' rs:rowid='true' rs:basetable='IT_CUSTOMER' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c212' rs:name='ROWID' rs:number='213' rs:rowid='true' rs:basetable='ET_CANCER_HEADER'
			 rs:basecolumn='ROWID' rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c213' rs:name='ROWID' rs:number='214' rs:rowid='true' rs:basetable='ET_CANCER_COLO'
			 rs:basecolumn='ROWID' rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c214' rs:name='ROWID' rs:number='215' rs:rowid='true' rs:basetable='IT_AUTH_USER' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c215' rs:name='ROWID' rs:number='216' rs:rowid='true' rs:basetable='IT_AUTH_USER' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c216' rs:name='ROWID' rs:number='217' rs:rowid='true' rs:basetable='IT_AUTH_USER' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c217' rs:name='ROWID' rs:number='218' rs:rowid='true' rs:basetable='IT_AUTH_USER' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
...
<%
		...
		while(cRsList.next()) {
			...
			String LICEN_NO3_T = cRsList.getString("LICEN_NO3");
			String LICEN_NM3_T = cRsList.getString("LICEN_NM3");
			String LICEN_NO4_T = cRsList.getString("LICEN_NO4");
			String LICEN_NM4_T = cRsList.getString("LICEN_NM4");
			String ROWID_T = cRsList.getString("ROWID");
			String c211_T = cRsList.getString("c211");
			String c212_T = cRsList.getString("c212");
			String c213_T = cRsList.getString("c213");
			String c214_T = cRsList.getString("c214");
			String c215_T = cRsList.getString("c215");
			String c216_T = cRsList.getString("c216");
			String c217_T = cRsList.getString("c217");
%>
			<z:row
<%
...
<%
			...
			if(! LICEN_NO3_T.equals("")) {
%>
		 		LICEN_NO3='<%= LICEN_NO3_T%>'
<%
			}

			if(! LICEN_NM3_T.equals("")) {
%>
		 		LICEN_NM3='<%= LICEN_NM3_T%>'
<%
			}

			if(! LICEN_NO4_T.equals("")) {
%>
		 		LICEN_NO4='<%= LICEN_NO4_T%>'
<%
			}

			if(! LICEN_NM4_T.equals("")) {
%>
		 		LICEN_NM4='<%= LICEN_NM4_T%>'
<%
			}
%>
				ROWID='<%= cnt%>'
