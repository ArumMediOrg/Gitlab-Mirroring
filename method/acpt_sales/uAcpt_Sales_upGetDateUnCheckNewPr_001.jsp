...
<%
		...
		sql = " SELECT A.ERI_EXAM_DT, NVL(SUM(B.ITEM_PR),0) NEW_UNCHECK_PR FROM ET_RSLT_ITEM A ";
		sql += " INNER JOIN ";
		...
		sql += " GROUP BY A.ERI_EXAM_DT ";


			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uAcpt_Sales_upGetDateUnCheckNewPr_001 \n";
			G_INFO += "설명 : 일자별 일반검진 미검수가 조회 \n";
			G_INFO += "\n\n";
