...
select icr_penl_id, icr_penl_nm, icr_pid_en
  from it_customer
 where icr_cust_no = :cust_no

		*/

		sql = " SELECT ICR_PENL_ID, ICR_PENL_NM, ICR_PID_EN";
		sql += " FROM IT_CUSTOMER";
		sql += " WHERE ICR_CUST_NO = '" + CUST_NO + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uBusinessTrip_btnUpLoadClick_002 \n";
			G_INFO += "설명 : 고객정보 로딩 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='ICR_PID_EN' rs:number='3' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_CUSTOMER'
