...
<%
		...
		String IIQ_ITEM_CD = htMethod.get("IIQ_ITEM_CD");

		//
		if(EXAM_DT == null) { EXAM_DT = ""; }
		if(EXAM_SQ == null) { EXAM_SQ = ""; }
		if(ITEM_CD == null) { ITEM_CD = ""; }
		if(IIQ_ITEM_CD == null) { IIQ_ITEM_CD = ""; }
...
SELECT NVL(B.QQN_RESULT,'0') QQN_RESULT,A.IIQ_ITQU_LV1, A.IIQ_ITQU_LV2, A.IIQ_ITQU_SQ,      
       C.CQN_QSTN_CD, C.CQN_QSKD_CD, C.CQN_QSTN_SQ,                                              
 ...
 WHERE A.IIQ_ITEM_CD = :ITEM_CD
   AND A.IIQ_APLY_DT = GetITEM_QUESTION_ApplyDate(:IIQ_ITEM_CD, QQN_EXAM_DT)                    
   AND A.IIQ_USE_YN = 'Y'                                                                      
 ORDER BY A.IIQ_SORT_NO                                                                          

		*/

		sql = " SELECT NVL(B.QQN_RESULT,'0') QQN_RESULT,A.IIQ_ITQU_LV1, A.IIQ_ITQU_LV2, A.IIQ_ITQU_SQ, C.CQN_QSTN_CD, C.CQN_QSKD_CD, C.CQN_QSTN_SQ, C.CQN_QSTN_LV, C.CQN_QSTN_NM, C.CQN_ANSR_CD, C.CQN_ANSE_EX, C.CQN_QSTN_CP, C.CQN_DEFULT, CASE WHEN C.CQN_ANSR_CD IS NULL";
		sql += " OR C.CQN_ANSR_CD = '' THEN C.CQN_ANSR_CD ELSE C.CQN_ANSR_CD || '-' || GETCOMMON_LVCDTONM('0415',C.CQN_ANSR_CD,'5',1) END CQN_ANSR_NM, C.CQN_SCOR_YN, C.CQN_SCOR_CNT, C.CQN_SCOR_NO, C.CQN_SCOR_SCR, B.QQN_SCORE_YN, B.QQN_SCORE";
		sql += " FROM IT_ITEM_QUESTION A INNER JOIN QT_QUESTION B";
		...
		sql += " AND A.IIQ_APLY_DT = GETITEM_QUESTION_APPLYDATE('" + IIQ_ITEM_CD + "', QQN_EXAM_DT)";
		sql += " AND A.IIQ_USE_YN = 'Y'";
		sql += " ORDER BY A.IIQ_SORT_NO";
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uHealthCjk_Prnt_19_DetailBand1BeforePrint_004 \n";
			G_INFO += "설명 : 노인기능 평가 \n";
			G_INFO += "\n\n";
			...
			G_INFO += " IIQ_ITEM_CD : " + IIQ_ITEM_CD + " \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='IIQ_ITQU_LV1' rs:number='2' rs:writeunknown='true' rs:basetable='IT_ITEM_QUESTION' rs:basecolumn='IIQ_ITQU_LV1'>
			<s:datatype dt:type='string' dt:maxLength='2' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='IIQ_ITQU_LV2' rs:number='3' rs:writeunknown='true' rs:basetable='IT_ITEM_QUESTION' rs:basecolumn='IIQ_ITQU_LV2'>
			<s:datatype dt:type='string' dt:maxLength='2' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='IIQ_ITQU_SQ' rs:number='4' rs:writeunknown='true' rs:basetable='IT_ITEM_QUESTION' rs:basecolumn='IIQ_ITQU_SQ'>
			<s:datatype dt:type='number' rs:dbtype='numeric' dt:maxLength='19' rs:scale='0' rs:precision='10' rs:fixedlength='true'
			 rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='CQN_QSTN_CD' rs:number='5' rs:nullable='true' rs:writeunknown='true' rs:basetable='CT_QUESTION'
			 rs:basecolumn='CQN_QSTN_CD'>
			<s:datatype dt:type='number' rs:dbtype='numeric' dt:maxLength='19' rs:scale='0' rs:precision='10' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='CQN_QSKD_CD' rs:number='6' rs:nullable='true' rs:writeunknown='true' rs:basetable='CT_QUESTION'
			 rs:basecolumn='CQN_QSKD_CD'>
			<s:datatype dt:type='string' dt:maxLength='4'/>
		</s:AttributeType>
		<s:AttributeType name='CQN_QSTN_SQ' rs:number='7' rs:nullable='true' rs:writeunknown='true' rs:basetable='CT_QUESTION'
			 rs:basecolumn='CQN_QSTN_SQ'>
			<s:datatype dt:type='number' rs:dbtype='numeric' dt:maxLength='19' rs:scale='0' rs:precision='10' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='CQN_QSTN_LV' rs:number='8' rs:nullable='true' rs:writeunknown='true' rs:basetable='CT_QUESTION'
			 rs:basecolumn='CQN_QSTN_LV'>
			<s:datatype dt:type='string' dt:maxLength='4'/>
		</s:AttributeType>
		<s:AttributeType name='CQN_QSTN_NM' rs:number='9' rs:nullable='true' rs:writeunknown='true' rs:basetable='CT_QUESTION'
			 rs:basecolumn='CQN_QSTN_NM'>
			<s:datatype dt:type='string' dt:maxLength='500'/>
		</s:AttributeType>
		<s:AttributeType name='CQN_ANSR_CD' rs:number='10' rs:nullable='true' rs:writeunknown='true' rs:basetable='CT_QUESTION'
		...
		<s:AttributeType name='CQN_QSTN_CP' rs:number='12' rs:nullable='true' rs:writeunknown='true' rs:basetable='CT_QUESTION'
