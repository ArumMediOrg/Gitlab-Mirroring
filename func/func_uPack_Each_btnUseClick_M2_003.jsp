...
<%!
	public String func_uPack_Each_btnUseClick_M2_003(Statement argStmtExec, HashMap argHtMethod) throws Exception {
		...
		try {
			...
			sql += "  EPO_USE_YN = 'N'";
			sql += ", EPO_NUSE_ID = '" + NUSE_ID + "'";
			sql += ", EPO_NUSE_DTT = SYSDATE";
