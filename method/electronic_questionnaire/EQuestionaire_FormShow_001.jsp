...
Select IHL_HOSP_NO, IHL_VIEWER_PATH From it_hospital
		*/

		sql = " SELECT IHL_HOSP_NO, IHL_VIEWER_PATH";
		sql += " FROM IT_HOSPITAL";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : EQuestionaire_FormShow_001 \n";
			G_INFO += "설명 : 병원정보 조회 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='IHL_VIEWER_PATH' rs:number='2' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_HOSPITAL'
