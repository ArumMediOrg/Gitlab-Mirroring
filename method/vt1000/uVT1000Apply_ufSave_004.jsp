...
<%
		...
		String MARK2_CLASS = htMethod.get("MARK2_CLASS");
		String VIEW2_CD1 = htMethod.get("VIEW2_CD1");
		String VIEW2_CD2 = htMethod.get("VIEW2_CD2");
		String VIEW2_CD3 = htMethod.get("VIEW2_CD3");
		String VIEW2_CD4 = htMethod.get("VIEW2_CD4");
		String VIEW2_CD5 = htMethod.get("VIEW2_CD5");
		String VIEW2_CD6 = htMethod.get("VIEW2_CD6");
		String VIEW2_NO = htMethod.get("VIEW2_NO");
		...
		sql = func_uVT1000Apply_ufSave_004(stmtExec, htMethod);

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uVT1000Apply_ufSave_004 \n";
			G_INFO += "설명 : 검사정보 수정 \n";
			G_INFO += "\n\n";
			...
			G_INFO += " MARK2_CLASS : " + MARK2_CLASS + " \n";
			G_INFO += " VIEW2_CD1 : " + VIEW2_CD1 + " \n";
			G_INFO += " VIEW2_CD2 : " + VIEW2_CD2 + " \n";
			G_INFO += " VIEW2_CD3 : " + VIEW2_CD3 + " \n";
			G_INFO += " VIEW2_CD4 : " + VIEW2_CD4 + " \n";
			G_INFO += " VIEW2_CD5 : " + VIEW2_CD5 + " \n";
			G_INFO += " VIEW2_CD6 : " + VIEW2_CD6 + " \n";
			G_INFO += " VIEW2_NO : " + VIEW2_NO + " \n";
			G_INFO += "\n\n";
