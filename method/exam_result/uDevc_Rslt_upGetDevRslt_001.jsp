...
select eea_inpt_id from et_exam_acpt
 Where EEA_EXAM_DT = :EXAM_DT
  And  EEA_EXAM_SQ = :EXAM_DT
		*/

		sql = " SELECT EEA_INPT_ID";
		...
		sql += " AND EEA_EXAM_SQ = '" + EXAM_SQ + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uDevc_Rslt_upGetDevRslt_001 \n";
			G_INFO += "설명 : 장비결과조회(자료변환 유무확인) \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='EEA_INPT_ID' rs:number='1' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_EXAM_ACPT'
