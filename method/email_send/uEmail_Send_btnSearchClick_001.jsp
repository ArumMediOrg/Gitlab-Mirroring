...
<%
		...
		sql += " f_tel_format(A.EEA_MOBL_NO) EEA_MOBL_NO, A.EEA_HTSB_YN, E.ECH_CFRM_CD, F.EDP_PANJ_YN, G.ERL_SUCC_YN,";
		sql += " CASE WHEN NVL(TO_CHAR(G.ERL_SEND_DTT), ' ' ) = ' ' THEN ' ' ELSE TO_CHAR(G.ERL_SEND_DTT) END SEND_DTT";
