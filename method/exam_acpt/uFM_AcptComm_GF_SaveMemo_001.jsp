...
<%
		...
		String RSVT_TX = htMethod.get("RSVT_TX");
		...
		sql = func_uFM_AcptComm_GF_SaveMemo_001(stmtExec, htMethod);

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uFM_AcptComm_GF_SaveMemo_001 \n";
			G_INFO += "설명 : 메모저장(Insert/Update) \n";
			G_INFO += "\n\n";
