...
<%
		...
		String CBNOUSE_PT = htMethod.get("CBNOUSE_PT");

		//
		if(CBSRCH_VW == null) { CBSRCH_VW = ""; }
		if(SSRCH_KD == null) { SSRCH_KD = ""; }
		if(CBNOUSE_PT == null) { CBNOUSE_PT = ""; }

		// DB객체
		stmtList = connect.createStatement();

		sql = " SELECT EPM_MARK_CD, EPM_MARK_SQ, EPM_USE_YN, EPM_INPT_ID, EPM_MODI_ID, ";
		sql += " F_CODE_FIND('0404', EPM_MARK_CD, '', '1') AS EPM_MARK_NM, EPM_MARK_TNM ";
		...
		sql += " ORDER BY EPM_MARK_CD, EPM_MARK_SQ";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uPack_Mark_btnSearchClick_002 \n";
			G_INFO += "설명 : 표적묶음정보 로딩 \n";
			G_INFO += "\n\n";
