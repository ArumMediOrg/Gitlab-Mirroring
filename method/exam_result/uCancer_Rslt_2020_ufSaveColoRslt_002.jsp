...
<%
		...
		String OBEX_DT = htMethod.get("OBEX_DT");
		String OBTP_KD = htMethod.get("OBTP_KD");
		String OBRT_CD = htMethod.get("OBRT_CD");
		String OBRT_VL = htMethod.get("OBRT_VL");
		String OBVL_VL = htMethod.get("OBVL_VL");
		...
		String GIPL_VL = htMethod.get("GIPL_VL");
		...
		String ENCE_KD = htMethod.get("ENCE_KD");
		String ENJJ_KD = htMethod.get("ENJJ_KD");
		String ENPL_VL = htMethod.get("ENPL_VL");
		String ENPL_CT = htMethod.get("ENPL_CT");
		...
		String FOCP_ADD_KD = htMethod.get("FOCP_ADD_KD");
		String BIBF_KD = htMethod.get("BIBF_KD");
		...
		sql = func_uCancer_Rslt_2020_ufSaveColoRslt_002(stmtExec, htMethod);

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCancer_Rslt_2020_ufSaveColoRslt_002 \n";
			G_INFO += "설명 : 대장암 결과판정 저장(insert,update) \n";
			G_INFO += "\n\n";
			...
			G_INFO += " OBEX_DT : " + OBEX_DT + " \n";
			G_INFO += " OBTP_KD : " + OBTP_KD + " \n";
			G_INFO += " OBRT_CD : " + OBRT_CD + " \n";
			G_INFO += " OBRT_VL : " + OBRT_VL + " \n";
			G_INFO += " OBVL_VL : " + OBVL_VL + " \n";
			...
			G_INFO += " ENCE_KD : " + ENCE_KD + " \n";
			G_INFO += " ENJJ_KD : " + ENJJ_KD + " \n";
			G_INFO += " ENPL_VL : " + ENPL_VL + " \n";
			G_INFO += " ENPL_CT : " + ENPL_CT + " \n";
			G_INFO += " ENETC_KD : " + ENETC_KD + " \n";
			G_INFO += " ENRT_EX : " + ENRT_EX + " \n";
			G_INFO += " BIEX_YN : " + BIEX_YN + " \n";
			G_INFO += " FOCP_KD : " + FOCP_KD + " \n";
			G_INFO += " FOCP_ADD_KD : " + FOCP_ADD_KD + " \n";
			G_INFO += " BIBF_KD : " + BIBF_KD + " \n";
