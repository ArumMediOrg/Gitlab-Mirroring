...
Select IIM_ITEM_CD, IIM_SBCD_CD, IIM_SNME_NM, IIM_RSLT_KD From IT_ITEM
 Where IIM_ITEM_CD = :ITEM_CD
   And IIM_RSLT_KD in ('6', '7')

		*/

		sql = " SELECT IIM_ITEM_CD, IIM_SBCD_CD, IIM_SNME_NM, IIM_RSLT_KD";
		sql += " FROM IT_ITEM";
		sql += " WHERE IIM_ITEM_CD = '" + ITEM_CD + "'";
		sql += " AND IIM_RSLT_KD IN ('6', '7')";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_Health_GirdSPITEMClickCell_001 \n";
			G_INFO += "설명 : 검사항목조회(결과종류 조건 추가) \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='IIM_SNME_NM' rs:number='3' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_ITEM'
			 rs:basecolumn='IIM_SNME_NM'>
			<s:datatype dt:type='string' dt:maxLength='200'/>
		</s:AttributeType>
		<s:AttributeType name='IIM_RSLT_KD' rs:number='4' rs:writeunknown='true' rs:basetable='IT_ITEM' rs:basecolumn='IIM_RSLT_KD'>
