...
Select (EPK_EXAM_CD || EPK_PACK_SQ) Exam_Cd, EPK_PACK_NM, EPK_PACK_SQ From ET_PACK
 Where EPK_EXAM_CD Like '91%'
  And EPK_USE_YN = 'Y'
		*/

		sql = " SELECT (EPK_EXAM_CD || EPK_PACK_SQ) EXAM_CD, EPK_PACK_NM, EPK_PACK_SQ";
		sql += " FROM ET_PACK";
		sql += " WHERE EPK_EXAM_CD LIKE '91%'";
		sql += " AND EPK_USE_YN = 'Y'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCOMP_CNRT_XML_COM_005 \n";
			G_INFO += "설명 : 기타검사(묶움) 조회(옵션대상) \n";
			G_INFO += "\n\n";
