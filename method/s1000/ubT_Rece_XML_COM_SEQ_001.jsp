...
select NVL(Max(RRM_RECE_SEQ),0) Max_no from RT_RECE_MEDICHK WHERE RRM_RECE_NO = :RECE_NO
		*/

		sql = " SELECT NVL(MAX(TO_NUMBER(RRM_RECE_SEQ)),0) MAX_NO";
		sql += " FROM RT_RECE_MEDICHK";
		sql += " WHERE RRM_RECE_NO = '" + RECE_NO + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : ubT_Rece_XML_COM_SEQ_001 \n";
			G_INFO += "설명 : 수납번호 최종순번 조회 \n";
			G_INFO += "\n\n";
