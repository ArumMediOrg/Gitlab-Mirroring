...
<%
    ...
    A.*, S.*, B.ICR_PENL_ID, G.IAU_LICEN1_NO EEA_STOMA_NO, G.IAU_PENL_NM EEA_STOMA_NM, 
    ...
    E.IAU_LICEN1_NO LICEN_NO3, E.IAU_PENL_NM LICEN_NM3, F.IAU_LICEN1_NO LICEN_NO4, F.IAU_PENL_NM LICEN_NM4 
     ...
     LEFT OUTER JOIN ET_CANCER_STMC S ON 
        S.ECS_EXAM_DT = A.EEA_EXAM_DT AND 
        S.ECS_EXAM_SQ = A.EEA_EXAM_SQ 
     LEFT OUTER JOIN IT_AUTH_USER C ON 
        C.IAU_EMP_NO = S.ECS_LICEN_CD AND NVL(S.ECS_LICEN_CD, ' ') <> ' '  
     LEFT OUTER JOIN IT_AUTH_USER D ON 
        D.IAU_EMP_NO = S.ECS_DECI_LICEN_CD AND NVL(S.ECS_DECI_LICEN_CD, ' ') <> ' '  
     LEFT OUTER JOIN IT_AUTH_USER E ON
        E.IAU_EMP_NO = S.ECS_CKUP_LICEN_CD AND NVL(S.ECS_CKUP_LICEN_CD, ' ') <> ' '
     LEFT OUTER JOIN IT_AUTH_USER F ON 
        F.IAU_EMP_NO = S.ECS_PATH_LICEN_CD AND NVL(S.ECS_PATH_LICEN_CD, ' ') <> ' '
     LEFT OUTER JOIN IT_AUTH_USER G ON 
        G.IAU_EMP_NO = A.EEA_STOMA_DR AND NVL(A.EEA_STOMA_DR, ' ') <> ' '  
     WHERE A.EEA_EXAM_DT = :EXAM_DT 
		...
		*/
		...
		if(G_ENCRT_KD.equals("1")) {
			...
			sql = " SELECT ECHELONDB.ECL_DECRYPT(B.ICR_PID_EN) AS ICR_PENL_DE,";
		} else {
			sql = " SELECT B.ICR_PENL_ID AS ICR_PENL_DE,";
		}

		sql += " F_CODE_FIND('0908', A.EEA_CNTR_CD, '', '1') EEA_CNTR_NM, A.*, S.*, B.ICR_PENL_ID, G.IAU_LICEN1_NO EEA_STOMA_NO, G.IAU_PENL_NM EEA_STOMA_NM, C.IAU_LICEN1_NO LICEN_NO1, C.IAU_PENL_NM LICEN_NM1, D.IAU_LICEN1_NO LICEN_NO2, D.IAU_PENL_NM LICEN_NM2, E.IAU_LICEN1_NO LICEN_NO3, E.IAU_PENL_NM LICEN_NM3, F.IAU_LICEN1_NO LICEN_NO4, F.IAU_PENL_NM LICEN_NM4";
		...
		sql += " AND H.ECH_EXAM_SQ = A.EEA_EXAM_SQ LEFT OUTER JOIN ET_CANCER_STMC S";
		sql += " ON S.ECS_EXAM_DT = A.EEA_EXAM_DT";
		sql += " AND S.ECS_EXAM_SQ = A.EEA_EXAM_SQ LEFT OUTER JOIN IT_AUTH_USER C";
		sql += " ON C.IAU_EMP_NO = S.ECS_LICEN_CD";
		sql += " AND NVL(S.ECS_LICEN_CD, ' ') <> ' ' LEFT OUTER JOIN IT_AUTH_USER D";
		sql += " ON D.IAU_EMP_NO = S.ECS_DECI_LICEN_CD";
		sql += " AND NVL(S.ECS_DECI_LICEN_CD, ' ') <> ' ' LEFT OUTER JOIN IT_AUTH_USER E";
		sql += " ON E.IAU_EMP_NO = S.ECS_CKUP_LICEN_CD";
		sql += " AND NVL(S.ECS_CKUP_LICEN_CD, ' ') <> ' ' LEFT OUTER JOIN IT_AUTH_USER F";
		sql += " ON F.IAU_EMP_NO = S.ECS_PATH_LICEN_CD";
		sql += " AND NVL(S.ECS_PATH_LICEN_CD, ' ') <> ' ' LEFT OUTER JOIN IT_AUTH_USER G";
		sql += " ON G.IAU_EMP_NO = A.EEA_STOMA_DR";
		sql += " AND NVL(A.EEA_STOMA_DR, ' ') <> ' '";
		sql += " WHERE A.EEA_EXAM_DT = '" + EXAM_DT + "'";
		sql += " AND A.EEA_EXAM_SQ = '" + EXAM_SQ + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCancer_Record_Stmc_19_DetailBand1BeforePrint_002 \n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='ECS_EXAM_DT' rs:number='146' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_EXAM_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_EXAM_SQ' rs:number='147' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_EXAM_SQ'>
			<s:datatype dt:type='string' dt:maxLength='6'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_CFRM_CD' rs:number='148' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_CFRM_CD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_GIEX_DT' rs:number='149' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_GIEX_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_GIEX_KD' rs:number='150' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_GIEX_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_GIRT1_KD' rs:number='151' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_GIRT1_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_GIRT1S_KD' rs:number='152' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_GIRT1S_KD'>
			<s:datatype dt:type='string' dt:maxLength='8'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_GIRT2_KD' rs:number='153' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_GIRT2_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_GIRT2S_KD' rs:number='154' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_GIRT2S_KD'>
			<s:datatype dt:type='string' dt:maxLength='8'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_GIRT3_KD' rs:number='155' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_GIRT3_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_GIRT3S_KD' rs:number='156' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_GIRT3S_KD'>
			<s:datatype dt:type='string' dt:maxLength='8'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_GIETC_KD' rs:number='157' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_GIETC_KD'>
			<s:datatype dt:type='string' dt:maxLength='8'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_GIRT_EX' rs:number='158' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_GIRT_EX'>
			<s:datatype dt:type='string' dt:maxLength='40'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_ENEX_DT' rs:number='159' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_ENEX_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_ENRT1_KD' rs:number='160' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_ENRT1_KD'>
			<s:datatype dt:type='string' dt:maxLength='2'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_ENRT1S_KD' rs:number='161' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_ENRT1S_KD'>
			<s:datatype dt:type='string' dt:maxLength='8'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_ENRT2_KD' rs:number='162' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_ENRT2_KD'>
			<s:datatype dt:type='string' dt:maxLength='2'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_ENRT2S_KD' rs:number='163' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_ENRT2S_KD'>
			<s:datatype dt:type='string' dt:maxLength='8'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_ENRT3_KD' rs:number='164' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_ENRT3_KD'>
			<s:datatype dt:type='string' dt:maxLength='2'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_ENRT3S_KD' rs:number='165' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_ENRT3S_KD'>
			<s:datatype dt:type='string' dt:maxLength='8'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_ENETC_KD' rs:number='166' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_ENETC_KD'>
			<s:datatype dt:type='string' dt:maxLength='8'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_ENRT_EX' rs:number='167' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_ENRT_EX'>
			<s:datatype dt:type='string' dt:maxLength='40'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_BIEX_YN' rs:number='168' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_BIEX_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_FOCP_KD' rs:number='169' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_FOCP_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_BIRT_KD' rs:number='170' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_BIRT_KD'>
			<s:datatype dt:type='string' dt:maxLength='2'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_BICT_KD' rs:number='171' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_BICT_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_BICNCR_KD' rs:number='172' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_BICNCR_KD'>
			<s:datatype dt:type='string' dt:maxLength='14'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_BICNCR_EX' rs:number='173' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_BICNCR_EX'>
			<s:datatype dt:type='string' dt:maxLength='40'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_BIETC_KD' rs:number='174' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_BIETC_KD'>
			<s:datatype dt:type='string' dt:maxLength='8'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_BIETC_EX' rs:number='175' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_BIETC_EX'>
			<s:datatype dt:type='string' dt:maxLength='40'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_RSLT_KD' rs:number='176' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_RSLT_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_STCN_YN' rs:number='177' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_STCN_YN'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_ETC_EX' rs:number='178' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_ETC_EX'>
			<s:datatype dt:type='string' dt:maxLength='40'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_RSLT_EX' rs:number='179' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_RSLT_EX'>
			<s:datatype dt:type='string' dt:maxLength='1200'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_RPT_DT' rs:number='180' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_RPT_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_CFRM_DT' rs:number='181' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_CFRM_DT'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_LICEN_CD' rs:number='182' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_LICEN_CD'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_INPUT_DTT' rs:number='183' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_INPUT_DTT'>
			<s:datatype dt:type='dateTime' rs:dbtype='timestamp' dt:maxLength='16' rs:scale='0' rs:precision='19' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_INPUT_ID' rs:number='184' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_INPUT_ID'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_MODI_DTT' rs:number='185' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_MODI_DTT'>
			<s:datatype dt:type='dateTime' rs:dbtype='timestamp' dt:maxLength='16' rs:scale='0' rs:precision='19' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_MODI_ID' rs:number='186' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_MODI_ID'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_DECI_LICEN_CD' rs:number='187' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_DECI_LICEN_CD'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_CKUP_LICEN_CD' rs:number='188' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_CKUP_LICEN_CD'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_PATH_LICEN_CD' rs:number='189' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_PATH_LICEN_CD'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='ECS_GICM_KD' rs:number='190' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ECS_GICM_KD'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='ICR_PENL_ID' rs:number='191' rs:writeunknown='true' rs:basetable='IT_CUSTOMER' rs:basecolumn='ICR_PENL_ID'>
			<s:datatype dt:type='string' dt:maxLength='13' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='EEA_STOMA_NO' rs:number='192' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
			 rs:basecolumn='IAU_LICEN1_NO'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='EEA_STOMA_NM' rs:number='193' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
			 rs:basecolumn='IAU_PENL_NM'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='LICEN_NO1' rs:number='194' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
			 rs:basecolumn='IAU_LICEN1_NO'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='LICEN_NM1' rs:number='195' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
			 rs:basecolumn='IAU_PENL_NM'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='LICEN_NO2' rs:number='196' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
			 rs:basecolumn='IAU_LICEN1_NO'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='LICEN_NM2' rs:number='197' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
			 rs:basecolumn='IAU_PENL_NM'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='LICEN_NO3' rs:number='198' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
			 rs:basecolumn='IAU_LICEN1_NO'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='LICEN_NM3' rs:number='199' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
			 rs:basecolumn='IAU_PENL_NM'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='LICEN_NO4' rs:number='200' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
			 rs:basecolumn='IAU_LICEN1_NO'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='LICEN_NM4' rs:number='201' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
			 rs:basecolumn='IAU_PENL_NM'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='ROWID' rs:number='202' rs:rowid='true' rs:basetable='ET_EXAM_ACPT' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c202' rs:name='ROWID' rs:number='203' rs:rowid='true' rs:basetable='IT_CUSTOMER' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c203' rs:name='ROWID' rs:number='204' rs:rowid='true' rs:basetable='ET_CANCER_HEADER'
			 rs:basecolumn='ROWID' rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c204' rs:name='ROWID' rs:number='205' rs:rowid='true' rs:basetable='ET_CANCER_STMC'
			 rs:basecolumn='ROWID' rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		...
		<s:AttributeType name='c206' rs:name='ROWID' rs:number='207' rs:rowid='true' rs:basetable='IT_AUTH_USER' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c207' rs:name='ROWID' rs:number='208' rs:rowid='true' rs:basetable='IT_AUTH_USER' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c208' rs:name='ROWID' rs:number='209' rs:rowid='true' rs:basetable='IT_AUTH_USER' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c209' rs:name='ROWID' rs:number='210' rs:rowid='true' rs:basetable='IT_AUTH_USER' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
...
<%
		...
		while(cRsList.next()) {
			...
			String EEA_STOMA_NO_T = cRsList.getString("EEA_STOMA_NO");
			...
			String c206_T = cRsList.getString("c206");
			String c207_T = cRsList.getString("c207");
			String c208_T = cRsList.getString("c208");
			String c209_T = cRsList.getString("c209");
%>
			<z:row
<%
...
<%
			...
			if(! EEA_STOMA_NO_T.equals("")) {
%>
		 		EEA_STOMA_NO='<%= EEA_STOMA_NO_T%>'
<%
			}
