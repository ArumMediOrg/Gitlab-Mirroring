...
SELECT BEI_ITEM_CD, BEI_ITEM_PR, BEI_ESTI_PR FROM BT_ESTI_PROF_ITEM
 WHERE BEI_MNGT_YR = :MNGT_YR 
   AND BEI_ESTI_CD = :ESTI_CD
   AND BEI_PROF_SQ <> :PROF_SQ
 GROUP BY BEI_ITEM_CD, BEI_ITEM_PR, BEI_ESTI_PR                    
		...
		*/
		...
		sql += " GROUP BY BEI_ITEM_CD, BEI_ITEM_PR, BEI_ESTI_PR";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uBT_ESTI_PROF_APPLY_FormShow_002 \n";
			G_INFO += "설명 : 검진유형관리 로딩 \n";
			G_INFO += "\n\n";
