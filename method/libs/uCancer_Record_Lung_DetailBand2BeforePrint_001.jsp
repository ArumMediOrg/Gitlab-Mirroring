...
<%
    ...
    if (:g_Encrt_Kd = '1') then
      ...
      LEFT OUTER JOIN IT_AUTH_USER C ON 
             C.IAU_EMP_NO = S.ECG_AFTE_LICEN_CD AND NVL(S.ECG_AFTE_LICEN_CD, ' ') <> ' '
      WHERE A.EEA_EXAM_DT = :EXAM_DT
		...
		*/
		...
		sql += " F_CODE_FIND('0908', A.EEA_CNTR_CD, '', '1') EEA_CNTR_NM, A.*, S.*, B.ICR_PENL_ID, C.IAU_LICEN1_NO LICEN_NO1, C.IAU_PENL_NM LICEN_NM1";
		...
		sql += " ON C.IAU_EMP_NO = S.ECG_AFTE_LICEN_CD";
		sql += " AND NVL(S.ECG_AFTE_LICEN_CD, ' ') <> ' '";
		sql += " WHERE A.EEA_EXAM_DT = '" + EXAM_DT + "'";
		sql += " AND A.EEA_EXAM_SQ = '" + EXAM_SQ + "'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCancer_Record_Lung_DetailBand2BeforePrint_001 \n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='ROWID' rs:number='233' rs:rowid='true' rs:basetable='ET_EXAM_ACPT' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c233' rs:name='ROWID' rs:number='234' rs:rowid='true' rs:basetable='IT_CUSTOMER' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c234' rs:name='ROWID' rs:number='235' rs:rowid='true' rs:basetable='ET_CANCER_HEADER'
			 rs:basecolumn='ROWID' rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c235' rs:name='ROWID' rs:number='236' rs:rowid='true' rs:basetable='ET_CANCER_LUNG'
			 rs:basecolumn='ROWID' rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c236' rs:name='ROWID' rs:number='237' rs:rowid='true' rs:basetable='IT_AUTH_USER' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
...
<%
		...
		while(cRsList.next()) {
			...
			String c233_T = cRsList.getString("c233");
			String c234_T = cRsList.getString("c234");
