...
SELECT DISTINCT CSP_SBCD_CD FROM CT_SP_PROF
WHERE CSP_JJ_CD IN (:JJ_CD) AND CSP_USE_YN = 'Y'
|| :sSQL_ADD
		*/
		...
		sql += SSQL_ADD;
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCOMP_DEPT_APPLY_UP_ListToITEMGird_001 \n";
			G_INFO += "설명 : 특수검진 표적장기 표준코드 조회 \n";
			G_INFO += "\n\n";
