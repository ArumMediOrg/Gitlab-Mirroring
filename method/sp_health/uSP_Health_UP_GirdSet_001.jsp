...
SELECT * FROM CT_SP_COMMON
WHERE CSC_LARGE IN ('HM90D','HM11A', 'HM90F')
  AND CSC_LEVEL  = '5'
ORDER BY CSC_CODE_EX, CSC_SMALL
		*/

		sql = " SELECT *";
		sql += " FROM CT_SP_COMMON";
		sql += " WHERE CSC_LARGE IN ('HM90D','HM11A', 'HM90F')";
		sql += " AND CSC_LEVEL = '5'";
		sql += " ORDER BY CSC_CODE_EX, CSC_SMALL";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_Health_UP_GirdSet_001 \n";
			G_INFO += "설명 : 특검공통코드(진찰코드,기본문진,진찰추가코드) \n";
			G_INFO += "\n\n";
