...
<%
		...
		sql = " SELECT CCF_CODE, CCF_PAN_CD, CCF_PAN_SQ, CCF_PANVIEW FROM CT_COMM_FIRVIEW ";
		sql += " WHERE CCF_CODE = '" + CODE + "' ";
		sql += " AND CCF_PAN_CD = '" + PAN_CD + "' ";
		sql += " AND CCF_PAN_SQ = '26' ";
		sql += SSQL_ADD;

			//
		G_INFO += "<!-- \n";
		G_INFO += "서비스명 : uGen_Frst_Panj_udfselfirview_002 \n";
		G_INFO += "설명 : 노동부판정 소견 일괄조회 \n";
		G_INFO += "\n\n";
