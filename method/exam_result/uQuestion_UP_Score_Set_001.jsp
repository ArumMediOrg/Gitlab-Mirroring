...
SELECT A.IIM_ITEM_CD, A.IIM_KNME_NM, A.IIM_TRTP_CD, A.IIM_TRLT_CD, A.IIM_TRNM_CD,
       A.IIM_RSLT_KD, B.IIR_RSLT_CD, B.IIR_SPEX_CD, B.IIR_RSLT_VL
FROM IT_ITEM A
LEFT OUTER JOIN IT_ITEM_RESULT B ON A.IIM_ITEM_CD = B.IIR_ITEM_CD
                                AND B.IIR_RSLT_KD = '2'
 WHERE A.IIM_ITEM_CD = :ITEM_CD
		*/
		...
		sql += " WHERE A.IIM_ITEM_CD = '" + ITEM_CD + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uQuestion_UP_Score_Set_001 \n";
			G_INFO += "설명 : 검사항목조회 \n";
			G_INFO += "\n\n";
