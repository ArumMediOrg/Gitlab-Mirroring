...
SELECT SUBSTR(:EXAM_DT, 1, 4) EXAM_YR, CSM_MATT_CD EXAM_CD, '' EXAM_SQ, 
       CSM_MATT_CD EXAM_DP, CSM_MATT_NM EXAM_NM, '' EXAM_YN, 
       :EXAM_DT PRCE_DT, CSM_MATT_CD ITEM_LT, 
       F_TBAS_CD(:COMP_CD) CALC_CD, 
       ...
       '2' PYER_CD, '2' CMPY_CD, '9' PRPY_CD, B.ICY_TKCG_CD SDMD_CD, 'N' UBEH_YN 
  FROM CT_SP_MATTER A LEFT OUTER JOIN IT_COMPANY B 
    ON B.ICY_COMP_CD = :COMP_CD 
 WHERE UPPER(CSM_USE_YN) = 'Y'
   :PARAM_TX
		*/

		sql = " SELECT SUBSTR('" + EXAM_DT + "', 1, 4) EXAM_YR, CSM_MATT_CD EXAM_CD, '' EXAM_SQ, CSM_MATT_CD EXAM_DP, CSM_MATT_NM EXAM_NM, '' EXAM_YN, '" + EXAM_DT + "' PRCE_DT, CSM_MATT_CD ITEM_LT, F_TBAS_CD('" + COMP_CD + "') CALC_CD, 0 EXAM_PR, 0 SALE_PR, 0 GRUP_PR, 0 COUP_PR, 0 FAMY_PR, 0 CUPN_PR, 0 MMBR_PR, 0 OPTN_PR, 0 JCSG_PR, 0 HESG_PR, 0 GBSG_PR, 0 SBSG_PR, 0 TGSG_PR, 'N' HTSB_YN, 'N' SPSB_YN, 'N' CVSB_YN, 'N' ETSB_YN, 'N' EMSB_YN, '' HTPR_CD, '' SPPR_CD, '' CVPR_CD, '' ETPR_CD, '' EMPR_CD, '9' CNCL_CD, 'N' OPTN_YN, '0' EXAM_KD, '' PACK_RMK, '' SALE_ID, '2' PYER_CD, '2' CMPY_CD, '9' PRPY_CD, B.ICY_TKCG_CD SDMD_CD, 'N' UBEH_YN";
		sql += " FROM CT_SP_MATTER A LEFT OUTER JOIN IT_COMPANY B";
		sql += " ON B.ICY_COMP_CD = '" + COMP_CD + "'";
		sql += " WHERE UPPER(CSM_USE_YN) = 'Y' ";
		sql += PARAM_TX;
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uFM_AcptComm_GP_ExamSetting_005 \n";
			G_INFO += "설명 : 특검 유해물질 세팅 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='EXAM_CD' rs:number='2' rs:writeunknown='true' rs:basetable='CT_SP_MATTER' rs:basecolumn='CSM_MATT_CD'>
		...
		<s:AttributeType name='EXAM_DP' rs:number='4' rs:writeunknown='true' rs:basetable='CT_SP_MATTER' rs:basecolumn='CSM_MATT_CD'>
			<s:datatype dt:type='string' dt:maxLength='10' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='EXAM_NM' rs:number='5' rs:writeunknown='true' rs:basetable='CT_SP_MATTER' rs:basecolumn='CSM_MATT_NM'>
		...
		<s:AttributeType name='ITEM_LT' rs:number='8' rs:writeunknown='true' rs:basetable='CT_SP_MATTER' rs:basecolumn='CSM_MATT_CD'>
			<s:datatype dt:type='string' dt:maxLength='10' rs:maybenull='false'/>
		</s:AttributeType>
		...
		<s:AttributeType name='GRUP_PR' rs:number='12' rs:nullable='true'>
			<s:datatype dt:type='number' rs:dbtype='varnumeric' dt:maxLength='38' rs:scale='255' rs:precision='38'/>
		</s:AttributeType>
		<s:AttributeType name='COUP_PR' rs:number='13' rs:nullable='true'>
			<s:datatype dt:type='number' rs:dbtype='varnumeric' dt:maxLength='38' rs:scale='255' rs:precision='38'/>
		</s:AttributeType>
		<s:AttributeType name='FAMY_PR' rs:number='14' rs:nullable='true'>
			<s:datatype dt:type='number' rs:dbtype='varnumeric' dt:maxLength='38' rs:scale='255' rs:precision='38'/>
		</s:AttributeType>
		...
		<s:AttributeType name='CNCL_CD' rs:number='33' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='1' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='OPTN_YN' rs:number='34' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='1' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='EXAM_KD' rs:number='35' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='1' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='PACK_RMK' rs:number='36' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='2' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='SALE_ID' rs:number='37' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='2' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='PYER_CD' rs:number='38' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='1' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='CMPY_CD' rs:number='39' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='1' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='PRPY_CD' rs:number='40' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='1' rs:fixedlength='true'/>
		</s:AttributeType>
		...
		<s:AttributeType name='ROWID' rs:number='43' rs:rowid='true' rs:basetable='CT_SP_MATTER' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c43' rs:name='ROWID' rs:number='44' rs:rowid='true' rs:basetable='IT_COMPANY' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
