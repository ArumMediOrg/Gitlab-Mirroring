...
SELECT ERI_ITEM_CD FROM ET_RSLT_ITEM
 WHERE ERI_EXAM_DT = :EXAM_DT
   AND ERI_EXAM_SQ = :EXAM_SQ
   AND ERI_ITEM_CD = 'G0021'
   AND ERI_CNCL_YN <> 'Y'
		*/
		...
		sql += " AND ERI_ITEM_CD = 'G0021'";
		sql += " AND ERI_CNCL_YN <> 'Y'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_Health_GrdEXAM_ACPTSelectionChanged_019 \n";
			G_INFO += "설명 : 검사항목결과조회(흉부CT(조영제사용))-유무확인 \n";
			G_INFO += "\n\n";
