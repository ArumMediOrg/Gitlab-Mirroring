...
SELECT * FROM PT_DANR_PANJUNG
 WHERE PDP_EXAM_DT = :EXAM_DT
   ...
   AND PDP_EXAM_KD = :EXAM_KD
 ORDER BY NVL(PDP_ETC4_CD, '0') DESC, PDP_ETC_KD
		*/
		...
		sql += " AND PDP_EXAM_KD = '" + EXAM_KD + "'";
		sql += " ORDER BY NVL(PDP_ETC4_CD, '0') DESC, PDP_ETC_KD";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : QRinresultA3_2018_DetailBand1BeforePrint_004 \n";
			G_INFO += "설명 : 위험판정정보 로딩 \n";
			G_INFO += "\n\n";
