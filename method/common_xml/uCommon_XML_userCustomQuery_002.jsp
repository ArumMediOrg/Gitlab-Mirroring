...
select A.aliasField1, A.aliasField2, A.aliasField3, A.aliasField4, A.aliasField5, A.aliasField6, A.aliasField7, A.aliasField8, A.aliasField9, A.aliasField10 from
(
  :sSql
) A  
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='ROWID' rs:number='11' rs:rowid='true' rs:basetable='DUAL' rs:basecolumn='ROWID' rs:keycolumn='true'
