...
select A.*
 ...
 where QQN_EXAM_DT = :EXAM_DT
   ...
   and IIQ_ITEM_CD = 'M0019'
   and QQN_QSTN_CD in ('43','921','53')
   and IIQ_APLY_DT = GetITEM_QUESTION_ApplyDate('M0028', :EXAM_DT )
		...
		*/
		...
		sql += " AND IIQ_ITEM_CD = 'M0019'";
		sql += " AND QQN_QSTN_CD IN ('43','921','53')";
		sql += " AND IIQ_APLY_DT = GETITEM_QUESTION_APPLYDATE('M0028', '" + EXAM_DT + "')";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uGen_Frst_Panj_upAutoPanExec_2019_006 \n";
			G_INFO += "설명 : 일검자동판정(노인신체기능 문진) \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='ROWID' rs:number='15' rs:rowid='true' rs:basetable='QT_QUESTION' rs:basecolumn='ROWID'
			 rs:keycolumn='true' rs:hidden='true' rs:autoincrement='true'>
			<s:datatype dt:type='string' rs:dbtype='str' dt:maxLength='18' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='c15' rs:name='ROWID' rs:number='16' rs:rowid='true' rs:basetable='IT_ITEM_QUESTION'
