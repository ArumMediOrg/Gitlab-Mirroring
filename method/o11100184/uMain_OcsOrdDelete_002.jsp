...
SELECT Distinct ERI_EXAM_DT, ERI_EXAM_SQ, ERI_OCS_CD, ERI_OCSC_SNO, ERI_OSSB_CD 
  FROM ET_RSLT_ITEM                                                
 WHERE ERI_EXAM_DT = :EXAM_DT
   ...
   And (SUBSTR(ERI_ITEM_CD,1,1) <> 'T' and                    
        SUBSTR(ERI_ITEM_CD,1,1) <> 'O')                       
 ORDER BY ERI_OCS_CD
		*/
		...
		sql += " ORDER BY ERI_OCS_CD";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uMain_OcsOrdDelete_002 \n";
			G_INFO += "설명 : 결과정보 로딩 \n";
			G_INFO += "\n\n";
