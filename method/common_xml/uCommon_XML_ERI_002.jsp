...
<%
 ...
 SELECT ERI_RSLT_KD, ERI_RSLT_VL, ERI_HERT_CD, ERI_SPRT_CD, ERI_RSLT_EX
   FROM ET_RSLT_ITEM
  WHERE ERI_EXAM_DT = :ERI_EXAM_DT
    ...
    AND ERI_ITEM_CD = :ERI_ITEM_CD
		*/
		...
		sql = " SELECT ERI_RSLT_KD, ERI_RSLT_VL, ERI_HERT_CD, ERI_SPRT_CD, ERI_RSLT_EX";
		...
		sql += " AND ERI_ITEM_CD = '" + ERI_ITEM_CD + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCommon_XML_ERI_002 \n";
			G_INFO += "설명 : 검사항목별 결과 조회(일부항목) \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='ERI_RSLT_KD' rs:number='1' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_RSLT_ITEM'
		...
		<s:AttributeType name='ERI_SPRT_CD' rs:number='4' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_RSLT_ITEM'
