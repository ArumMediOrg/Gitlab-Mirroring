...
<%!
	public String func_uAutoBrain_uAutoPanBrain_012(Statement argStmtExec, HashMap argHtMethod) throws Exception {
		...
		try {
			...
			sql = "INSERT INTO PT_DANR_PANJUNG (PDP_EXAM_DT, PDP_EXAM_SQ, PDP_EXAM_KD ,PDP_ETC1_CD, PDP_ETC2_CD, PDP_ETC3_CD ,PDP_ETC4_CD) VALUES (";
			sql += "  '" + EXAM_DT + "'";
			sql += ", '" + EXAM_SQ + "'";
			sql += ", '" + EXAM_KD + "'";
			sql += ", '" + ETC1_CD + "'";
