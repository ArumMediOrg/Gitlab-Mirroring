...
<%
		...
		sql = func_omr_insertarumtotal_002(stmtExec, htMethod);

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : omr_insertarumtotal_002 \n";
			G_INFO += "설명 : OMR 스캔 후 이미지 파일 이름 및 날짜 등 인서트(바코드를 못 읽었을 때 or 인적정보를 가져오지 못 했을 때) \n";
			G_INFO += "\n\n";
