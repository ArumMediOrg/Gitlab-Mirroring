...
<%
		...
		String PSNL_AG = htMethod.get("PSNL_AG");

		//
		if(ITEM_CD == null) { ITEM_CD = ""; }
		if(EXAM_DT == null) { EXAM_DT = ""; }
		if(SEX_CD == null) { SEX_CD = ""; }
		if(PSNL_AG == null) { PSNL_AG = ""; }
...
WHERE IIV_APLY_DT = GetITEM_VLDT_ApplyDate(:ITEM_CD,:EXAM_DT,'ITEM_CD','4')
  ...
  AND IIV_AGE_FR <= :PSNL_AG
  AND IIV_AGE_TO >= :PSNL_AG
  AND IIV_USE_YN = 'Y'        
		*/
		...
		sql += " AND IIV_AGE_FR <= '" + PSNL_AG + "'";
		sql += " AND IIV_AGE_TO >= '" + PSNL_AG + "'";
		sql += " AND IIV_USE_YN = 'Y'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uQuestion_UF_ITEM_VLDT_Set_001 \n";
			G_INFO += "설명 : 검사항목참고치조회 \n";
			G_INFO += "\n\n";
