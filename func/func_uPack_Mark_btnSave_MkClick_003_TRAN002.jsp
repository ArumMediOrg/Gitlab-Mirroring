...
<%!
	public String func_uPack_Mark_btnSave_MkClick_003_TRAN002(Statement argStmtExec, HashMap argHtMethod) throws Exception {
		...
		try {
			...
			String SMARK_CD = (String) argHtMethod.get("SMARK_CD");
			...
			SMARK_CD = CTr.Replace(SMARK_CD, "'", "''");
			SMAX_SQ = CTr.Replace(SMAX_SQ, "'", "''");
			PRNT_SQ = CTr.Replace(PRNT_SQ, "'", "''");
