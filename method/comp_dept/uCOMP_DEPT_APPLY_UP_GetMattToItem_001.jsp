...
SELECT CSC_ETC1_CD FROM CT_SP_COMMON WHERE CSC_LARGE = 'HM99A' AND CSC_SMALL IN (:SMALL)
		*/

		sql = " SELECT CSC_ETC1_CD";
		sql += " FROM CT_SP_COMMON";
		sql += " WHERE CSC_LARGE = 'HM99A'";
		sql += " AND CSC_SMALL IN (" + SMALL + ")";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCOMP_DEPT_APPLY_UP_GetMattToItem_001 \n";
			G_INFO += "설명 : 특검물질표적장기(나열) \n";
			G_INFO += "\n\n";
