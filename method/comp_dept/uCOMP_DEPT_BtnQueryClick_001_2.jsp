...
<%
		...
		sql += SSQL_ADD;
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCOMP_DEPT_BtnQueryClick_001_2 \n";
			G_INFO += "설명 : 사업장부서관리(특수) 리스트 조회 _(물질명추가) \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='ICD_MATT_NM' rs:number='51' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='4000' rs:fixedlength='true'/>
		</s:AttributeType>
