...
<%
		...
		sql = " SELECT A.* FROM ET_CANCER_COLO A  ";

		if(CMBPLACEFLG.equals("1")){
			sql += " INNER JOIN ET_EXAM_ACPT B ON B.EEA_EXAM_DT = A.ECC_EXAM_DT ";
		...
		sql += " AND (NVL(A.ECC_CKUP_LICEN_CD, ' ') <> ' ' OR NVL(A.ECC_DECI_LICEN_CD, ' ') <> ' ' OR NVL(A.ECC_PATH_LICEN_CD, ' ') <> ' ') ";


			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uDoctor_Pm_UP_QryOpen_Chk_002 \n";
			G_INFO += "설명 : 대장암 검진정보 로딩(검사/진단의) \n";
			G_INFO += "\n\n";
