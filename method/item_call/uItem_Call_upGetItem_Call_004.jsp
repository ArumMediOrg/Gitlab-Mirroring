...
SELECT IIM_ITEM_CD, SUBSTR(:sField, :sCount, 1) AS HCGB 
  FROM IT_ITEM WHERE SUBSTR(:sField, :sCount, 1) <> '0'
		*/

		sql = " SELECT IIM_ITEM_CD, SUBSTR(" + SFIELD + ", " + SCOUNT + ", 1) AS HCGB";
		sql += " FROM IT_ITEM";
		sql += " WHERE SUBSTR(" + SFIELD + ", " + SCOUNT + ", 1) <> '0'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uItem_Call_upGetItem_Call_004 \n";
			G_INFO += "설명 : 항목정보 로딩 \n";
			G_INFO += "\n\n";
