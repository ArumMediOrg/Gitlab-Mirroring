...
if :PAN_SQ  <> '' then     //CCF_PAN_SQ : 공백이 아닌 경우 조건 추가
begin
 ...
 ORDER BY f_lpad(NVL(CCF_PAN_SQ, '0'), 5, '0')
		...
		*/
		...
		sql += " WHERE ROWNUM = 1";
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uGen_Frst_Panj_ufSelOpin_001 \n";
			G_INFO += "설명 : 노동부판정 소견 조회3 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='CCF_CODENM' rs:number='1'>
			<s:datatype dt:type='string' dt:maxLength='100' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='CCF_PAN_CD' rs:number='2'>
			<s:datatype dt:type='string' dt:maxLength='3' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='CCF_PAN_SQ' rs:number='3'>
			<s:datatype dt:type='string' dt:maxLength='2' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='CCF_PANVIEW' rs:number='4' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='500'/>
		</s:AttributeType>
		<s:AttributeType name='CCF_MEMO' rs:number='5' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='500'/>
		</s:AttributeType>
		<s:AttributeType name='CCF_CODE' rs:number='6' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='2'/>
		</s:AttributeType>
		<s:AttributeType name='CCF_LCODE' rs:number='7' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='2'/>
		</s:AttributeType>
		<s:AttributeType name='CCF_JILCD' rs:number='8' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='CCF_PLVCD' rs:number='9' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='5'/>
		</s:AttributeType>
		<s:AttributeType name='CCF_JILVIEW' rs:number='10' rs:nullable='true'>
			<s:datatype dt:type='string' dt:maxLength='500'/>
		</s:AttributeType>
		<s:AttributeType name='CCF_AUTO_YN' rs:number='11' rs:nullable='true'>
