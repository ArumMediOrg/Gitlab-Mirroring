...
<%
		...
		sql = func_uSP_ChungFILERE_RzBmNhAcnoClick_001(stmtExec, htMethod);

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_ChungFILERE_RzBmNhAcnoClick_001 \n";
			G_INFO += "설명 : 특검 청구파일정보 수정 \n";
			G_INFO += "\n\n";

			G_INFO += "전달인자 : \n";
			G_INFO += " ACPT_NO : " + ACPT_NO + " \n";
			G_INFO += " BUSI_YR : " + BUSI_YR + " \n";
			G_INFO += " BILL_DT : " + BILL_DT + " \n";
			G_INFO += " BILL_NO : " + BILL_NO + " \n";
			G_INFO += " RZRBCHUNGFILE : " + RZRBCHUNGFILE + " \n";
