...
select eea_exam_dt, eea_exam_sq, eea_psnl_nm from et_exam_acpt where eea_exam_dt = :exam_dt and eea_chart_no = :chart_no
		*/
		...
		sql += " AND EEA_CHART_NO = '" + CHART_NO + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uMain_getKey_001 \n";
			G_INFO += "설명 : 사용될 키값을 가져옴. \n";
			G_INFO += "\n\n";
