...
SELECT ERI_ITEM_CD, ERI_RSLT_VL, ERI_HTSB_PANJ
  FROM Et_RSLT_ITEM
 WHERE ERI_EXAM_DT = :EXAM_DT
   AND ERI_EXAM_SQ = :EXAM_SQ
   AND ERI_ITEM_CD in ('A0006','A0009')
		*/

		sql = " SELECT ERI_ITEM_CD, ERI_RSLT_VL, ERI_HTSB_PANJ";
		sql += " FROM ET_RSLT_ITEM";
		sql += " WHERE ERI_EXAM_DT = '" + EXAM_DT + "'";
		sql += " AND ERI_EXAM_SQ = '" + EXAM_SQ + "'";
		sql += " AND ERI_ITEM_CD IN ('A0006','A0009')";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uLife_Panj_rgpPspPrscrPyc_YnClick_001 \n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='ERI_HTSB_PANJ' rs:number='3' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_RSLT_ITEM'
