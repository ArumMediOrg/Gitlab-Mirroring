...
<%
		...
		String SPID_EN = htMethod.get("SPID_EN");

		//
		if(SPID_EN == null) { SPID_EN = ""; }
...
Select ecl_decrypt(:sPID_EN) as enc_pid  from dual
		*/

		sql = " SELECT ECL_DECRYPT('" + SPID_EN + "') AS ENC_PID";
		sql += " FROM DUAL";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uIT_ChungGU_2018_XML_COM_001 \n";
			G_INFO += "설명 : 유비엠 복호화 조회 \n";
			G_INFO += "\n\n";

			G_INFO += "전달인자 : \n";
			G_INFO += " SPID_EN : " + SPID_EN + " \n";
			G_INFO += "\n\n";
