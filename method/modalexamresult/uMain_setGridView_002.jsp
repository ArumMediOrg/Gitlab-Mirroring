...
<%
		...
		sql += " SELECT EEA_EXAM_DT, EEA_EXAM_SQ, EEA_PSNL_NM, ";
		sql += " 	F_CODE_FIND('0401', EEA_EXAM_CD, '', '1') EEA_EXAM_NM ";
		sql += " FROM ET_EXAM_ACPT ";
		sql += " WHERE EEA_CHART_NO = '" + CHART_NO + "' ";
		...
		sql += " ORDER BY EEA_EXAM_DT DESC, EEA_EXAM_SQ DESC ";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uMain_setGridView_002 \n";
