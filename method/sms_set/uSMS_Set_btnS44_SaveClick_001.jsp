...
<%
		...
		String CHECKBOX2 = htMethod.get("CHECKBOX2");
		...
		sql = func_uSMS_Set_btnS44_SaveClick_001(stmtExec, htMethod);

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSMS_Set_btnS44_SaveClick_001 \n";
			G_INFO += "설명 : SMS내용 수정 \n";
			G_INFO += "\n\n";
