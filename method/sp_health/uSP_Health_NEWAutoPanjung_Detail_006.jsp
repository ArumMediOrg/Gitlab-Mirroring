...
Select * From ET_RSLT_ITEM
 Where ERI_EXAM_DT = :EXAM_DT
   ...
   And ERI_ITEM_CD = 'BA010'
   And Cast(NVL(ERI_RSLT_VL,  0) as Float) <= '39'
		*/
		...
		sql += " AND ERI_ITEM_CD = 'BA010'";
		sql += " AND CAST(NVL(ERI_RSLT_VL, 0) AS FLOAT) <= '39'";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_Health_NEWAutoPanjung_Detail_006 \n";
			G_INFO += "설명 : 특검자동판정-HDL 검사항목 조회(고대안산) \n";
			G_INFO += "\n\n";
