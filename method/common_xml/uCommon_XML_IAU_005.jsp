...
select IAU_EMP_NO , IAU_PENL_NM , IAU_DPAN_DR, IAU_LICEN1_NO
from IT_AUTH_USER
where 1 = 1
:sSQL_ADD
		...
		*/
		...
		sql = " SELECT IAU_EMP_NO , IAU_PENL_NM , IAU_DPAN_DR, IAU_LICEN1_NO";
		...
		sql += SSQL_ADD;
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCommon_XML_IAU_005 \n";
			G_INFO += "설명 : 사용자조회(의사리스트-조회조건) \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='IAU_DPAN_DR' rs:number='3' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
			 rs:basecolumn='IAU_DPAN_DR'>
			<s:datatype dt:type='string' dt:maxLength='10'/>
		</s:AttributeType>
		<s:AttributeType name='IAU_LICEN1_NO' rs:number='4' rs:nullable='true' rs:writeunknown='true' rs:basetable='IT_AUTH_USER'
