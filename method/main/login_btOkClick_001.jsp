...
<%
    ...
    WHERE IAU_EMP_NO = :EMP_NO  AND IAU_USE_YN='Y'
		*/
		...
		sql = " SELECT IAU_EMP_NO,IAU_PASS_WD,IAU_AUTH_GP,IAU_PENL_NM, IAU_ENCRYP_GB, IAU_ANOTHER_NO, ";
		sql += " IAU_LICEN1_CD, IAU_LICEN2_CD, TO_CHAR(IAU_MODI_DTT, 'YYYY-MM-DD') IAU_MODI_DTT";
		...
		sql += " AND IAU_USE_YN='Y'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : login_btOkClick_001 \n";
