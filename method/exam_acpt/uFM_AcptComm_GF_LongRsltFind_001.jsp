...
SELECT IIM_ITEM_CD, IIM_KNME_NM, IIM_RSLT_KD
  FROM IT_ITEM
 WHERE IIM_RSLT_KD IN ('3', '4', '6', '7')

		*/

		sql = " SELECT IIM_ITEM_CD, IIM_KNME_NM, IIM_RSLT_KD";
		sql += " FROM IT_ITEM";
		sql += " WHERE IIM_RSLT_KD IN ('3', '4', '6', '7')";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uFM_AcptComm_GF_LongRsltFind_001 \n";
			G_INFO += "설명 : 장문결과 검사항목 조회 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='IIM_RSLT_KD' rs:number='3' rs:writeunknown='true' rs:basetable='IT_ITEM' rs:basecolumn='IIM_RSLT_KD'>
			<s:datatype dt:type='string' dt:maxLength='1' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='ROWID' rs:number='4' rs:rowid='true' rs:basetable='IT_ITEM' rs:basecolumn='ROWID' rs:keycolumn='true'
