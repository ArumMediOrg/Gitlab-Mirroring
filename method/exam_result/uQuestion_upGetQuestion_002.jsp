...
SELECT A.ERI_ITEM_CD, B.IIM_KNME_NM FROM ET_RSLT_ITEM A
INNER JOIN IT_ITEM B ON A.ERI_ITEM_CD = B.IIM_ITEM_CD
                    AND (B.IIM_EXGN_CD = 'M' OR ERI_ITEM_CD = 'S0250')
  ...
  AND ERI_CNCL_YN = 'N'
		*/
		...
		sql += " AND ERI_CNCL_YN = 'N'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uQuestion_upGetQuestion_002 \n";
			G_INFO += "설명 : 검사항목조회(대상문진목록) \n";
			G_INFO += "\n\n";
