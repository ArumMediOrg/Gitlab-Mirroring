...
from (
    select RRM_MODI_ID, IAU_PENL_NM, RRM_PAY_KD, RRM_RECE_PR,
       case when RRM_PAY_KD ='01' then (RRM_RECE_PR - RRM_RESEREPL_PR) end cardpr,
       case when RRM_PAY_KD IN ('02','03')  then (RRM_RECE_PR - RRM_RESEREPL_PR) end cashpr,
       case when RRM_PAY_KD IN ('04')  then (RRM_RECE_PR - RRM_RESEREPL_PR) end bkbookpr,
       case when RRM_PAY_KD  NOT IN ('01','02','03','04')  then (RRM_RECE_PR - RRM_RESEREPL_PR) end otherpr,
    ...
    where
       ...
       and RRM_OCCU_KD in ('10','20','70','71','72')
		...
		*/
		...
		sql += " FROM (";
		sql += "	SELECT RRM_MODI_ID, IAU_PENL_NM, RRM_PAY_KD, RRM_RECE_PR";
		sql += "	, CASE WHEN RRM_PAY_KD ='01' THEN (RRM_RECE_PR - RRM_RESEREPL_PR) END CARDPR";
		sql += "	, CASE WHEN RRM_PAY_KD IN ('02','03') THEN (RRM_RECE_PR - RRM_RESEREPL_PR) END CASHPR";
		sql += "	, CASE WHEN RRM_PAY_KD IN ('04') THEN (RRM_RECE_PR - RRM_RESEREPL_PR) END BKBOOKPR";
		sql += "	, CASE WHEN RRM_PAY_KD NOT IN ('01','02','03','04') THEN (RRM_RECE_PR - RRM_RESEREPL_PR) END OTHERPR";
		...
		sql += " 	AND RRM_OCCU_KD IN ('10','20','70','71','72')";
		sql += " ) A";
		sql += " GROUP BY IAU_PENL_NM, RRM_MODI_ID";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uRT_ReceDayReport_Up_afLoadComp2_001 \n";
