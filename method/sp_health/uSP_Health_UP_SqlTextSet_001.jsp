...
<%
		...
		sql += " OR B.ICR_SEX_KD = '' THEN B.ICR_SEX_KD ELSE '[' || B.ICR_SEX_KD || ']' || GETCOMMON_LVCDTONM('0411',B.ICR_SEX_KD ,'5',1) END ICR_SEX_NM, A.EEA_EXAM_CD, A.EEA_HDMD_YN, A.EEA_SDMD_YN, A.EEA_SPCL_LT, A.EEA_SPCL_CD, A.EEA_SPHT_CD, B.ICR_SEX_KD, A.EEA_CHART_NO, D.SBE_PANJ_YN, D.SBE_EXAM_CHA, D.SBE_TPAN_NM, A.EEA_PLCE_CD, B.ICR_PENL_ID, A.EEA_EMSB_CD";
