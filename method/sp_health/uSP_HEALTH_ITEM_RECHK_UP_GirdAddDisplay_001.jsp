...
Select SIR_ADD_LT From ST_ITEM_RECHECK
 Where SIR_EXAM_DT = :EXAM_DT
   And SIR_EXAM_SQ = :EXAM_SQ
   And SIR_ORGA_CD = :ORGA_CD
		*/

		sql = " SELECT SIR_ADD_LT";
		...
		sql += " AND SIR_ORGA_CD = '" + ORGA_CD + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uSP_HEALTH_ITEM_RECHK_UP_GirdAddDisplay_001 \n";
			G_INFO += "설명 : 특검 2차 추가검사 대상항목묶음 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='SIR_ADD_LT' rs:number='1' rs:nullable='true' rs:writeunknown='true' rs:basetable='ST_ITEM_RECHECK'
