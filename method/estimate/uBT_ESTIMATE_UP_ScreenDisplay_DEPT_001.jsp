...
SELECT CASE WHEN BED_HALF_CD  IS NULL OR BED_HALF_CD  = '' THEN BED_HALF_CD  else '[' || BED_HALF_CD  || ']' || GetSP_COMMON_cdToNm('HM99F',BED_HALF_CD) END BED_HALF_NM, 
       CASE WHEN BED_TAGR_TM  IS NULL OR BED_TAGR_TM  = '' THEN BED_TAGR_TM  else '[' || BED_TAGR_TM  || ']' || GetSP_COMMON_cdToNm('HM99B',BED_TAGR_TM) END BED_TAGR_NM, 
       A.* 
from BT_ESTI_DEPT A 
WHERE BED_MNGT_YR = :MNGT_YR
  ...
  AND BED_DEPT_SQ = :DEPT_SQ
		*/
		...
		sql = " SELECT CASE WHEN BED_HALF_CD IS NULL OR BED_HALF_CD = '' THEN BED_HALF_CD ELSE '[' || BED_HALF_CD || ']' || GetSP_COMMON_cdToNm('HM99F',BED_HALF_CD) END BED_HALF_NM";
		sql += ", CASE WHEN BED_TAGR_TM IS NULL OR BED_TAGR_TM = '' THEN BED_TAGR_TM ELSE '[' || BED_TAGR_TM || ']' || GetSP_COMMON_cdToNm('HM99B',BED_TAGR_TM) END BED_TAGR_NM";
		sql += ", A.*";
		sql += " FROM BT_ESTI_DEPT A";
		...
		sql += " AND BED_DEPT_SQ = '" + DEPT_SQ + "'";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uBT_ESTIMATE_UP_ScreenDisplay_DEPT_001 \n";
			G_INFO += "설명 : 특검유형 로딩 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		<s:AttributeType name='BED_HALF_NM' rs:number='1' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_HALF_NM'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='BED_TAGR_NM' rs:number='2' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_TAGR_NM'>
			<s:datatype dt:type='string' dt:maxLength='4000'/>
		</s:AttributeType>
		<s:AttributeType name='BED_MNGT_YR' rs:number='3' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT' rs:basecolumn='BED_MNGT_YR'>
			<s:datatype dt:type='string' dt:maxLength='4' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='BED_ESTI_CD' rs:number='4' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT' rs:basecolumn='BED_ESTI_CD'>
			<s:datatype dt:type='string' dt:maxLength='8' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='BED_DEPT_SQ' rs:number='5' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT' rs:basecolumn='BED_DEPT_SQ'>
			<s:datatype dt:type='string' dt:maxLength='4' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='BED_HALF_CD' rs:number='6' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT' rs:basecolumn='BED_HALF_CD'>
			<s:datatype dt:type='string' dt:maxLength='1' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='BED_DEPT_NM' rs:number='7' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT' rs:basecolumn='BED_DEPT_NM'>
			<s:datatype dt:type='string' dt:maxLength='100' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='BED_SUBD_NM' rs:number='8' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_SUBD_NM'>
			<s:datatype dt:type='string' dt:maxLength='100'/>
		</s:AttributeType>
		<s:AttributeType name='BED_MATT_LT' rs:number='9' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_MATT_LT'>
			<s:datatype dt:type='string' dt:maxLength='1000'/>
		</s:AttributeType>
		<s:AttributeType name='BED_MTJG_LT' rs:number='10' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_MTJG_LT'>
			<s:datatype dt:type='string' dt:maxLength='2000'/>
		</s:AttributeType>
		<s:AttributeType name='BED_BSBS_PR' rs:number='11' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_BSBS_PR'>
			<s:datatype dt:type='number' rs:dbtype='varnumeric' dt:maxLength='38' rs:scale='255' rs:precision='38'/>
		</s:AttributeType>
		<s:AttributeType name='BED_BTGS_PR' rs:number='12' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_BTGS_PR'>
			<s:datatype dt:type='number' rs:dbtype='varnumeric' dt:maxLength='38' rs:scale='255' rs:precision='38'/>
		</s:AttributeType>
		<s:AttributeType name='BED_BCAS_PR' rs:number='13' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_BCAS_PR'>
			<s:datatype dt:type='number' rs:dbtype='varnumeric' dt:maxLength='38' rs:scale='255' rs:precision='38'/>
		</s:AttributeType>
		<s:AttributeType name='BED_JSBS_PR' rs:number='14' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_JSBS_PR'>
			<s:datatype dt:type='number' rs:dbtype='varnumeric' dt:maxLength='38' rs:scale='255' rs:precision='38'/>
		</s:AttributeType>
		<s:AttributeType name='BED_JTGS_PR' rs:number='15' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_JTGS_PR'>
			<s:datatype dt:type='number' rs:dbtype='varnumeric' dt:maxLength='38' rs:scale='255' rs:precision='38'/>
		</s:AttributeType>
		<s:AttributeType name='BED_JCAS_PR' rs:number='16' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_JCAS_PR'>
			<s:datatype dt:type='number' rs:dbtype='varnumeric' dt:maxLength='38' rs:scale='255' rs:precision='38'/>
		</s:AttributeType>
		<s:AttributeType name='BED_BSBS_RT' rs:number='17' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_BSBS_RT'>
			<s:datatype dt:type='float' dt:maxLength='8' rs:precision='15' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='BED_BTGS_RT' rs:number='18' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_BTGS_RT'>
			<s:datatype dt:type='float' dt:maxLength='8' rs:precision='15' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='BED_BCAS_RT' rs:number='19' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_BCAS_RT'>
			<s:datatype dt:type='float' dt:maxLength='8' rs:precision='15' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='BED_JSBS_RT' rs:number='20' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_JSBS_RT'>
			<s:datatype dt:type='float' dt:maxLength='8' rs:precision='15' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='BED_JTGS_RT' rs:number='21' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_JTGS_RT'>
			<s:datatype dt:type='float' dt:maxLength='8' rs:precision='15' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='BED_JCAS_RT' rs:number='22' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_JCAS_RT'>
			<s:datatype dt:type='float' dt:maxLength='8' rs:precision='15' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='BED_JBSBS_PR' rs:number='23' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_JBSBS_PR'>
			<s:datatype dt:type='number' rs:dbtype='varnumeric' dt:maxLength='38' rs:scale='255' rs:precision='38'/>
		</s:AttributeType>
		<s:AttributeType name='BED_JBTGS_PR' rs:number='24' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_JBTGS_PR'>
			<s:datatype dt:type='number' rs:dbtype='varnumeric' dt:maxLength='38' rs:scale='255' rs:precision='38'/>
		</s:AttributeType>
		<s:AttributeType name='BED_JBCAS_PR' rs:number='25' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_JBCAS_PR'>
			<s:datatype dt:type='number' rs:dbtype='varnumeric' dt:maxLength='38' rs:scale='255' rs:precision='38'/>
		</s:AttributeType>
		<s:AttributeType name='BED_JJSBS_PR' rs:number='26' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_JJSBS_PR'>
			<s:datatype dt:type='number' rs:dbtype='varnumeric' dt:maxLength='38' rs:scale='255' rs:precision='38'/>
		</s:AttributeType>
		<s:AttributeType name='BED_JJTGS_PR' rs:number='27' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_JJTGS_PR'>
			<s:datatype dt:type='number' rs:dbtype='varnumeric' dt:maxLength='38' rs:scale='255' rs:precision='38'/>
		</s:AttributeType>
		<s:AttributeType name='BED_JJCAS_PR' rs:number='28' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_JJCAS_PR'>
			<s:datatype dt:type='number' rs:dbtype='varnumeric' dt:maxLength='38' rs:scale='255' rs:precision='38'/>
		</s:AttributeType>
		<s:AttributeType name='BED_BCUST_CNT' rs:number='29' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_BCUST_CNT'>
			<s:datatype dt:type='number' rs:dbtype='varnumeric' dt:maxLength='38' rs:scale='255' rs:precision='38'/>
		</s:AttributeType>
		<s:AttributeType name='BED_BSALE_PR' rs:number='30' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_BSALE_PR'>
			<s:datatype dt:type='number' rs:dbtype='varnumeric' dt:maxLength='38' rs:scale='255' rs:precision='38'/>
		</s:AttributeType>
		<s:AttributeType name='BED_JCUST_CNT' rs:number='31' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_JCUST_CNT'>
			<s:datatype dt:type='number' rs:dbtype='varnumeric' dt:maxLength='38' rs:scale='255' rs:precision='38'/>
		</s:AttributeType>
		<s:AttributeType name='BED_JSALE_PR' rs:number='32' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_JSALE_PR'>
			<s:datatype dt:type='number' rs:dbtype='varnumeric' dt:maxLength='38' rs:scale='255' rs:precision='38'/>
		</s:AttributeType>
		<s:AttributeType name='BED_TAGR_TM' rs:number='33' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_TAGR_TM'>
			<s:datatype dt:type='string' dt:maxLength='1'/>
		</s:AttributeType>
		<s:AttributeType name='BED_USE_YN' rs:number='34' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT' rs:basecolumn='BED_USE_YN'>
			<s:datatype dt:type='string' dt:maxLength='1' rs:maybenull='false'/>
		</s:AttributeType>
		<s:AttributeType name='BED_NUSE_ID' rs:number='35' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_NUSE_ID'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='BED_NUSE_DTT' rs:number='36' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_NUSE_DTT'>
			<s:datatype dt:type='dateTime' rs:dbtype='timestamp' dt:maxLength='16' rs:scale='0' rs:precision='19' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='BED_INPT_ID' rs:number='37' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_INPT_ID'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='BED_INPT_DTT' rs:number='38' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_INPT_DTT'>
			<s:datatype dt:type='dateTime' rs:dbtype='timestamp' dt:maxLength='16' rs:scale='0' rs:precision='19' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='BED_MODI_ID' rs:number='39' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_MODI_ID'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='BED_MODI_DTT' rs:number='40' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_MODI_DTT'>
			<s:datatype dt:type='dateTime' rs:dbtype='timestamp' dt:maxLength='16' rs:scale='0' rs:precision='19' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='BED_TRNS_ID' rs:number='41' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_TRNS_ID'>
			<s:datatype dt:type='string' dt:maxLength='20'/>
		</s:AttributeType>
		<s:AttributeType name='BED_TRNS_DTT' rs:number='42' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_TRNS_DTT'>
			<s:datatype dt:type='dateTime' rs:dbtype='timestamp' dt:maxLength='16' rs:scale='0' rs:precision='19' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='BED_SPCL_CD' rs:number='43' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_SPCL_CD'>
			<s:datatype dt:type='string' dt:maxLength='2'/>
		</s:AttributeType>
		<s:AttributeType name='BED_MCAS_PR' rs:number='44' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_MCAS_PR'>
			<s:datatype dt:type='number' rs:dbtype='varnumeric' dt:maxLength='38' rs:scale='255' rs:precision='38'/>
		</s:AttributeType>
		<s:AttributeType name='BED_MSALE_PR' rs:number='45' rs:nullable='true' rs:writeunknown='true' rs:basetable='BT_ESTI_DEPT'
			 rs:basecolumn='BED_MSALE_PR'>
			<s:datatype dt:type='number' rs:dbtype='varnumeric' dt:maxLength='38' rs:scale='255' rs:precision='38'/>
		</s:AttributeType>
		<s:AttributeType name='ROWID' rs:number='46' rs:rowid='true' rs:basetable='BT_ESTI_DEPT' rs:basecolumn='ROWID'
...
<%
		...
		while(cRsList.next()) {
			...
			String BED_TAGR_NM_T = cRsList.getString("BED_TAGR_NM");
...
<%
			...
			if(! BED_TAGR_NM_T.equals("")) {
%>
		 		BED_TAGR_NM='<%= BED_TAGR_NM_T%>'
<%
			}
