...
SELECT EEP_ORDER_DT, 
       ...
       EEP_COMP_PR, EEP_COMPS_PR, EEP_PSNL_PR, EEP_PSNLP_PR, EEP_INPT_DTT 
  FROM ET_EXAM_PRICE 
 ...
 ORDER BY EEP_ORDER_SQ DESC
		...
		*/
		...
		sql = " SELECT EEP_ORDER_DT, F_CODE_FIND('0419', EEP_ORDER_CD, '', '1') EEP_ORDER_NM, EEP_EXAM_PR, EEP_FST_PR, EEP_ADD_PR, EEP_PRGS_PR, EEP_HTSB_PR, EEP_CAN_PR, EEP_SPSB_PR, EEP_CVSB_PR, EEP_EMSB_PR, EEP_ETSB_PR, EEP_DMD_PR, EEP_HDMD_PR, EEP_SDMD_PR, EEP_COMP_PR, EEP_COMPS_PR, EEP_PSNL_PR, EEP_PSNLP_PR, EEP_INPT_DTT";
		...
		sql += " ORDER BY EEP_ORDER_SQ DESC";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uExam_Acpt_Up_DisplayDmd_001 \n";
			G_INFO += "설명 : 수가 청구내역 조회 \n";
			G_INFO += "\n\n";
...
<s:Schema id='RowsetSchema'>
	<s:ElementType name='row' content='eltOnly' rs:updatable='true'>
		...
		<s:AttributeType name='EEP_INPT_DTT' rs:number='20' rs:nullable='true' rs:writeunknown='true' rs:basetable='ET_EXAM_PRICE'
			 rs:basecolumn='EEP_INPT_DTT'>
			<s:datatype dt:type='dateTime' rs:dbtype='timestamp' dt:maxLength='16' rs:scale='0' rs:precision='19' rs:fixedlength='true'/>
		</s:AttributeType>
		<s:AttributeType name='ROWID' rs:number='21' rs:rowid='true' rs:basetable='ET_EXAM_PRICE' rs:basecolumn='ROWID'
