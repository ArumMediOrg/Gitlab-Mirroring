...
<%
		...
		String CON_COLUMN_S1 = htMethod.get("CON_COLUMN_S1");
		String CON_COLUMN_S2 = htMethod.get("CON_COLUMN_S2");
		String CON_COLUMN_S3 = htMethod.get("CON_COLUMN_S3");
		String CON_COLUMN_S4 = htMethod.get("CON_COLUMN_S4");
		String CON_COLUMN_S5 = htMethod.get("CON_COLUMN_S5");
		...
		String CON_VALUE_S1 = htMethod.get("CON_VALUE_S1");
		String CON_VALUE_S2 = htMethod.get("CON_VALUE_S2");
		String CON_VALUE_S3 = htMethod.get("CON_VALUE_S3");
		String CON_VALUE_S4 = htMethod.get("CON_VALUE_S4");
		String CON_VALUE_S5 = htMethod.get("CON_VALUE_S5");
		...
		sql = func_uFM_AcptComm_GF_UdtMultiColumn_001(stmtExec, htMethod);

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uFM_AcptComm_GF_UdtMultiColumn_001 \n";
			G_INFO += "설명 : 다중 컬럼 변경(5개 까지) \n";
			G_INFO += "\n\n";
			...
			G_INFO += " CON_COLUMN_S1 : " + CON_COLUMN_S1 + " \n";
			G_INFO += " CON_COLUMN_S2 : " + CON_COLUMN_S2 + " \n";
			G_INFO += " CON_COLUMN_S3 : " + CON_COLUMN_S3 + " \n";
			G_INFO += " CON_COLUMN_S4 : " + CON_COLUMN_S4 + " \n";
			G_INFO += " CON_COLUMN_S5 : " + CON_COLUMN_S5 + " \n";
			...
			G_INFO += " CON_VALUE_S1 : " + CON_VALUE_S1 + " \n";
			G_INFO += " CON_VALUE_S2 : " + CON_VALUE_S2 + " \n";
			G_INFO += " CON_VALUE_S3 : " + CON_VALUE_S3 + " \n";
			G_INFO += " CON_VALUE_S4 : " + CON_VALUE_S4 + " \n";
			G_INFO += " CON_VALUE_S5 : " + CON_VALUE_S5 + " \n";
