...
<%
		...
		String ADV_YEAR = htMethod.get("ADV_YEAR");
		String PSNL_NM = htMethod.get("PSNL_NM");


		//
		if(ADV_YEAR == null) { ADV_YEAR = ""; }
		...
		sql += " WHERE CAP_RSVN_DT LIKE '" + ADV_YEAR + "%' ";
		sql += " AND EEA_PSNL_NM Like '%" + PSNL_NM + "%' ";
		sql += " ORDER BY CAP_RSVN_DT, CAP_RSVN_TM ";

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCRM_BASIC_MAIN_BtnS3_Schedule_SearchClick_001 \n";
			G_INFO += "설명 : 상담예약자 조회 \n";
			G_INFO += "\n\n";

			G_INFO += "전달인자 : \n";
			G_INFO += " ADV_YEAR : " + ADV_YEAR + " \n";
