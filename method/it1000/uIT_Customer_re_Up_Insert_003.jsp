...
<%
		...
		String SEXD_KD = htMethod.get("SEXD_KD");
		...
		sql = func_uIT_Customer_re_Up_Insert_003(stmtExec, htMethod);

			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uIT_Customer_re_Up_Insert_003 \n";
			G_INFO += "설명 : 고객정보 추가 \n";
			G_INFO += "\n\n";
