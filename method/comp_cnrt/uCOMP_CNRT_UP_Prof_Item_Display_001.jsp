...
<%
		...
		sql = " SELECT ECI_ITEM_CD";
		sql += ", (SELECT IIM_KNME_NM FROM IT_ITEM WHERE IIM_ITEM_CD = ECI_ITEM_CD) AS ECI_ITEM_NM";
		sql += ", ECI_ITEM_PR, ECI_CNRT_PR, ECI_SORT_SQ, ECI_CNRT_SQ, ECI_PROF_SQ ";
		sql += ", (SELECT IIM_OSCD_CD FROM IT_ITEM WHERE IIM_ITEM_CD = ECI_ITEM_CD) AS IIM_OSCD_CD";
		...
		sql += " ORDER BY ECI_SORT_SQ";
			...
			//
			G_INFO += "<!-- \n";
			G_INFO += "서비스명 : uCOMP_CNRT_UP_Prof_Item_Display_001 \n";
